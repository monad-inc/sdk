...
class TransformsApi:
    ...
    def v1_transforms_get(
        ...
        _param = self._v1_transforms_get_serialize(
            body=body,
    ...
    @validate_call
    def v1_transforms_get_with_http_info(
        self,
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v1_transforms_get_without_preload_content(
        self,
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
            None,
    ...
    def _v1_transforms_get_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def v1_transforms_transform_type_id_get(
        self,
        ...
        _param = self._v1_transforms_transform_type_id_get_serialize(
    ...
    @validate_call
    def v1_transforms_transform_type_id_get_with_http_info(
        self,
        transform_type_id: Annotated[StrictStr, Field(description="Transform type ID")],
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def v1_transforms_transform_type_id_get_without_preload_content(
        self,
        transform_type_id: Annotated[StrictStr, Field(description="Transform type ID")],
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
    ...
    def _v1_transforms_transform_type_id_get_serialize(
        self,
        transform_type_id,
        body,
        _request_auth,
