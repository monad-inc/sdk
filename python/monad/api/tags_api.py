...
class TagsApi:
    ...
    def list_tag_resources(
        ...
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        tag: Annotated[StrictStr, Field(description="Tag ID or name")],
        limit: Annotated[Optional[StrictInt], Field(description="Page size (default 10, max 100)")] = None,
        ...
        _param = self._list_tag_resources_serialize(
            organization_id=organization_id,
            tag=tag,
            limit=limit,
            offset=offset,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RoutesV3TagResourcesResponse",
            '400': "ResponderErrorResponse",
            '404': "ResponderErrorResponse",
            '500': "ResponderErrorResponse",
        }
    ...
    @validate_call
    def list_tag_resources_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        tag: Annotated[StrictStr, Field(description="Tag ID or name")],
        limit: Annotated[Optional[StrictInt], Field(description="Page size (default 10, max 100)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RoutesV3TagResourcesResponse]:
        """List a tag's resources
    ...
    @validate_call
    def list_tag_resources_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        tag: Annotated[StrictStr, Field(description="Tag ID or name")],
        limit: Annotated[Optional[StrictInt], Field(description="Page size (default 10, max 100)")] = None,
    ...
    def _list_tag_resources_serialize(
        self,
        organization_id,
        tag,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/{organization_id}/tags/{tag}/resources',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
