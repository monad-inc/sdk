...
class OrganizationInputsApi:
    ...
    def preview_input(
        ...
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        input_id: Annotated[StrictStr, Field(description="Input ID")],
        preview_input_request: Annotated[PreviewInputRequest, Field(description="Proposed input configuration")],
        ...
        :param input_id: Input ID (required)
        :type input_id: str
        :param preview_input_request: Proposed input configuration (required)
        :type preview_input_request: PreviewInputRequest
        ...
        _param = self._preview_input_serialize(
            organization_id=organization_id,
            input_id=input_id,
            preview_input_request=preview_input_request,
            impact=impact,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def preview_input_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        input_id: Annotated[StrictStr, Field(description="Input ID")],
        preview_input_request: Annotated[PreviewInputRequest, Field(description="Proposed input configuration")],
    ...
    @validate_call
    def preview_input_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        input_id: Annotated[StrictStr, Field(description="Input ID")],
        preview_input_request: Annotated[PreviewInputRequest, Field(description="Proposed input configuration")],
    ...
    def _preview_input_serialize(
        self,
        organization_id,
        input_id,
        preview_input_request,
        impact,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if preview_input_request is not None:
            _body_params = preview_input_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/{organization_id}/inputs/{input_id}/preview',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
