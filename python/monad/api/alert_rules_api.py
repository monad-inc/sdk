...
class AlertRulesApi:
    ...
    @validate_call
    def get_alert_rule_config_meta(
        self,
        ...
        _param = self._get_alert_rule_config_meta_serialize(
    ...
    @validate_call
    def get_alert_rule_config_meta_with_http_info(
        self,
        alert_rule_type_id: Annotated[StrictStr, Field(description="Alert Rule Type ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_alert_rule_config_meta_without_preload_content(
        self,
        alert_rule_type_id: Annotated[StrictStr, Field(description="Alert Rule Type ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_alert_rule_config_meta_serialize(
        self,
        alert_rule_type_id,
        _request_auth,
        _content_type,
    ...
    def list_alert_rule_types(
        ...
        _param = self._list_alert_rule_types_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_alert_rule_types_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_alert_rule_types_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_alert_rule_types_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
