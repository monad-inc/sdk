...
class OrganizationQuotasApi:
    ...
    @validate_call
    def v2_organization_id_quotas_get(
        self,
        ...
        _param = self._v2_organization_id_quotas_get_serialize(
    ...
    @validate_call
    def v2_organization_id_quotas_get_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        limit: Annotated[Optional[StrictInt], Field(description="Limit")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Offset")] = None,
    ...
    @validate_call
    def v2_organization_id_quotas_get_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        limit: Annotated[Optional[StrictInt], Field(description="Limit")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Offset")] = None,
    ...
    def _v2_organization_id_quotas_get_serialize(
        self,
        organization_id,
        limit,
        offset,
