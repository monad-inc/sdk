...
class TransformsRecommendationsApi:
    ...
    @validate_call
    def v3_organization_id_transform_recommendations_optimizers_get(
        self,
        ...
        _param = self._v3_organization_id_transform_recommendations_optimizers_get_serialize(
    ...
    @validate_call
    def v3_organization_id_transform_recommendations_optimizers_get_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v3_organization_id_transform_recommendations_optimizers_get_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        _request_timeout: Union[
            None,
    ...
    def _v3_organization_id_transform_recommendations_optimizers_get_serialize(
        self,
        organization_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def v3_organization_id_transform_recommendations_post(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        ...
        _param = self._v3_organization_id_transform_recommendations_post_serialize(
            organization_id=organization_id,
    ...
    @validate_call
    def v3_organization_id_transform_recommendations_post_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        routes_v3_transform_recommendation_request: Annotated[RoutesV3TransformRecommendationRequest, Field(description="Security data to analyze")],
        _request_timeout: Union[
    ...
    @validate_call
    def v3_organization_id_transform_recommendations_post_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        routes_v3_transform_recommendation_request: Annotated[RoutesV3TransformRecommendationRequest, Field(description="Security data to analyze")],
        _request_timeout: Union[
    ...
    def _v3_organization_id_transform_recommendations_post_serialize(
        self,
        organization_id,
