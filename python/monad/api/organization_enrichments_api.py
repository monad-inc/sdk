...
class OrganizationEnrichmentsApi:
    ...
    @validate_call
    def v3_organization_id_enrichments_enrichment_id_put(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        enrichment_id: Annotated[StrictStr, Field(description="Enrichment ID")],
        ...
        _param = self._v3_organization_id_enrichments_enrichment_id_put_serialize(
            organization_id=organization_id,
            enrichment_id=enrichment_id,
    ...
    @validate_call
    def v3_organization_id_enrichments_enrichment_id_put_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        enrichment_id: Annotated[StrictStr, Field(description="Enrichment ID")],
        routes_v3_put_enrichment_request: Annotated[RoutesV3PutEnrichmentRequest, Field(description="Enrichment configuration update")],
    ...
    @validate_call
    def v3_organization_id_enrichments_enrichment_id_put_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        enrichment_id: Annotated[StrictStr, Field(description="Enrichment ID")],
        routes_v3_put_enrichment_request: Annotated[RoutesV3PutEnrichmentRequest, Field(description="Enrichment configuration update")],
    ...
    def _v3_organization_id_enrichments_enrichment_id_put_serialize(
        self,
        organization_id,
        enrichment_id,
