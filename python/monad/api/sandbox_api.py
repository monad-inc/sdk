...
class SandboxApi:
    ...
    @validate_call
    def v2_organization_id_sandbox_transform_post(
        self,
        ...
        _param = self._v2_organization_id_sandbox_transform_post_serialize(
    ...
    @validate_call
    def v2_organization_id_sandbox_transform_post_with_http_info(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        routes_v2_apply_transformation_request: Annotated[RoutesV2ApplyTransformationRequest, Field(description="Transform configuration and record")],
        _request_timeout: Union[
    ...
    @validate_call
    def v2_organization_id_sandbox_transform_post_without_preload_content(
        self,
        organization_id: Annotated[StrictStr, Field(description="Organization ID")],
        routes_v2_apply_transformation_request: Annotated[RoutesV2ApplyTransformationRequest, Field(description="Transform configuration and record")],
        _request_timeout: Union[
    ...
    def _v2_organization_id_sandbox_transform_post_serialize(
        self,
        organization_id,
