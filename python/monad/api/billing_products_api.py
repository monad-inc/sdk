...
class BillingProductsApi:
    ...
    @validate_call
    def cancel_billing_account_subscription(
        self,
        ...
        _param = self._cancel_billing_account_subscription_serialize(
    ...
    @validate_call
    def cancel_billing_account_subscription_with_http_info(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="Billing Account ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cancel_billing_account_subscription_without_preload_content(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="Billing Account ID")],
        _request_timeout: Union[
            None,
    ...
    def _cancel_billing_account_subscription_serialize(
        self,
        billing_account_id,
        _request_auth,
        _content_type,
    ...
    def get_billing_account_subscription(
        ...
        _param = self._get_billing_account_subscription_serialize(
            billing_account_id=billing_account_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_billing_account_subscription_with_http_info(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="Billing Account ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_billing_account_subscription_without_preload_content(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="Billing Account ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_billing_account_subscription_serialize(
        self,
        billing_account_id,
        _request_auth,
        _content_type,
    ...
    def get_billing_products(
        ...
        _param = self._get_billing_products_serialize(
    ...
    @validate_call
    def get_billing_products_with_http_info(
        self,
        show_inactive: Annotated[Optional[StrictBool], Field(description="Show inactive products")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Limit")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Offset")] = None,
    ...
    @validate_call
    def get_billing_products_without_preload_content(
        self,
        show_inactive: Annotated[Optional[StrictBool], Field(description="Show inactive products")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="Limit")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Offset")] = None,
    ...
    def _get_billing_products_serialize(
        self,
        show_inactive,
        limit,
        offset,
