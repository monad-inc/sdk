...
class PipelineNodeStatusProgressTimestamps(BaseModel):
    """
    PipelineNodeStatusProgressTimestamps
    """ # noqa: E501
    timestamps: Optional[List[PipelineNodeStatusProgressTimestamp]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timestamps": [PipelineNodeStatusProgressTimestamp.from_dict(_item) for _item in obj["timestamps"]] if obj.get("timestamps") is not None else None
        })
        return _obj
