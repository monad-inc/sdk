...
class GithubComAwsAwsSdkGoV2ServiceSecretsmanagerTypesFilter(BaseModel):
    """
    GithubComAwsAwsSdkGoV2ServiceSecretsmanagerTypesFilter
    """ # noqa: E501
    key: Optional[TypesFilterNameStringType] = None
    values: Optional[List[StrictStr]] = Field(default=None, description="The keyword to filter for.  You can prefix your search value with an exclamation mark ( ! ) in order to perform negation filters.")
