...
class DatabricksWriteMode(BaseModel):
    """
    ...
    copy_into: Optional[DatabricksCopyIntoWriteMode] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "copy_into": DatabricksCopyIntoWriteMode.from_dict(obj["copy_into"]) if obj.get("copy_into") is not None else None,
