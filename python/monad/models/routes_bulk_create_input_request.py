...
class RoutesBulkCreateInputRequest(BaseModel):
    """
    RoutesBulkCreateInputRequest
    """ # noqa: E501
    inputs: List[RoutesCreateInputRequest]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": [RoutesCreateInputRequest.from_dict(_item) for _item in obj["inputs"]] if obj.get("inputs") is not None else None
        })
        return _obj
