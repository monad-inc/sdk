...
class ModelsOutput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["config", "created_at", "description", "id", "managed_by", "name", "organization_id", "references", "share_details", "template_settings", "type", "updated_at", "version"]
