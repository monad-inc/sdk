...
class AuthenticationtypesConnectionConfig(BaseModel):
    """
    Connection Config to be updated
    """ # noqa: E501
    auth0: Optional[AuthenticationtypesAuth0] = None
    __properties: ClassVar[List[str]] = ["auth0"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auth0": AuthenticationtypesAuth0.from_dict(obj["auth0"]) if obj.get("auth0") is not None else None
        })
        return _obj
