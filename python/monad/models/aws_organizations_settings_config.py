...
class AwsOrganizationsSettingsConfig(BaseModel):
    """
    AwsOrganizationsSettingsConfig
    """ # noqa: E501
    child_type: Optional[StrictStr] = Field(default=None, description="Specifies whether to list AWS accounts or organizational units (OUs) as children of the parent entity.")
