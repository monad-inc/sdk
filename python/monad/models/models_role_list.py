...
class ModelsRoleList(BaseModel):
    """
    ModelsRoleList
    """ # noqa: E501
    pagination: Optional[ModelsPagination] = None
    roles: Optional[List[ModelsRole]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "roles": [ModelsRole.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj
