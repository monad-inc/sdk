...
class RoutesV2OutputConfig(BaseModel):
    """
    RoutesV2OutputConfig
    """ # noqa: E501
    secrets: Optional[RoutesV2OutputConfigSecrets] = None
    settings: Optional[RoutesV2OutputConfigSettings] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "secrets": RoutesV2OutputConfigSecrets.from_dict(obj["secrets"]) if obj.get("secrets") is not None else None,
            "settings": RoutesV2OutputConfigSettings.from_dict(obj["settings"]) if obj.get("settings") is not None else None
        })
        return _obj
