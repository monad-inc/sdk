...
class SecretProcessesorOutputConfigSettings(BaseModel):
    ...
    oneof_schema_1_validator: Optional[AwssqsoutputSettingsConfig] = None
    # data type: BigquerySettingsConfig
    oneof_schema_2_validator: Optional[BigquerySettingsConfig] = None
    # data type: CriblHttpSettingsConfig
    oneof_schema_3_validator: Optional[CriblHttpSettingsConfig] = None
    # data type: ElasticsearchSettingsConfig
    oneof_schema_4_validator: Optional[ElasticsearchSettingsConfig] = None
    # data type: GoogleCloudStorageOutputSettingsConfig
    oneof_schema_5_validator: Optional[GoogleCloudStorageOutputSettingsConfig] = None
    # data type: HttpSettingsConfig
    oneof_schema_6_validator: Optional[HttpSettingsConfig] = None
    # data type: Dict[str, object]
    oneof_schema_7_validator: Optional[Dict[str, Any]] = None
    # data type: NextGenSiemSettingsConfig
    oneof_schema_8_validator: Optional[NextGenSiemSettingsConfig] = None
    # data type: ObjectStorageSettingsConfig
    oneof_schema_9_validator: Optional[ObjectStorageSettingsConfig] = None
    # data type: OpensearchSettingsConfig
    oneof_schema_10_validator: Optional[OpensearchSettingsConfig] = None
    # data type: PagerdutySettingsConfig
    oneof_schema_11_validator: Optional[PagerdutySettingsConfig] = None
    # data type: PostgresqlSettingsConfig
    oneof_schema_12_validator: Optional[PostgresqlSettingsConfig] = None
    # data type: S3SettingsConfig
    oneof_schema_13_validator: Optional[S3SettingsConfig] = None
    # data type: SecurityLakeSettingsConfig
    oneof_schema_14_validator: Optional[SecurityLakeSettingsConfig] = None
    # data type: SentinelSettingsConfig
    oneof_schema_15_validator: Optional[SentinelSettingsConfig] = None
    # data type: SnowflakeOutputSettingsConfig
    oneof_schema_16_validator: Optional[SnowflakeOutputSettingsConfig] = None
    # data type: SplunkSettingsConfig
    oneof_schema_17_validator: Optional[SplunkSettingsConfig] = None
    # data type: SumologicSettingsConfig
    oneof_schema_18_validator: Optional[SumologicSettingsConfig] = None
    actual_instance: Optional[Union[AwssqsoutputSettingsConfig, BigquerySettingsConfig, CriblHttpSettingsConfig, Dict[str, object], ElasticsearchSettingsConfig, GoogleCloudStorageOutputSettingsConfig, HttpSettingsConfig, NextGenSiemSettingsConfig, ObjectStorageSettingsConfig, OpensearchSettingsConfig, PagerdutySettingsConfig, PostgresqlSettingsConfig, S3SettingsConfig, SecurityLakeSettingsConfig, SentinelSettingsConfig, SnowflakeOutputSettingsConfig, SplunkSettingsConfig, SumologicSettingsConfig]] = None
    one_of_schemas: Set[str] = { "AwssqsoutputSettingsConfig", "BigquerySettingsConfig", "CriblHttpSettingsConfig", "Dict[str, object]", "ElasticsearchSettingsConfig", "GoogleCloudStorageOutputSettingsConfig", "HttpSettingsConfig", "NextGenSiemSettingsConfig", "ObjectStorageSettingsConfig", "OpensearchSettingsConfig", "PagerdutySettingsConfig", "PostgresqlSettingsConfig", "S3SettingsConfig", "SecurityLakeSettingsConfig", "SentinelSettingsConfig", "SnowflakeOutputSettingsConfig", "SplunkSettingsConfig", "SumologicSettingsConfig" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in SecretProcessesorOutputConfigSettings with oneOf schemas: AwssqsoutputSettingsConfig, BigquerySettingsConfig, CriblHttpSettingsConfig, Dict[str, object], ElasticsearchSettingsConfig, GoogleCloudStorageOutputSettingsConfig, HttpSettingsConfig, NextGenSiemSettingsConfig, ObjectStorageSettingsConfig, OpensearchSettingsConfig, PagerdutySettingsConfig, PostgresqlSettingsConfig, S3SettingsConfig, SecurityLakeSettingsConfig, SentinelSettingsConfig, SnowflakeOutputSettingsConfig, SplunkSettingsConfig, SumologicSettingsConfig. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in SecretProcessesorOutputConfigSettings with oneOf schemas: AwssqsoutputSettingsConfig, BigquerySettingsConfig, CriblHttpSettingsConfig, Dict[str, object], ElasticsearchSettingsConfig, GoogleCloudStorageOutputSettingsConfig, HttpSettingsConfig, NextGenSiemSettingsConfig, ObjectStorageSettingsConfig, OpensearchSettingsConfig, PagerdutySettingsConfig, PostgresqlSettingsConfig, S3SettingsConfig, SecurityLakeSettingsConfig, SentinelSettingsConfig, SnowflakeOutputSettingsConfig, SplunkSettingsConfig, SumologicSettingsConfig. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into SecretProcessesorOutputConfigSettings with oneOf schemas: AwssqsoutputSettingsConfig, BigquerySettingsConfig, CriblHttpSettingsConfig, Dict[str, object], ElasticsearchSettingsConfig, GoogleCloudStorageOutputSettingsConfig, HttpSettingsConfig, NextGenSiemSettingsConfig, ObjectStorageSettingsConfig, OpensearchSettingsConfig, PagerdutySettingsConfig, PostgresqlSettingsConfig, S3SettingsConfig, SecurityLakeSettingsConfig, SentinelSettingsConfig, SnowflakeOutputSettingsConfig, SplunkSettingsConfig, SumologicSettingsConfig. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], AwssqsoutputSettingsConfig, BigquerySettingsConfig, CriblHttpSettingsConfig, Dict[str, object], ElasticsearchSettingsConfig, GoogleCloudStorageOutputSettingsConfig, HttpSettingsConfig, NextGenSiemSettingsConfig, ObjectStorageSettingsConfig, OpensearchSettingsConfig, PagerdutySettingsConfig, PostgresqlSettingsConfig, S3SettingsConfig, SecurityLakeSettingsConfig, SentinelSettingsConfig, SnowflakeOutputSettingsConfig, SplunkSettingsConfig, SumologicSettingsConfig]]:
