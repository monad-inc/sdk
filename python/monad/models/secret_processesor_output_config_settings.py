...
class SecretProcessesorOutputConfigSettings(BaseModel):
    ...
    # data type: DatabricksDeltaTableSettingsConfig
    oneof_schema_7_validator: Optional[DatabricksDeltaTableSettingsConfig] = None
    # data type: DatabricksLakehouseSettingsConfig
    oneof_schema_8_validator: Optional[DatabricksLakehouseSettingsConfig] = None
    # data type: DatabricksLakewatchSettingsConfig
    oneof_schema_9_validator: Optional[DatabricksLakewatchSettingsConfig] = None
    # data type: DatadogSettingsConfig
    oneof_schema_10_validator: Optional[DatadogSettingsConfig] = None
    ...
    oneof_schema_17_validator: Optional[Dict[str, Any]] = None
    # data type: NextGenSiemSettingsConfig
    oneof_schema_18_validator: Optional[NextGenSiemSettingsConfig] = None
    # data type: ObjectStorageSettingsConfig
    oneof_schema_19_validator: Optional[ObjectStorageSettingsConfig] = None
    # data type: OpensearchSettingsConfig
    oneof_schema_20_validator: Optional[OpensearchSettingsConfig] = None
    # data type: PagerdutySettingsConfig
    oneof_schema_21_validator: Optional[PagerdutySettingsConfig] = None
    # data type: PantherSettingsConfig
    oneof_schema_22_validator: Optional[PantherSettingsConfig] = None
    # data type: PostgresqlSettingsConfig
    oneof_schema_23_validator: Optional[PostgresqlSettingsConfig] = None
    # data type: PrometheusSettingsConfig
    oneof_schema_24_validator: Optional[PrometheusSettingsConfig] = None
    # data type: RunrevealSettingsConfig
    oneof_schema_25_validator: Optional[RunrevealSettingsConfig] = None
    # data type: S3SettingsConfig
    oneof_schema_26_validator: Optional[S3SettingsConfig] = None
    # data type: ScannerSettingsConfig
    oneof_schema_27_validator: Optional[ScannerSettingsConfig] = None
    # data type: SecurityLakeSettingsConfig
    oneof_schema_28_validator: Optional[SecurityLakeSettingsConfig] = None
    # data type: Sentinelv2SettingsConfig
    oneof_schema_29_validator: Optional[Sentinelv2SettingsConfig] = None
    # data type: SlackSettingsConfig
    oneof_schema_30_validator: Optional[SlackSettingsConfig] = None
    # data type: SnowflakeOutputSettingsConfig
    oneof_schema_31_validator: Optional[SnowflakeOutputSettingsConfig] = None
    # data type: SnowflakeSnowpipeStreamingSettingsConfig
    oneof_schema_32_validator: Optional[SnowflakeSnowpipeStreamingSettingsConfig] = None
    # data type: SplunkSettingsConfig
    oneof_schema_33_validator: Optional[SplunkSettingsConfig] = None
    # data type: SumologicSettingsConfig
    oneof_schema_34_validator: Optional[SumologicSettingsConfig] = None
    # data type: WazuhSettingsConfig
    oneof_schema_35_validator: Optional[WazuhSettingsConfig] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, CriblHttpSettingsConfig):
            ...
            match += 1
        # validate data type: DatabricksDeltaTableSettingsConfig
        if not isinstance(v, DatabricksDeltaTableSettingsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DatabricksDeltaTableSettingsConfig`")
        else:
            match += 1
        # validate data type: DatabricksLakehouseSettingsConfig
        if not isinstance(v, DatabricksLakehouseSettingsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DatabricksLakehouseSettingsConfig`")
        else:
            match += 1
        # validate data type: DatabricksLakewatchSettingsConfig
        if not isinstance(v, DatabricksLakewatchSettingsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DatabricksLakewatchSettingsConfig`")
        else:
            match += 1
        ...
        if not isinstance(v, S3SettingsConfig):
            ...
            match += 1
        # validate data type: ScannerSettingsConfig
        if not isinstance(v, ScannerSettingsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ScannerSettingsConfig`")
        else:
            match += 1
        ...
        if not isinstance(v, SecurityLakeSettingsConfig):
            ...
            match += 1
        # validate data type: Sentinelv2SettingsConfig
        if not isinstance(v, Sentinelv2SettingsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `Sentinelv2SettingsConfig`")
        else:
            match += 1
        ...
        if not isinstance(v, SnowflakeOutputSettingsConfig):
            ...
            match += 1
        # validate data type: SnowflakeSnowpipeStreamingSettingsConfig
        if not isinstance(v, SnowflakeSnowpipeStreamingSettingsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `SnowflakeSnowpipeStreamingSettingsConfig`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into DatabricksDeltaTableSettingsConfig
        try:
            instance.actual_instance = DatabricksDeltaTableSettingsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into DatabricksLakehouseSettingsConfig
        try:
            instance.actual_instance = DatabricksLakehouseSettingsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into DatabricksLakewatchSettingsConfig
        try:
            instance.actual_instance = DatabricksLakewatchSettingsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into ScannerSettingsConfig
        try:
            instance.actual_instance = ScannerSettingsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into Sentinelv2SettingsConfig
        try:
            instance.actual_instance = Sentinelv2SettingsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into SnowflakeSnowpipeStreamingSettingsConfig
        try:
            instance.actual_instance = SnowflakeSnowpipeStreamingSettingsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
