...
class SecretProcessesorOutputConfigSettings(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, SecurityLakeSettingsConfig):
            ...
            match += 1
        # validate data type: SentinelThreatIntelligenceSettingsConfig
        if not isinstance(v, SentinelThreatIntelligenceSettingsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `SentinelThreatIntelligenceSettingsConfig`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into SentinelThreatIntelligenceSettingsConfig
        try:
            instance.actual_instance = SentinelThreatIntelligenceSettingsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
