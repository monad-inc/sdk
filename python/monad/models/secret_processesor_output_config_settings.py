...
class SecretProcessesorOutputConfigSettings(BaseModel):
    ...
    oneof_schema_7_validator: Optional[ObjectStorageSettingsConfig] = None
    # data type: OpensearchSettingsConfig
    oneof_schema_8_validator: Optional[OpensearchSettingsConfig] = None
    # data type: PagerdutySettingsConfig
    oneof_schema_9_validator: Optional[PagerdutySettingsConfig] = None
    # data type: PostgresqlSettingsConfig
    oneof_schema_10_validator: Optional[PostgresqlSettingsConfig] = None
    # data type: S3SettingsConfig
    oneof_schema_11_validator: Optional[S3SettingsConfig] = None
    # data type: SecurityLakeSettingsConfig
    oneof_schema_12_validator: Optional[SecurityLakeSettingsConfig] = None
    # data type: SentinelSettingsConfig
    oneof_schema_13_validator: Optional[SentinelSettingsConfig] = None
    # data type: SnowflakeOutputSettingsConfig
    oneof_schema_14_validator: Optional[SnowflakeOutputSettingsConfig] = None
    # data type: SplunkSettingsConfig
    oneof_schema_15_validator: Optional[SplunkSettingsConfig] = None
    # data type: SumologicSettingsConfig
    oneof_schema_16_validator: Optional[SumologicSettingsConfig] = None
