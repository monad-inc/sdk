...
class RoutesUpdateInputRequest(BaseModel):
    """
    RoutesUpdateInputRequest
    """ # noqa: E501
    config: Optional[RoutesUpdateInputRequestConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": RoutesUpdateInputRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
