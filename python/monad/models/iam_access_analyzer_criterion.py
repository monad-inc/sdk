...
class IamAccessAnalyzerCriterion(BaseModel):
    """
    IamAccessAnalyzerCriterion
    """ # noqa: E501
    contains: Optional[List[StrictStr]] = None
    eq: Optional[List[StrictStr]] = None
    exists: Optional[StrictBool] = None
    neq: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["contains", "eq", "exists", "neq"]
