...
class BigqueryCronSettingsConfig(BaseModel):
    """
    ...
    query: Optional[StrictStr] = Field(default=None, description="Optional custom query to use instead of table")
    table: Optional[StrictStr] = Field(default=None, description="The BigQuery table ID to query data from")
    __properties: ClassVar[List[str]] = ["cron", "dataset", "project", "query", "table"]
