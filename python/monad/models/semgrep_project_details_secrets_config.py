...
class SemgrepProjectDetailsSecretsConfig(BaseModel):
    """
    Semgrep project details secrets
    """ # noqa: E501
    api_key: Optional[StrictStr] = Field(default=None, description="API Key for the Semgrep API. This is required to authenticate requests.")
