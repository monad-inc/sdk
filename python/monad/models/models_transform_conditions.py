...
class ModelsTransformConditions(BaseModel):
    """
    ModelsTransformConditions
    """ # noqa: E501
    conditions: Optional[ModelsConditionEvaluatable] = None
    on_fail: Optional[StrictStr] = Field(default=None, description="will default to bypass if left empty on create/update")
    __properties: ClassVar[List[str]] = ["conditions", "on_fail"]
