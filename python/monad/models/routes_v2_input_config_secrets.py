...
class RoutesV2InputConfigSecrets(BaseModel):
    ...
    oneof_schema_26_validator: Optional[LogAnalyticsQuerySecretsConfig] = None
    # data type: LoginActivitySecretsConfig
    oneof_schema_27_validator: Optional[LoginActivitySecretsConfig] = None
    # data type: LoginSessionsSecretsConfig
    oneof_schema_28_validator: Optional[LoginSessionsSecretsConfig] = None
    # data type: Dict[str, object]
    oneof_schema_29_validator: Optional[Dict[str, Any]] = None
    # data type: object
    oneof_schema_30_validator: Optional[Dict[str, Any]] = Field(default=None, description="Monad HTTP secrets")
    # data type: object
    oneof_schema_31_validator: Optional[Dict[str, Any]] = Field(default=None, description="Monad Log secrets")
    # data type: OauthActivitySecretsConfig
    oneof_schema_32_validator: Optional[OauthActivitySecretsConfig] = None
    # data type: RolesInfoSecretsConfig
    oneof_schema_33_validator: Optional[RolesInfoSecretsConfig] = None
    # data type: SemgrepCodeFindingsSecretsConfig
    oneof_schema_34_validator: Optional[SemgrepCodeFindingsSecretsConfig] = None
    # data type: SemgrepDeploymentsSecretsConfig
    oneof_schema_35_validator: Optional[SemgrepDeploymentsSecretsConfig] = None
    # data type: SemgrepProjectDetailsSecretsConfig
    oneof_schema_36_validator: Optional[SemgrepProjectDetailsSecretsConfig] = None
    # data type: SemgrepProjectsSecretsConfig
    oneof_schema_37_validator: Optional[SemgrepProjectsSecretsConfig] = None
    # data type: SemgrepSupplyChainFindingsSecretsConfig
    oneof_schema_38_validator: Optional[SemgrepSupplyChainFindingsSecretsConfig] = None
    # data type: SlackUsersSecretsConfig
    oneof_schema_39_validator: Optional[SlackUsersSecretsConfig] = None
    # data type: SlackgroupsSecretsConfig
    oneof_schema_40_validator: Optional[SlackgroupsSecretsConfig] = None
    # data type: SnykIssuesSecretsConfig
    oneof_schema_41_validator: Optional[SnykIssuesSecretsConfig] = None
    # data type: SnykOrganizationsSecretsConfig
    oneof_schema_42_validator: Optional[SnykOrganizationsSecretsConfig] = None
    # data type: SnykProjectsSecretsConfig
    oneof_schema_43_validator: Optional[SnykProjectsSecretsConfig] = None
    # data type: SnykTargetsSecretsConfig
    oneof_schema_44_validator: Optional[SnykTargetsSecretsConfig] = None
    # data type: TenableAssetsSecretsConfig
    oneof_schema_45_validator: Optional[TenableAssetsSecretsConfig] = None
    # data type: TenableVulnerabilitiesSecretsConfig
    oneof_schema_46_validator: Optional[TenableVulnerabilitiesSecretsConfig] = None
    # data type: UsersSecretsConfig
    oneof_schema_47_validator: Optional[UsersSecretsConfig] = None
    # data type: UsersInfoSecretsConfig
    oneof_schema_48_validator: Optional[UsersInfoSecretsConfig] = None
    # data type: VulnerabilitiesSecretsConfig
    oneof_schema_49_validator: Optional[VulnerabilitiesSecretsConfig] = None
    # data type: VulnerabilityFindingsSecretsConfig
    oneof_schema_50_validator: Optional[VulnerabilityFindingsSecretsConfig] = None
