...
class ModelsUserList(BaseModel):
    """
    ModelsUserList
    """ # noqa: E501
    pagination: Optional[ModelsPagination] = None
    users: Optional[List[ModelsUser]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [ModelsUser.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
