...
class ModelsSecretList(BaseModel):
    """
    ModelsSecretList
    """ # noqa: E501
    pagination: Optional[ModelsPagination] = None
    secrets: Optional[List[ModelsSecret]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "secrets": [ModelsSecret.from_dict(_item) for _item in obj["secrets"]] if obj.get("secrets") is not None else None
        })
        return _obj
