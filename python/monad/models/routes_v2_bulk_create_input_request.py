...
class RoutesV2BulkCreateInputRequest(BaseModel):
    """
    RoutesV2BulkCreateInputRequest
    """ # noqa: E501
    inputs: Optional[List[RoutesV2CreateInputRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inputs": [RoutesV2CreateInputRequest.from_dict(_item) for _item in obj["inputs"]] if obj.get("inputs") is not None else None
        })
        return _obj
