...
class IamAccessAnalyzerFilter(BaseModel):
    """
    IamAccessAnalyzerFilter
    """ # noqa: E501
    criterion: Optional[IamAccessAnalyzerCriterion] = None
    filter_key: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["criterion", "filter_key"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criterion": IamAccessAnalyzerCriterion.from_dict(obj["criterion"]) if obj.get("criterion") is not None else None,
