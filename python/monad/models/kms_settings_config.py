...
class KmsSettingsConfig(BaseModel):
    """
    KmsSettingsConfig
    """ # noqa: E501
    cron: Optional[StrictStr] = Field(default=None, description="Cron expression for scheduling the input")
    kms_type: Optional[StrictStr] = Field(default=None, description="Type of KMS resources to list")
    ...
    __properties: ClassVar[List[str]] = ["cron", "kms_type", "region", "role_arn"]
