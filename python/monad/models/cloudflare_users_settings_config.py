...
class CloudflareUsersSettingsConfig(BaseModel):
    """
    Cloudflare Users settings
    """ # noqa: E501
    account_id: Optional[StrictStr] = Field(default=None, description="Cloudflare account ID (required path parameter)")
    ...
    __properties: ClassVar[List[str]] = ["account_id", "cron", "use_synthetic_data"]
