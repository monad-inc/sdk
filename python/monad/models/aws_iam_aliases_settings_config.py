...
class AwsIamAliasesSettingsConfig(BaseModel):
    """
    AwsIamAliasesSettingsConfig
    """ # noqa: E501
    accounts: Optional[List[AwsIamAliasesAccount]] = Field(default=None, description="List of AWS accounts to fetch IAM aliases from")
    ...
    __properties: ClassVar[List[str]] = ["accounts", "cron", "use_synthetic_data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [AwsIamAliasesAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None,
            "cron": obj.get("cron"),
