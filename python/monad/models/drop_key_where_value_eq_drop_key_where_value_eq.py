...
class DropKeyWhereValueEqDropKeyWhereValueEq(BaseModel):
    """
    DropKeyWhereValueEqDropKeyWhereValueEq
    """ # noqa: E501
    arguments: Optional[DropKeyWhereValueEqArgumentsConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "arguments": DropKeyWhereValueEqArgumentsConfig.from_dict(obj["arguments"]) if obj.get("arguments") is not None else None
        })
        return _obj
