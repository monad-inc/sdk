...
class ModelsTransform(BaseModel):
    """
    ModelsTransform
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["config", "created_at", "description", "id", "managed_by", "name", "organization_id", "references", "share_details", "updated_at", "version"]
