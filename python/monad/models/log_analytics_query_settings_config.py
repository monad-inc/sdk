...
class LogAnalyticsQuerySettingsConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["backfill_start_time", "ingestion_delay", "query", "rate_limit", "tenant_id", "use_synthetic_data", "workspace_id"]
