...
class SecretProcessesorOutputConfigSecrets(BaseModel):
    ...
    oneof_schema_14_validator: Optional[NextGenSiemSecretsConfig] = None
    # data type: ObjectStorageSecretsConfig
    oneof_schema_15_validator: Optional[ObjectStorageSecretsConfig] = None
    # data type: OpensearchSecretsConfig
    oneof_schema_16_validator: Optional[OpensearchSecretsConfig] = None
    # data type: PagerdutySecretsConfig
    oneof_schema_17_validator: Optional[PagerdutySecretsConfig] = None
    # data type: PantherSecretsConfig
    oneof_schema_18_validator: Optional[PantherSecretsConfig] = None
    # data type: PostgresqlSecretsConfig
    oneof_schema_19_validator: Optional[PostgresqlSecretsConfig] = None
    # data type: S3SecretsConfig
    oneof_schema_20_validator: Optional[S3SecretsConfig] = None
    # data type: Sentinelv2SecretsConfig
    oneof_schema_21_validator: Optional[Sentinelv2SecretsConfig] = None
    # data type: SnowflakeOutputSecretsConfig
    oneof_schema_22_validator: Optional[SnowflakeOutputSecretsConfig] = None
    ...
    oneof_schema_25_validator: Optional[WazuhSecretsConfig] = None
