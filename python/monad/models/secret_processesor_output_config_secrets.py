...
class SecretProcessesorOutputConfigSecrets(BaseModel):
    ...
    oneof_schema_8_validator: Optional[ElasticsearchSecretsConfig] = None
    # data type: GoogleCloudStorageOutputSecretsConfig
    oneof_schema_9_validator: Optional[GoogleCloudStorageOutputSecretsConfig] = None
    # data type: HttpSecretsConfig
    oneof_schema_10_validator: Optional[HttpSecretsConfig] = None
    # data type: KafkaSecretsConfig
    oneof_schema_11_validator: Optional[KafkaSecretsConfig] = None
    # data type: object
    oneof_schema_12_validator: Optional[Dict[str, Any]] = Field(default=None, description="KV Lookup Output Secrets")
    # data type: NextGenSiemSecretsConfig
    oneof_schema_13_validator: Optional[NextGenSiemSecretsConfig] = None
    # data type: ObjectStorageSecretsConfig
    oneof_schema_14_validator: Optional[ObjectStorageSecretsConfig] = None
    # data type: OpensearchSecretsConfig
    oneof_schema_15_validator: Optional[OpensearchSecretsConfig] = None
    # data type: PagerdutySecretsConfig
    oneof_schema_16_validator: Optional[PagerdutySecretsConfig] = None
    # data type: PantherSecretsConfig
    oneof_schema_17_validator: Optional[PantherSecretsConfig] = None
    # data type: PostgresqlSecretsConfig
    oneof_schema_18_validator: Optional[PostgresqlSecretsConfig] = None
    # data type: S3SecretsConfig
    oneof_schema_19_validator: Optional[S3SecretsConfig] = None
    # data type: Sentinelv2SecretsConfig
    oneof_schema_20_validator: Optional[Sentinelv2SecretsConfig] = None
    # data type: SnowflakeOutputSecretsConfig
    oneof_schema_21_validator: Optional[SnowflakeOutputSecretsConfig] = None
    # data type: SplunkSecretsConfig
    oneof_schema_22_validator: Optional[SplunkSecretsConfig] = None
    # data type: SumologicSecretsConfig
    oneof_schema_23_validator: Optional[SumologicSecretsConfig] = None
    # data type: WazuhSecretsConfig
    oneof_schema_24_validator: Optional[WazuhSecretsConfig] = None
    actual_instance: Optional[Union[AbsSecretsConfig, AxiomSecretsConfig, BackblazeSecretsConfig, BigquerySecretsConfig, CriblHttpSecretsConfig, DatabricksDeltaTableSecretsConfig, DatadogSecretsConfig, ElasticsearchSecretsConfig, GoogleCloudStorageOutputSecretsConfig, HttpSecretsConfig, KafkaSecretsConfig, NextGenSiemSecretsConfig, ObjectStorageSecretsConfig, OpensearchSecretsConfig, PagerdutySecretsConfig, PantherSecretsConfig, PostgresqlSecretsConfig, S3SecretsConfig, Sentinelv2SecretsConfig, SnowflakeOutputSecretsConfig, SplunkSecretsConfig, SumologicSecretsConfig, WazuhSecretsConfig, object]] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, HttpSecretsConfig):
            ...
            match += 1
        # validate data type: KafkaSecretsConfig
        if not isinstance(v, KafkaSecretsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `KafkaSecretsConfig`")
        else:
            match += 1
        ...
        if not isinstance(v, S3SecretsConfig):
            ...
            match += 1
        # validate data type: Sentinelv2SecretsConfig
        if not isinstance(v, Sentinelv2SecretsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `Sentinelv2SecretsConfig`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into KafkaSecretsConfig
        try:
            instance.actual_instance = KafkaSecretsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into Sentinelv2SecretsConfig
        try:
            instance.actual_instance = Sentinelv2SecretsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into WazuhSecretsConfig
        try:
            instance.actual_instance = WazuhSecretsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
