...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_2_validator: Optional[AdminLogsSettingsConfig] = None
    # data type: AivenServiceLogsSettingsConfig
    oneof_schema_3_validator: Optional[AivenServiceLogsSettingsConfig] = None
    # data type: AlertCenterSettingsConfig
    oneof_schema_4_validator: Optional[AlertCenterSettingsConfig] = None
    # data type: ArizeAuditLogsSettingsConfig
    oneof_schema_5_validator: Optional[ArizeAuditLogsSettingsConfig] = None
    # data type: AuditLogsSettingsConfig
    oneof_schema_6_validator: Optional[AuditLogsSettingsConfig] = None
    # data type: AuthLogsSettingsConfig
    oneof_schema_7_validator: Optional[AuthLogsSettingsConfig] = None
    # data type: AwsGuarddutySettingsConfig
    oneof_schema_8_validator: Optional[AwsGuarddutySettingsConfig] = None
    # data type: AwsIamAliasesSettingsConfig
    oneof_schema_9_validator: Optional[AwsIamAliasesSettingsConfig] = None
    # data type: AwsOrganizationsSettingsConfig
    oneof_schema_10_validator: Optional[AwsOrganizationsSettingsConfig] = None
    ...
    oneof_schema_22_validator: Optional[BitwardenEventsSettingsConfig] = None
    # data type: BoxEventsSettingsConfig
    oneof_schema_23_validator: Optional[BoxEventsSettingsConfig] = None
    # data type: BoxUsersSettingsConfig
    oneof_schema_24_validator: Optional[BoxUsersSettingsConfig] = None
    # data type: BrinqaAuditLogsSettingsConfig
    oneof_schema_25_validator: Optional[BrinqaAuditLogsSettingsConfig] = None
    # data type: BugsnagOrgEventsSettingsConfig
    oneof_schema_26_validator: Optional[BugsnagOrgEventsSettingsConfig] = None
    # data type: BuildkiteAuditLogsSettingsConfig
    oneof_schema_27_validator: Optional[BuildkiteAuditLogsSettingsConfig] = None
    # data type: BuildkiteGraphqlInputSettingsConfig
    oneof_schema_28_validator: Optional[BuildkiteGraphqlInputSettingsConfig] = None
    # data type: CisaUserSettingsConfig
    oneof_schema_29_validator: Optional[CisaUserSettingsConfig] = None
    # data type: CloudAssetInventorySettingsConfig
    oneof_schema_30_validator: Optional[CloudAssetInventorySettingsConfig] = None
    # data type: CloudConfigurationFindingsSettingsConfig
    oneof_schema_31_validator: Optional[CloudConfigurationFindingsSettingsConfig] = None
    # data type: CloudLogsSettingsConfig
    oneof_schema_32_validator: Optional[CloudLogsSettingsConfig] = None
    # data type: CloudResourceInventorySettingsConfig
    oneof_schema_33_validator: Optional[CloudResourceInventorySettingsConfig] = None
    # data type: CloudResourceInventoryReportsSettingsConfig
    oneof_schema_34_validator: Optional[CloudResourceInventoryReportsSettingsConfig] = None
    # data type: CloudflareDdosAttackAnalyticsSettingsConfig
    oneof_schema_35_validator: Optional[CloudflareDdosAttackAnalyticsSettingsConfig] = None
    # data type: CloudflareDnsRecordsSettingsConfig
    oneof_schema_36_validator: Optional[CloudflareDnsRecordsSettingsConfig] = None
    # data type: CloudflareFirewallEventsSettingsConfig
    oneof_schema_37_validator: Optional[CloudflareFirewallEventsSettingsConfig] = None
    # data type: CloudflareHttpRequestsSettingsConfig
    oneof_schema_38_validator: Optional[CloudflareHttpRequestsSettingsConfig] = None
    # data type: CloudflarePageShieldConnectionsSettingsConfig
    oneof_schema_39_validator: Optional[CloudflarePageShieldConnectionsSettingsConfig] = None
    # data type: CloudflareRulesetsSettingsConfig
    oneof_schema_40_validator: Optional[CloudflareRulesetsSettingsConfig] = None
    # data type: CloudflareSecurityInsightsSettingsConfig
    oneof_schema_41_validator: Optional[CloudflareSecurityInsightsSettingsConfig] = None
    # data type: CloudflareUrlScannerSettingsConfig
    oneof_schema_42_validator: Optional[CloudflareUrlScannerSettingsConfig] = None
    # data type: CloudflareUsersSettingsConfig
    oneof_schema_43_validator: Optional[CloudflareUsersSettingsConfig] = None
    # data type: CloudflareZeroTrustAccessRequestsSettingsConfig
    oneof_schema_44_validator: Optional[CloudflareZeroTrustAccessRequestsSettingsConfig] = None
    # data type: CloudflareZonesSettingsConfig
    oneof_schema_45_validator: Optional[CloudflareZonesSettingsConfig] = None
    # data type: CloudtrailSettingsConfig
    oneof_schema_46_validator: Optional[CloudtrailSettingsConfig] = None
    # data type: ClumioAuditLogsSettingsConfig
    oneof_schema_47_validator: Optional[ClumioAuditLogsSettingsConfig] = None
    # data type: ClumioConsolidatedAlertsSettingsConfig
    oneof_schema_48_validator: Optional[ClumioConsolidatedAlertsSettingsConfig] = None
    # data type: CodaAuditEventsSettingsConfig
    oneof_schema_49_validator: Optional[CodaAuditEventsSettingsConfig] = None
    # data type: CognitoUsersSettingsConfig
    oneof_schema_50_validator: Optional[CognitoUsersSettingsConfig] = None
    # data type: CortexXsoarManagementLogsSettingsConfig
    oneof_schema_51_validator: Optional[CortexXsoarManagementLogsSettingsConfig] = None
    # data type: CrowdstrikeFdrSettingsConfig
    oneof_schema_52_validator: Optional[CrowdstrikeFdrSettingsConfig] = None
    # data type: CustomerEventDataSettingsConfig
    oneof_schema_53_validator: Optional[CustomerEventDataSettingsConfig] = None
    # data type: DefenderForEndpointAlertsSettingsConfig
    oneof_schema_54_validator: Optional[DefenderForEndpointAlertsSettingsConfig] = None
    # data type: DeviceDetailsSettingsConfig
    oneof_schema_55_validator: Optional[DeviceDetailsSettingsConfig] = None
    # data type: DevicesSettingsConfig
    oneof_schema_56_validator: Optional[DevicesSettingsConfig] = None
    # data type: DuoSecurityActivityLogsSettingsConfig
    oneof_schema_57_validator: Optional[DuoSecurityActivityLogsSettingsConfig] = None
    # data type: EndorLabsAuditLogsSettingsConfig
    oneof_schema_58_validator: Optional[EndorLabsAuditLogsSettingsConfig] = None
    # data type: EntraIdSettingsConfig
    oneof_schema_59_validator: Optional[EntraIdSettingsConfig] = None
    # data type: EventSettingsConfig
    oneof_schema_60_validator: Optional[EventSettingsConfig] = None
    # data type: FleetdmActivityLogsSettingsConfig
    oneof_schema_61_validator: Optional[FleetdmActivityLogsSettingsConfig] = None
    ...
    oneof_schema_66_validator: Optional[GoogleWorkspaceSettingsConfig] = None
    # data type: GreenhouseAuditLogsSettingsConfig
    oneof_schema_67_validator: Optional[GreenhouseAuditLogsSettingsConfig] = None
    # data type: IamAccessAnalyzerSettingsConfig
    oneof_schema_68_validator: Optional[IamAccessAnalyzerSettingsConfig] = None
    # data type: IndividualAlertsSettingsConfig
    oneof_schema_69_validator: Optional[IndividualAlertsSettingsConfig] = None
    # data type: InspectorSettingsConfig
    oneof_schema_70_validator: Optional[InspectorSettingsConfig] = None
    # data type: IssuesSettingsConfig
    oneof_schema_71_validator: Optional[IssuesSettingsConfig] = None
    # data type: IssuesReportSettingsConfig
    oneof_schema_72_validator: Optional[IssuesReportSettingsConfig] = None
    # data type: KmsSettingsConfig
    oneof_schema_73_validator: Optional[KmsSettingsConfig] = None
    # data type: KoiAuditLogsSettingsConfig
    oneof_schema_74_validator: Optional[KoiAuditLogsSettingsConfig] = None
    # data type: LogAnalyticsQuerySettingsConfig
    oneof_schema_75_validator: Optional[LogAnalyticsQuerySettingsConfig] = None
    # data type: LoginSessionsSettingsConfig
    oneof_schema_76_validator: Optional[LoginSessionsSettingsConfig] = None
    # data type: MerakiConfigLogsSettingsConfig
    oneof_schema_77_validator: Optional[MerakiConfigLogsSettingsConfig] = None
    # data type: Microsoft365GenericSettingsConfig
    oneof_schema_78_validator: Optional[Microsoft365GenericSettingsConfig] = None
    # data type: Dict[str, object]
    oneof_schema_79_validator: Optional[Dict[str, Any]] = None
    # data type: MonadLogSettingsConfig
    oneof_schema_80_validator: Optional[MonadLogSettingsConfig] = None
    # data type: ObjectStorageInputSettingsConfig
    oneof_schema_81_validator: Optional[ObjectStorageInputSettingsConfig] = None
    # data type: OfflineenrollmentlogsSettingsConfig
    oneof_schema_82_validator: Optional[OfflineenrollmentlogsSettingsConfig] = None
    # data type: OneloginEventsSettingsConfig
    oneof_schema_83_validator: Optional[OneloginEventsSettingsConfig] = None
    # data type: OpalEventsSettingsConfig
    oneof_schema_84_validator: Optional[OpalEventsSettingsConfig] = None
    # data type: OpenaiSettingsConfig
    oneof_schema_85_validator: Optional[OpenaiSettingsConfig] = None
    # data type: OperationLogsSettingsConfig
    oneof_schema_86_validator: Optional[OperationLogsSettingsConfig] = None
    # data type: OracleSettingsConfig
    oneof_schema_87_validator: Optional[OracleSettingsConfig] = None
    # data type: OrgAuditLogsSettingsConfig
    oneof_schema_88_validator: Optional[OrgAuditLogsSettingsConfig] = None
    # data type: OwnbackupAccountEventsSettingsConfig
    oneof_schema_89_validator: Optional[OwnbackupAccountEventsSettingsConfig] = None
    # data type: PagerdutyAuditRecordsSettingsConfig
    oneof_schema_90_validator: Optional[PagerdutyAuditRecordsSettingsConfig] = None
    # data type: PaloAltoDataSecurityAlertsSettingsConfig
    oneof_schema_91_validator: Optional[PaloAltoDataSecurityAlertsSettingsConfig] = None
    # data type: PolymerSettingsConfig
    oneof_schema_92_validator: Optional[PolymerSettingsConfig] = None
    # data type: PostmanAuditLogsSettingsConfig
    oneof_schema_93_validator: Optional[PostmanAuditLogsSettingsConfig] = None
    # data type: PubsubSettingsConfig
    oneof_schema_94_validator: Optional[PubsubSettingsConfig] = None
    # data type: ResourceEvaluationsSettingsConfig
    oneof_schema_95_validator: Optional[ResourceEvaluationsSettingsConfig] = None
    # data type: RolesInfoSettingsConfig
    oneof_schema_96_validator: Optional[RolesInfoSettingsConfig] = None
    # data type: RootlyAuditLogsSettingsConfig
    oneof_schema_97_validator: Optional[RootlyAuditLogsSettingsConfig] = None
    # data type: SalesforceUsersSettingsConfig
    oneof_schema_98_validator: Optional[SalesforceUsersSettingsConfig] = None
    # data type: SecretsmanagerSettingsConfig
    oneof_schema_99_validator: Optional[SecretsmanagerSettingsConfig] = None
    # data type: SecurityGroupsSettingsConfig
    oneof_schema_100_validator: Optional[SecurityGroupsSettingsConfig] = None
    # data type: SemgrepCodeFindingsSettingsConfig
    oneof_schema_101_validator: Optional[SemgrepCodeFindingsSettingsConfig] = None
    # data type: SemgrepDeploymentsSettingsConfig
    oneof_schema_102_validator: Optional[SemgrepDeploymentsSettingsConfig] = None
    # data type: SemgrepProjectDetailsSettingsConfig
    oneof_schema_103_validator: Optional[SemgrepProjectDetailsSettingsConfig] = None
    # data type: SemgrepProjectsSettingsConfig
    oneof_schema_104_validator: Optional[SemgrepProjectsSettingsConfig] = None
    # data type: SemgrepSupplyChainFindingsSettingsConfig
    oneof_schema_105_validator: Optional[SemgrepSupplyChainFindingsSettingsConfig] = None
    # data type: SentryOrgAuditLogsSettingsConfig
    oneof_schema_106_validator: Optional[SentryOrgAuditLogsSettingsConfig] = None
    # data type: SlackEnterpriseAuditLogsSettingsConfig
    oneof_schema_107_validator: Optional[SlackEnterpriseAuditLogsSettingsConfig] = None
    # data type: SlackUsersSettingsConfig
    oneof_schema_108_validator: Optional[SlackUsersSettingsConfig] = None
    # data type: SlackgroupsSettingsConfig
    oneof_schema_109_validator: Optional[SlackgroupsSettingsConfig] = None
    # data type: SnowflakeInputSettingsConfig
    oneof_schema_110_validator: Optional[SnowflakeInputSettingsConfig] = None
    # data type: SnykIssuesSettingsConfig
    oneof_schema_111_validator: Optional[SnykIssuesSettingsConfig] = None
    # data type: SnykProjectsSettingsConfig
    oneof_schema_112_validator: Optional[SnykProjectsSettingsConfig] = None
    # data type: SnykTargetsSettingsConfig
    oneof_schema_113_validator: Optional[SnykTargetsSettingsConfig] = None
    # data type: SyntheticDataSettingsConfig
    oneof_schema_114_validator: Optional[SyntheticDataSettingsConfig] = None
    # data type: SyntheticDataCustomSettingsConfig
    oneof_schema_115_validator: Optional[SyntheticDataCustomSettingsConfig] = None
    # data type: TailscaleUsersSettingsConfig
    oneof_schema_116_validator: Optional[TailscaleUsersSettingsConfig] = None
    # data type: TaniumGraphqlInputSettingsConfig
    oneof_schema_117_validator: Optional[TaniumGraphqlInputSettingsConfig] = None
    # data type: TeamAccessLogsSettingsConfig
    oneof_schema_118_validator: Optional[TeamAccessLogsSettingsConfig] = None
    # data type: TeamIntegrationLogsSettingsConfig
    oneof_schema_119_validator: Optional[TeamIntegrationLogsSettingsConfig] = None
    # data type: TelephonyLogsSettingsConfig
    oneof_schema_120_validator: Optional[TelephonyLogsSettingsConfig] = None
    # data type: TenableAssetsSettingsConfig
    oneof_schema_121_validator: Optional[TenableAssetsSettingsConfig] = None
    # data type: TenableAssetsCronSettingsConfig
    oneof_schema_122_validator: Optional[TenableAssetsCronSettingsConfig] = None
    # data type: TenableVulnerabilitiesSettingsConfig
    oneof_schema_123_validator: Optional[TenableVulnerabilitiesSettingsConfig] = None
    # data type: TenableVulnerabilitiesCronSettingsConfig
    oneof_schema_124_validator: Optional[TenableVulnerabilitiesCronSettingsConfig] = None
    # data type: TinesAuditLogsSettingsConfig
    oneof_schema_125_validator: Optional[TinesAuditLogsSettingsConfig] = None
    # data type: TinesEventsLogsSettingsConfig
    oneof_schema_126_validator: Optional[TinesEventsLogsSettingsConfig] = None
    # data type: TwilioEventsSettingsConfig
    oneof_schema_127_validator: Optional[TwilioEventsSettingsConfig] = None
    # data type: TwilioSendgridEmailActivitySettingsConfig
    oneof_schema_128_validator: Optional[TwilioSendgridEmailActivitySettingsConfig] = None
    # data type: UniversalSettingsConfig
    oneof_schema_129_validator: Optional[UniversalSettingsConfig] = None
    # data type: UsersSettingsConfig
    oneof_schema_130_validator: Optional[UsersSettingsConfig] = None
    # data type: UsersInfoSettingsConfig
    oneof_schema_131_validator: Optional[UsersInfoSettingsConfig] = None
    # data type: VercelUserEventsSettingsConfig
    oneof_schema_132_validator: Optional[VercelUserEventsSettingsConfig] = None
    # data type: VoltioAuditLogsSettingsConfig
    oneof_schema_133_validator: Optional[VoltioAuditLogsSettingsConfig] = None
    # data type: VulnerabilitiesSettingsConfig
    oneof_schema_134_validator: Optional[VulnerabilitiesSettingsConfig] = None
    # data type: VulnerabilitiesCronSettingsConfig
    oneof_schema_135_validator: Optional[VulnerabilitiesCronSettingsConfig] = None
    # data type: VulnerabilityFindingsSettingsConfig
    oneof_schema_136_validator: Optional[VulnerabilityFindingsSettingsConfig] = None
    # data type: VulnerabilityFindingsReportSettingsConfig
    oneof_schema_137_validator: Optional[VulnerabilityFindingsReportSettingsConfig] = None
    # data type: WizAuditLogsSettingsConfig
    oneof_schema_138_validator: Optional[WizAuditLogsSettingsConfig] = None
    # data type: ZendeskAuditLogsSettingsConfig
    oneof_schema_139_validator: Optional[ZendeskAuditLogsSettingsConfig] = None
    # data type: ZoomActivityLogsSettingsConfig
    oneof_schema_140_validator: Optional[ZoomActivityLogsSettingsConfig] = None
    # data type: ZoomMeetingActivityLogsSettingsConfig
    oneof_schema_141_validator: Optional[ZoomMeetingActivityLogsSettingsConfig] = None
    actual_instance: Optional[Union[ActorsInfoSettingsConfig, AdminLogsSettingsConfig, AivenServiceLogsSettingsConfig, AlertCenterSettingsConfig, ArizeAuditLogsSettingsConfig, AuditLogsSettingsConfig, AuthLogsSettingsConfig, AwsGuarddutySettingsConfig, AwsIamAliasesSettingsConfig, AwsOrganizationsSettingsConfig, AwsS3SettingsConfig, AwssecurityhubSettingsConfig, Awssqss3SettingsConfig, AzureActivityLogsSettingsConfig, AzureBlobStorageSettingsConfig, AzureEventHubsSettingsConfig, AzureVirtualMachineSettingsConfig, AzureVnetFlowLogsSettingsConfig, BackblazeB2SettingsConfig, BigqueryCronSettingsConfig, BigqueryInputSettingsConfig, BitwardenEventsSettingsConfig, BoxEventsSettingsConfig, BoxUsersSettingsConfig, BrinqaAuditLogsSettingsConfig, BugsnagOrgEventsSettingsConfig, BuildkiteAuditLogsSettingsConfig, BuildkiteGraphqlInputSettingsConfig, CisaUserSettingsConfig, CloudAssetInventorySettingsConfig, CloudConfigurationFindingsSettingsConfig, CloudLogsSettingsConfig, CloudResourceInventoryReportsSettingsConfig, CloudResourceInventorySettingsConfig, CloudflareDdosAttackAnalyticsSettingsConfig, CloudflareDnsRecordsSettingsConfig, CloudflareFirewallEventsSettingsConfig, CloudflareHttpRequestsSettingsConfig, CloudflarePageShieldConnectionsSettingsConfig, CloudflareRulesetsSettingsConfig, CloudflareSecurityInsightsSettingsConfig, CloudflareUrlScannerSettingsConfig, CloudflareUsersSettingsConfig, CloudflareZeroTrustAccessRequestsSettingsConfig, CloudflareZonesSettingsConfig, CloudtrailSettingsConfig, ClumioAuditLogsSettingsConfig, ClumioConsolidatedAlertsSettingsConfig, CodaAuditEventsSettingsConfig, CognitoUsersSettingsConfig, CortexXsoarManagementLogsSettingsConfig, CrowdstrikeFdrSettingsConfig, CustomerEventDataSettingsConfig, DefenderForEndpointAlertsSettingsConfig, DeviceDetailsSettingsConfig, DevicesSettingsConfig, Dict[str, object], DuoSecurityActivityLogsSettingsConfig, EndorLabsAuditLogsSettingsConfig, EntraIdSettingsConfig, EventSettingsConfig, FleetdmActivityLogsSettingsConfig, FullScansSettingsConfig, GithubAdvisoryUserSettingsConfig, GitlabIssuesSettingsConfig, GoogleCloudStorageSettingsConfig, GoogleWorkspaceSettingsConfig, GreenhouseAuditLogsSettingsConfig, IamAccessAnalyzerSettingsConfig, IndividualAlertsSettingsConfig, InspectorSettingsConfig, IssuesReportSettingsConfig, IssuesSettingsConfig, KmsSettingsConfig, KoiAuditLogsSettingsConfig, LogAnalyticsQuerySettingsConfig, LoginSessionsSettingsConfig, MerakiConfigLogsSettingsConfig, Microsoft365GenericSettingsConfig, MonadLogSettingsConfig, ObjectStorageInputSettingsConfig, OfflineenrollmentlogsSettingsConfig, OneloginEventsSettingsConfig, OpalEventsSettingsConfig, OpenaiSettingsConfig, OperationLogsSettingsConfig, OracleSettingsConfig, OrgAuditLogsSettingsConfig, OwnbackupAccountEventsSettingsConfig, PagerdutyAuditRecordsSettingsConfig, PaloAltoDataSecurityAlertsSettingsConfig, PolymerSettingsConfig, PostmanAuditLogsSettingsConfig, PubsubSettingsConfig, ResourceEvaluationsSettingsConfig, RolesInfoSettingsConfig, RootlyAuditLogsSettingsConfig, SalesforceUsersSettingsConfig, SecretsmanagerSettingsConfig, SecurityGroupsSettingsConfig, SemgrepCodeFindingsSettingsConfig, SemgrepDeploymentsSettingsConfig, SemgrepProjectDetailsSettingsConfig, SemgrepProjectsSettingsConfig, SemgrepSupplyChainFindingsSettingsConfig, SentryOrgAuditLogsSettingsConfig, SlackEnterpriseAuditLogsSettingsConfig, SlackUsersSettingsConfig, SlackgroupsSettingsConfig, SnowflakeInputSettingsConfig, SnykIssuesSettingsConfig, SnykProjectsSettingsConfig, SnykTargetsSettingsConfig, SyntheticDataCustomSettingsConfig, SyntheticDataSettingsConfig, TailscaleUsersSettingsConfig, TaniumGraphqlInputSettingsConfig, TeamAccessLogsSettingsConfig, TeamIntegrationLogsSettingsConfig, TelephonyLogsSettingsConfig, TenableAssetsCronSettingsConfig, TenableAssetsSettingsConfig, TenableVulnerabilitiesCronSettingsConfig, TenableVulnerabilitiesSettingsConfig, TinesAuditLogsSettingsConfig, TinesEventsLogsSettingsConfig, TwilioEventsSettingsConfig, TwilioSendgridEmailActivitySettingsConfig, UniversalSettingsConfig, UsersInfoSettingsConfig, UsersSettingsConfig, VercelUserEventsSettingsConfig, VoltioAuditLogsSettingsConfig, VulnerabilitiesCronSettingsConfig, VulnerabilitiesSettingsConfig, VulnerabilityFindingsReportSettingsConfig, VulnerabilityFindingsSettingsConfig, WizAuditLogsSettingsConfig, ZendeskAuditLogsSettingsConfig, ZoomActivityLogsSettingsConfig, ZoomMeetingActivityLogsSettingsConfig]] = None
    one_of_schemas: Set[str] = { "ActorsInfoSettingsConfig", "AdminLogsSettingsConfig", "AivenServiceLogsSettingsConfig", "AlertCenterSettingsConfig", "ArizeAuditLogsSettingsConfig", "AuditLogsSettingsConfig", "AuthLogsSettingsConfig", "AwsGuarddutySettingsConfig", "AwsIamAliasesSettingsConfig", "AwsOrganizationsSettingsConfig", "AwsS3SettingsConfig", "AwssecurityhubSettingsConfig", "Awssqss3SettingsConfig", "AzureActivityLogsSettingsConfig", "AzureBlobStorageSettingsConfig", "AzureEventHubsSettingsConfig", "AzureVirtualMachineSettingsConfig", "AzureVnetFlowLogsSettingsConfig", "BackblazeB2SettingsConfig", "BigqueryCronSettingsConfig", "BigqueryInputSettingsConfig", "BitwardenEventsSettingsConfig", "BoxEventsSettingsConfig", "BoxUsersSettingsConfig", "BrinqaAuditLogsSettingsConfig", "BugsnagOrgEventsSettingsConfig", "BuildkiteAuditLogsSettingsConfig", "BuildkiteGraphqlInputSettingsConfig", "CisaUserSettingsConfig", "CloudAssetInventorySettingsConfig", "CloudConfigurationFindingsSettingsConfig", "CloudLogsSettingsConfig", "CloudResourceInventoryReportsSettingsConfig", "CloudResourceInventorySettingsConfig", "CloudflareDdosAttackAnalyticsSettingsConfig", "CloudflareDnsRecordsSettingsConfig", "CloudflareFirewallEventsSettingsConfig", "CloudflareHttpRequestsSettingsConfig", "CloudflarePageShieldConnectionsSettingsConfig", "CloudflareRulesetsSettingsConfig", "CloudflareSecurityInsightsSettingsConfig", "CloudflareUrlScannerSettingsConfig", "CloudflareUsersSettingsConfig", "CloudflareZeroTrustAccessRequestsSettingsConfig", "CloudflareZonesSettingsConfig", "CloudtrailSettingsConfig", "ClumioAuditLogsSettingsConfig", "ClumioConsolidatedAlertsSettingsConfig", "CodaAuditEventsSettingsConfig", "CognitoUsersSettingsConfig", "CortexXsoarManagementLogsSettingsConfig", "CrowdstrikeFdrSettingsConfig", "CustomerEventDataSettingsConfig", "DefenderForEndpointAlertsSettingsConfig", "DeviceDetailsSettingsConfig", "DevicesSettingsConfig", "Dict[str, object]", "DuoSecurityActivityLogsSettingsConfig", "EndorLabsAuditLogsSettingsConfig", "EntraIdSettingsConfig", "EventSettingsConfig", "FleetdmActivityLogsSettingsConfig", "FullScansSettingsConfig", "GithubAdvisoryUserSettingsConfig", "GitlabIssuesSettingsConfig", "GoogleCloudStorageSettingsConfig", "GoogleWorkspaceSettingsConfig", "GreenhouseAuditLogsSettingsConfig", "IamAccessAnalyzerSettingsConfig", "IndividualAlertsSettingsConfig", "InspectorSettingsConfig", "IssuesReportSettingsConfig", "IssuesSettingsConfig", "KmsSettingsConfig", "KoiAuditLogsSettingsConfig", "LogAnalyticsQuerySettingsConfig", "LoginSessionsSettingsConfig", "MerakiConfigLogsSettingsConfig", "Microsoft365GenericSettingsConfig", "MonadLogSettingsConfig", "ObjectStorageInputSettingsConfig", "OfflineenrollmentlogsSettingsConfig", "OneloginEventsSettingsConfig", "OpalEventsSettingsConfig", "OpenaiSettingsConfig", "OperationLogsSettingsConfig", "OracleSettingsConfig", "OrgAuditLogsSettingsConfig", "OwnbackupAccountEventsSettingsConfig", "PagerdutyAuditRecordsSettingsConfig", "PaloAltoDataSecurityAlertsSettingsConfig", "PolymerSettingsConfig", "PostmanAuditLogsSettingsConfig", "PubsubSettingsConfig", "ResourceEvaluationsSettingsConfig", "RolesInfoSettingsConfig", "RootlyAuditLogsSettingsConfig", "SalesforceUsersSettingsConfig", "SecretsmanagerSettingsConfig", "SecurityGroupsSettingsConfig", "SemgrepCodeFindingsSettingsConfig", "SemgrepDeploymentsSettingsConfig", "SemgrepProjectDetailsSettingsConfig", "SemgrepProjectsSettingsConfig", "SemgrepSupplyChainFindingsSettingsConfig", "SentryOrgAuditLogsSettingsConfig", "SlackEnterpriseAuditLogsSettingsConfig", "SlackUsersSettingsConfig", "SlackgroupsSettingsConfig", "SnowflakeInputSettingsConfig", "SnykIssuesSettingsConfig", "SnykProjectsSettingsConfig", "SnykTargetsSettingsConfig", "SyntheticDataCustomSettingsConfig", "SyntheticDataSettingsConfig", "TailscaleUsersSettingsConfig", "TaniumGraphqlInputSettingsConfig", "TeamAccessLogsSettingsConfig", "TeamIntegrationLogsSettingsConfig", "TelephonyLogsSettingsConfig", "TenableAssetsCronSettingsConfig", "TenableAssetsSettingsConfig", "TenableVulnerabilitiesCronSettingsConfig", "TenableVulnerabilitiesSettingsConfig", "TinesAuditLogsSettingsConfig", "TinesEventsLogsSettingsConfig", "TwilioEventsSettingsConfig", "TwilioSendgridEmailActivitySettingsConfig", "UniversalSettingsConfig", "UsersInfoSettingsConfig", "UsersSettingsConfig", "VercelUserEventsSettingsConfig", "VoltioAuditLogsSettingsConfig", "VulnerabilitiesCronSettingsConfig", "VulnerabilitiesSettingsConfig", "VulnerabilityFindingsReportSettingsConfig", "VulnerabilityFindingsSettingsConfig", "WizAuditLogsSettingsConfig", "ZendeskAuditLogsSettingsConfig", "ZoomActivityLogsSettingsConfig", "ZoomMeetingActivityLogsSettingsConfig" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, EventSettingsConfig):
            ...
            match += 1
        # validate data type: FleetdmActivityLogsSettingsConfig
        if not isinstance(v, FleetdmActivityLogsSettingsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FleetdmActivityLogsSettingsConfig`")
        else:
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in SecretProcessesorInputConfigSettings with oneOf schemas: ActorsInfoSettingsConfig, AdminLogsSettingsConfig, AivenServiceLogsSettingsConfig, AlertCenterSettingsConfig, ArizeAuditLogsSettingsConfig, AuditLogsSettingsConfig, AuthLogsSettingsConfig, AwsGuarddutySettingsConfig, AwsIamAliasesSettingsConfig, AwsOrganizationsSettingsConfig, AwsS3SettingsConfig, AwssecurityhubSettingsConfig, Awssqss3SettingsConfig, AzureActivityLogsSettingsConfig, AzureBlobStorageSettingsConfig, AzureEventHubsSettingsConfig, AzureVirtualMachineSettingsConfig, AzureVnetFlowLogsSettingsConfig, BackblazeB2SettingsConfig, BigqueryCronSettingsConfig, BigqueryInputSettingsConfig, BitwardenEventsSettingsConfig, BoxEventsSettingsConfig, BoxUsersSettingsConfig, BrinqaAuditLogsSettingsConfig, BugsnagOrgEventsSettingsConfig, BuildkiteAuditLogsSettingsConfig, BuildkiteGraphqlInputSettingsConfig, CisaUserSettingsConfig, CloudAssetInventorySettingsConfig, CloudConfigurationFindingsSettingsConfig, CloudLogsSettingsConfig, CloudResourceInventoryReportsSettingsConfig, CloudResourceInventorySettingsConfig, CloudflareDdosAttackAnalyticsSettingsConfig, CloudflareDnsRecordsSettingsConfig, CloudflareFirewallEventsSettingsConfig, CloudflareHttpRequestsSettingsConfig, CloudflarePageShieldConnectionsSettingsConfig, CloudflareRulesetsSettingsConfig, CloudflareSecurityInsightsSettingsConfig, CloudflareUrlScannerSettingsConfig, CloudflareUsersSettingsConfig, CloudflareZeroTrustAccessRequestsSettingsConfig, CloudflareZonesSettingsConfig, CloudtrailSettingsConfig, ClumioAuditLogsSettingsConfig, ClumioConsolidatedAlertsSettingsConfig, CodaAuditEventsSettingsConfig, CognitoUsersSettingsConfig, CortexXsoarManagementLogsSettingsConfig, CrowdstrikeFdrSettingsConfig, CustomerEventDataSettingsConfig, DefenderForEndpointAlertsSettingsConfig, DeviceDetailsSettingsConfig, DevicesSettingsConfig, Dict[str, object], DuoSecurityActivityLogsSettingsConfig, EndorLabsAuditLogsSettingsConfig, EntraIdSettingsConfig, EventSettingsConfig, FleetdmActivityLogsSettingsConfig, FullScansSettingsConfig, GithubAdvisoryUserSettingsConfig, GitlabIssuesSettingsConfig, GoogleCloudStorageSettingsConfig, GoogleWorkspaceSettingsConfig, GreenhouseAuditLogsSettingsConfig, IamAccessAnalyzerSettingsConfig, IndividualAlertsSettingsConfig, InspectorSettingsConfig, IssuesReportSettingsConfig, IssuesSettingsConfig, KmsSettingsConfig, KoiAuditLogsSettingsConfig, LogAnalyticsQuerySettingsConfig, LoginSessionsSettingsConfig, MerakiConfigLogsSettingsConfig, Microsoft365GenericSettingsConfig, MonadLogSettingsConfig, ObjectStorageInputSettingsConfig, OfflineenrollmentlogsSettingsConfig, OneloginEventsSettingsConfig, OpalEventsSettingsConfig, OpenaiSettingsConfig, OperationLogsSettingsConfig, OracleSettingsConfig, OrgAuditLogsSettingsConfig, OwnbackupAccountEventsSettingsConfig, PagerdutyAuditRecordsSettingsConfig, PaloAltoDataSecurityAlertsSettingsConfig, PolymerSettingsConfig, PostmanAuditLogsSettingsConfig, PubsubSettingsConfig, ResourceEvaluationsSettingsConfig, RolesInfoSettingsConfig, RootlyAuditLogsSettingsConfig, SalesforceUsersSettingsConfig, SecretsmanagerSettingsConfig, SecurityGroupsSettingsConfig, SemgrepCodeFindingsSettingsConfig, SemgrepDeploymentsSettingsConfig, SemgrepProjectDetailsSettingsConfig, SemgrepProjectsSettingsConfig, SemgrepSupplyChainFindingsSettingsConfig, SentryOrgAuditLogsSettingsConfig, SlackEnterpriseAuditLogsSettingsConfig, SlackUsersSettingsConfig, SlackgroupsSettingsConfig, SnowflakeInputSettingsConfig, SnykIssuesSettingsConfig, SnykProjectsSettingsConfig, SnykTargetsSettingsConfig, SyntheticDataCustomSettingsConfig, SyntheticDataSettingsConfig, TailscaleUsersSettingsConfig, TaniumGraphqlInputSettingsConfig, TeamAccessLogsSettingsConfig, TeamIntegrationLogsSettingsConfig, TelephonyLogsSettingsConfig, TenableAssetsCronSettingsConfig, TenableAssetsSettingsConfig, TenableVulnerabilitiesCronSettingsConfig, TenableVulnerabilitiesSettingsConfig, TinesAuditLogsSettingsConfig, TinesEventsLogsSettingsConfig, TwilioEventsSettingsConfig, TwilioSendgridEmailActivitySettingsConfig, UniversalSettingsConfig, UsersInfoSettingsConfig, UsersSettingsConfig, VercelUserEventsSettingsConfig, VoltioAuditLogsSettingsConfig, VulnerabilitiesCronSettingsConfig, VulnerabilitiesSettingsConfig, VulnerabilityFindingsReportSettingsConfig, VulnerabilityFindingsSettingsConfig, WizAuditLogsSettingsConfig, ZendeskAuditLogsSettingsConfig, ZoomActivityLogsSettingsConfig, ZoomMeetingActivityLogsSettingsConfig. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in SecretProcessesorInputConfigSettings with oneOf schemas: ActorsInfoSettingsConfig, AdminLogsSettingsConfig, AivenServiceLogsSettingsConfig, AlertCenterSettingsConfig, ArizeAuditLogsSettingsConfig, AuditLogsSettingsConfig, AuthLogsSettingsConfig, AwsGuarddutySettingsConfig, AwsIamAliasesSettingsConfig, AwsOrganizationsSettingsConfig, AwsS3SettingsConfig, AwssecurityhubSettingsConfig, Awssqss3SettingsConfig, AzureActivityLogsSettingsConfig, AzureBlobStorageSettingsConfig, AzureEventHubsSettingsConfig, AzureVirtualMachineSettingsConfig, AzureVnetFlowLogsSettingsConfig, BackblazeB2SettingsConfig, BigqueryCronSettingsConfig, BigqueryInputSettingsConfig, BitwardenEventsSettingsConfig, BoxEventsSettingsConfig, BoxUsersSettingsConfig, BrinqaAuditLogsSettingsConfig, BugsnagOrgEventsSettingsConfig, BuildkiteAuditLogsSettingsConfig, BuildkiteGraphqlInputSettingsConfig, CisaUserSettingsConfig, CloudAssetInventorySettingsConfig, CloudConfigurationFindingsSettingsConfig, CloudLogsSettingsConfig, CloudResourceInventoryReportsSettingsConfig, CloudResourceInventorySettingsConfig, CloudflareDdosAttackAnalyticsSettingsConfig, CloudflareDnsRecordsSettingsConfig, CloudflareFirewallEventsSettingsConfig, CloudflareHttpRequestsSettingsConfig, CloudflarePageShieldConnectionsSettingsConfig, CloudflareRulesetsSettingsConfig, CloudflareSecurityInsightsSettingsConfig, CloudflareUrlScannerSettingsConfig, CloudflareUsersSettingsConfig, CloudflareZeroTrustAccessRequestsSettingsConfig, CloudflareZonesSettingsConfig, CloudtrailSettingsConfig, ClumioAuditLogsSettingsConfig, ClumioConsolidatedAlertsSettingsConfig, CodaAuditEventsSettingsConfig, CognitoUsersSettingsConfig, CortexXsoarManagementLogsSettingsConfig, CrowdstrikeFdrSettingsConfig, CustomerEventDataSettingsConfig, DefenderForEndpointAlertsSettingsConfig, DeviceDetailsSettingsConfig, DevicesSettingsConfig, Dict[str, object], DuoSecurityActivityLogsSettingsConfig, EndorLabsAuditLogsSettingsConfig, EntraIdSettingsConfig, EventSettingsConfig, FleetdmActivityLogsSettingsConfig, FullScansSettingsConfig, GithubAdvisoryUserSettingsConfig, GitlabIssuesSettingsConfig, GoogleCloudStorageSettingsConfig, GoogleWorkspaceSettingsConfig, GreenhouseAuditLogsSettingsConfig, IamAccessAnalyzerSettingsConfig, IndividualAlertsSettingsConfig, InspectorSettingsConfig, IssuesReportSettingsConfig, IssuesSettingsConfig, KmsSettingsConfig, KoiAuditLogsSettingsConfig, LogAnalyticsQuerySettingsConfig, LoginSessionsSettingsConfig, MerakiConfigLogsSettingsConfig, Microsoft365GenericSettingsConfig, MonadLogSettingsConfig, ObjectStorageInputSettingsConfig, OfflineenrollmentlogsSettingsConfig, OneloginEventsSettingsConfig, OpalEventsSettingsConfig, OpenaiSettingsConfig, OperationLogsSettingsConfig, OracleSettingsConfig, OrgAuditLogsSettingsConfig, OwnbackupAccountEventsSettingsConfig, PagerdutyAuditRecordsSettingsConfig, PaloAltoDataSecurityAlertsSettingsConfig, PolymerSettingsConfig, PostmanAuditLogsSettingsConfig, PubsubSettingsConfig, ResourceEvaluationsSettingsConfig, RolesInfoSettingsConfig, RootlyAuditLogsSettingsConfig, SalesforceUsersSettingsConfig, SecretsmanagerSettingsConfig, SecurityGroupsSettingsConfig, SemgrepCodeFindingsSettingsConfig, SemgrepDeploymentsSettingsConfig, SemgrepProjectDetailsSettingsConfig, SemgrepProjectsSettingsConfig, SemgrepSupplyChainFindingsSettingsConfig, SentryOrgAuditLogsSettingsConfig, SlackEnterpriseAuditLogsSettingsConfig, SlackUsersSettingsConfig, SlackgroupsSettingsConfig, SnowflakeInputSettingsConfig, SnykIssuesSettingsConfig, SnykProjectsSettingsConfig, SnykTargetsSettingsConfig, SyntheticDataCustomSettingsConfig, SyntheticDataSettingsConfig, TailscaleUsersSettingsConfig, TaniumGraphqlInputSettingsConfig, TeamAccessLogsSettingsConfig, TeamIntegrationLogsSettingsConfig, TelephonyLogsSettingsConfig, TenableAssetsCronSettingsConfig, TenableAssetsSettingsConfig, TenableVulnerabilitiesCronSettingsConfig, TenableVulnerabilitiesSettingsConfig, TinesAuditLogsSettingsConfig, TinesEventsLogsSettingsConfig, TwilioEventsSettingsConfig, TwilioSendgridEmailActivitySettingsConfig, UniversalSettingsConfig, UsersInfoSettingsConfig, UsersSettingsConfig, VercelUserEventsSettingsConfig, VoltioAuditLogsSettingsConfig, VulnerabilitiesCronSettingsConfig, VulnerabilitiesSettingsConfig, VulnerabilityFindingsReportSettingsConfig, VulnerabilityFindingsSettingsConfig, WizAuditLogsSettingsConfig, ZendeskAuditLogsSettingsConfig, ZoomActivityLogsSettingsConfig, ZoomMeetingActivityLogsSettingsConfig. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into FleetdmActivityLogsSettingsConfig
        try:
            instance.actual_instance = FleetdmActivityLogsSettingsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into SecretProcessesorInputConfigSettings with oneOf schemas: ActorsInfoSettingsConfig, AdminLogsSettingsConfig, AivenServiceLogsSettingsConfig, AlertCenterSettingsConfig, ArizeAuditLogsSettingsConfig, AuditLogsSettingsConfig, AuthLogsSettingsConfig, AwsGuarddutySettingsConfig, AwsIamAliasesSettingsConfig, AwsOrganizationsSettingsConfig, AwsS3SettingsConfig, AwssecurityhubSettingsConfig, Awssqss3SettingsConfig, AzureActivityLogsSettingsConfig, AzureBlobStorageSettingsConfig, AzureEventHubsSettingsConfig, AzureVirtualMachineSettingsConfig, AzureVnetFlowLogsSettingsConfig, BackblazeB2SettingsConfig, BigqueryCronSettingsConfig, BigqueryInputSettingsConfig, BitwardenEventsSettingsConfig, BoxEventsSettingsConfig, BoxUsersSettingsConfig, BrinqaAuditLogsSettingsConfig, BugsnagOrgEventsSettingsConfig, BuildkiteAuditLogsSettingsConfig, BuildkiteGraphqlInputSettingsConfig, CisaUserSettingsConfig, CloudAssetInventorySettingsConfig, CloudConfigurationFindingsSettingsConfig, CloudLogsSettingsConfig, CloudResourceInventoryReportsSettingsConfig, CloudResourceInventorySettingsConfig, CloudflareDdosAttackAnalyticsSettingsConfig, CloudflareDnsRecordsSettingsConfig, CloudflareFirewallEventsSettingsConfig, CloudflareHttpRequestsSettingsConfig, CloudflarePageShieldConnectionsSettingsConfig, CloudflareRulesetsSettingsConfig, CloudflareSecurityInsightsSettingsConfig, CloudflareUrlScannerSettingsConfig, CloudflareUsersSettingsConfig, CloudflareZeroTrustAccessRequestsSettingsConfig, CloudflareZonesSettingsConfig, CloudtrailSettingsConfig, ClumioAuditLogsSettingsConfig, ClumioConsolidatedAlertsSettingsConfig, CodaAuditEventsSettingsConfig, CognitoUsersSettingsConfig, CortexXsoarManagementLogsSettingsConfig, CrowdstrikeFdrSettingsConfig, CustomerEventDataSettingsConfig, DefenderForEndpointAlertsSettingsConfig, DeviceDetailsSettingsConfig, DevicesSettingsConfig, Dict[str, object], DuoSecurityActivityLogsSettingsConfig, EndorLabsAuditLogsSettingsConfig, EntraIdSettingsConfig, EventSettingsConfig, FleetdmActivityLogsSettingsConfig, FullScansSettingsConfig, GithubAdvisoryUserSettingsConfig, GitlabIssuesSettingsConfig, GoogleCloudStorageSettingsConfig, GoogleWorkspaceSettingsConfig, GreenhouseAuditLogsSettingsConfig, IamAccessAnalyzerSettingsConfig, IndividualAlertsSettingsConfig, InspectorSettingsConfig, IssuesReportSettingsConfig, IssuesSettingsConfig, KmsSettingsConfig, KoiAuditLogsSettingsConfig, LogAnalyticsQuerySettingsConfig, LoginSessionsSettingsConfig, MerakiConfigLogsSettingsConfig, Microsoft365GenericSettingsConfig, MonadLogSettingsConfig, ObjectStorageInputSettingsConfig, OfflineenrollmentlogsSettingsConfig, OneloginEventsSettingsConfig, OpalEventsSettingsConfig, OpenaiSettingsConfig, OperationLogsSettingsConfig, OracleSettingsConfig, OrgAuditLogsSettingsConfig, OwnbackupAccountEventsSettingsConfig, PagerdutyAuditRecordsSettingsConfig, PaloAltoDataSecurityAlertsSettingsConfig, PolymerSettingsConfig, PostmanAuditLogsSettingsConfig, PubsubSettingsConfig, ResourceEvaluationsSettingsConfig, RolesInfoSettingsConfig, RootlyAuditLogsSettingsConfig, SalesforceUsersSettingsConfig, SecretsmanagerSettingsConfig, SecurityGroupsSettingsConfig, SemgrepCodeFindingsSettingsConfig, SemgrepDeploymentsSettingsConfig, SemgrepProjectDetailsSettingsConfig, SemgrepProjectsSettingsConfig, SemgrepSupplyChainFindingsSettingsConfig, SentryOrgAuditLogsSettingsConfig, SlackEnterpriseAuditLogsSettingsConfig, SlackUsersSettingsConfig, SlackgroupsSettingsConfig, SnowflakeInputSettingsConfig, SnykIssuesSettingsConfig, SnykProjectsSettingsConfig, SnykTargetsSettingsConfig, SyntheticDataCustomSettingsConfig, SyntheticDataSettingsConfig, TailscaleUsersSettingsConfig, TaniumGraphqlInputSettingsConfig, TeamAccessLogsSettingsConfig, TeamIntegrationLogsSettingsConfig, TelephonyLogsSettingsConfig, TenableAssetsCronSettingsConfig, TenableAssetsSettingsConfig, TenableVulnerabilitiesCronSettingsConfig, TenableVulnerabilitiesSettingsConfig, TinesAuditLogsSettingsConfig, TinesEventsLogsSettingsConfig, TwilioEventsSettingsConfig, TwilioSendgridEmailActivitySettingsConfig, UniversalSettingsConfig, UsersInfoSettingsConfig, UsersSettingsConfig, VercelUserEventsSettingsConfig, VoltioAuditLogsSettingsConfig, VulnerabilitiesCronSettingsConfig, VulnerabilitiesSettingsConfig, VulnerabilityFindingsReportSettingsConfig, VulnerabilityFindingsSettingsConfig, WizAuditLogsSettingsConfig, ZendeskAuditLogsSettingsConfig, ZoomActivityLogsSettingsConfig, ZoomMeetingActivityLogsSettingsConfig. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ActorsInfoSettingsConfig, AdminLogsSettingsConfig, AivenServiceLogsSettingsConfig, AlertCenterSettingsConfig, ArizeAuditLogsSettingsConfig, AuditLogsSettingsConfig, AuthLogsSettingsConfig, AwsGuarddutySettingsConfig, AwsIamAliasesSettingsConfig, AwsOrganizationsSettingsConfig, AwsS3SettingsConfig, AwssecurityhubSettingsConfig, Awssqss3SettingsConfig, AzureActivityLogsSettingsConfig, AzureBlobStorageSettingsConfig, AzureEventHubsSettingsConfig, AzureVirtualMachineSettingsConfig, AzureVnetFlowLogsSettingsConfig, BackblazeB2SettingsConfig, BigqueryCronSettingsConfig, BigqueryInputSettingsConfig, BitwardenEventsSettingsConfig, BoxEventsSettingsConfig, BoxUsersSettingsConfig, BrinqaAuditLogsSettingsConfig, BugsnagOrgEventsSettingsConfig, BuildkiteAuditLogsSettingsConfig, BuildkiteGraphqlInputSettingsConfig, CisaUserSettingsConfig, CloudAssetInventorySettingsConfig, CloudConfigurationFindingsSettingsConfig, CloudLogsSettingsConfig, CloudResourceInventoryReportsSettingsConfig, CloudResourceInventorySettingsConfig, CloudflareDdosAttackAnalyticsSettingsConfig, CloudflareDnsRecordsSettingsConfig, CloudflareFirewallEventsSettingsConfig, CloudflareHttpRequestsSettingsConfig, CloudflarePageShieldConnectionsSettingsConfig, CloudflareRulesetsSettingsConfig, CloudflareSecurityInsightsSettingsConfig, CloudflareUrlScannerSettingsConfig, CloudflareUsersSettingsConfig, CloudflareZeroTrustAccessRequestsSettingsConfig, CloudflareZonesSettingsConfig, CloudtrailSettingsConfig, ClumioAuditLogsSettingsConfig, ClumioConsolidatedAlertsSettingsConfig, CodaAuditEventsSettingsConfig, CognitoUsersSettingsConfig, CortexXsoarManagementLogsSettingsConfig, CrowdstrikeFdrSettingsConfig, CustomerEventDataSettingsConfig, DefenderForEndpointAlertsSettingsConfig, DeviceDetailsSettingsConfig, DevicesSettingsConfig, Dict[str, object], DuoSecurityActivityLogsSettingsConfig, EndorLabsAuditLogsSettingsConfig, EntraIdSettingsConfig, EventSettingsConfig, FleetdmActivityLogsSettingsConfig, FullScansSettingsConfig, GithubAdvisoryUserSettingsConfig, GitlabIssuesSettingsConfig, GoogleCloudStorageSettingsConfig, GoogleWorkspaceSettingsConfig, GreenhouseAuditLogsSettingsConfig, IamAccessAnalyzerSettingsConfig, IndividualAlertsSettingsConfig, InspectorSettingsConfig, IssuesReportSettingsConfig, IssuesSettingsConfig, KmsSettingsConfig, KoiAuditLogsSettingsConfig, LogAnalyticsQuerySettingsConfig, LoginSessionsSettingsConfig, MerakiConfigLogsSettingsConfig, Microsoft365GenericSettingsConfig, MonadLogSettingsConfig, ObjectStorageInputSettingsConfig, OfflineenrollmentlogsSettingsConfig, OneloginEventsSettingsConfig, OpalEventsSettingsConfig, OpenaiSettingsConfig, OperationLogsSettingsConfig, OracleSettingsConfig, OrgAuditLogsSettingsConfig, OwnbackupAccountEventsSettingsConfig, PagerdutyAuditRecordsSettingsConfig, PaloAltoDataSecurityAlertsSettingsConfig, PolymerSettingsConfig, PostmanAuditLogsSettingsConfig, PubsubSettingsConfig, ResourceEvaluationsSettingsConfig, RolesInfoSettingsConfig, RootlyAuditLogsSettingsConfig, SalesforceUsersSettingsConfig, SecretsmanagerSettingsConfig, SecurityGroupsSettingsConfig, SemgrepCodeFindingsSettingsConfig, SemgrepDeploymentsSettingsConfig, SemgrepProjectDetailsSettingsConfig, SemgrepProjectsSettingsConfig, SemgrepSupplyChainFindingsSettingsConfig, SentryOrgAuditLogsSettingsConfig, SlackEnterpriseAuditLogsSettingsConfig, SlackUsersSettingsConfig, SlackgroupsSettingsConfig, SnowflakeInputSettingsConfig, SnykIssuesSettingsConfig, SnykProjectsSettingsConfig, SnykTargetsSettingsConfig, SyntheticDataCustomSettingsConfig, SyntheticDataSettingsConfig, TailscaleUsersSettingsConfig, TaniumGraphqlInputSettingsConfig, TeamAccessLogsSettingsConfig, TeamIntegrationLogsSettingsConfig, TelephonyLogsSettingsConfig, TenableAssetsCronSettingsConfig, TenableAssetsSettingsConfig, TenableVulnerabilitiesCronSettingsConfig, TenableVulnerabilitiesSettingsConfig, TinesAuditLogsSettingsConfig, TinesEventsLogsSettingsConfig, TwilioEventsSettingsConfig, TwilioSendgridEmailActivitySettingsConfig, UniversalSettingsConfig, UsersInfoSettingsConfig, UsersSettingsConfig, VercelUserEventsSettingsConfig, VoltioAuditLogsSettingsConfig, VulnerabilitiesCronSettingsConfig, VulnerabilitiesSettingsConfig, VulnerabilityFindingsReportSettingsConfig, VulnerabilityFindingsSettingsConfig, WizAuditLogsSettingsConfig, ZendeskAuditLogsSettingsConfig, ZoomActivityLogsSettingsConfig, ZoomMeetingActivityLogsSettingsConfig]]:
