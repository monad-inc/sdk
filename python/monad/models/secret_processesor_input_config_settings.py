...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_115_validator: Optional[SystemlogSettingsConfig] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, SyntheticDataCustomSettingsConfig):
            ...
            match += 1
        # validate data type: SystemlogSettingsConfig
        if not isinstance(v, SystemlogSettingsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `SystemlogSettingsConfig`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into SystemlogSettingsConfig
        try:
            instance.actual_instance = SystemlogSettingsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
