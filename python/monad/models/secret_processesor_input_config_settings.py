...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_44_validator: Optional[GithubAdvisoryUserSettingsConfig] = None
    ...
    oneof_schema_102_validator: Optional[ZoomActivityLogsSettingsConfig] = None
    # data type: ZoomMeetingActivityLogsSettingsConfig
    oneof_schema_103_validator: Optional[ZoomMeetingActivityLogsSettingsConfig] = None
