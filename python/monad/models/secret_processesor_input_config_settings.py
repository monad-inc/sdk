...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_54_validator: Optional[DevicesSettingsConfig] = None
    ...
    oneof_schema_58_validator: Optional[FullScansSettingsConfig] = None
    # data type: object
    oneof_schema_59_validator: Optional[Dict[str, Any]] = Field(default=None, description="Monad HTTP settings")
    ...
    oneof_schema_63_validator: Optional[GreenhouseAuditLogsSettingsConfig] = None
    # data type: IamAccessAnalyzerSettingsConfig
    oneof_schema_64_validator: Optional[IamAccessAnalyzerSettingsConfig] = None
    # data type: IndividualAlertsSettingsConfig
    oneof_schema_65_validator: Optional[IndividualAlertsSettingsConfig] = None
    # data type: InspectorSettingsConfig
    oneof_schema_66_validator: Optional[InspectorSettingsConfig] = None
    # data type: IssuesSettingsConfig
    oneof_schema_67_validator: Optional[IssuesSettingsConfig] = None
    # data type: IssuesReportSettingsConfig
    oneof_schema_68_validator: Optional[IssuesReportSettingsConfig] = None
    # data type: KmsSettingsConfig
    oneof_schema_69_validator: Optional[KmsSettingsConfig] = None
    # data type: KoiAuditLogsSettingsConfig
    oneof_schema_70_validator: Optional[KoiAuditLogsSettingsConfig] = None
    # data type: LogAnalyticsQuerySettingsConfig
    oneof_schema_71_validator: Optional[LogAnalyticsQuerySettingsConfig] = None
    # data type: LoginSessionsSettingsConfig
    oneof_schema_72_validator: Optional[LoginSessionsSettingsConfig] = None
    # data type: MerakiConfigLogsSettingsConfig
    oneof_schema_73_validator: Optional[MerakiConfigLogsSettingsConfig] = None
    # data type: Microsoft365GenericSettingsConfig
    oneof_schema_74_validator: Optional[Microsoft365GenericSettingsConfig] = None
    # data type: Dict[str, object]
    oneof_schema_75_validator: Optional[Dict[str, Any]] = None
    # data type: MonadLogSettingsConfig
    oneof_schema_76_validator: Optional[MonadLogSettingsConfig] = None
    # data type: ObjectStorageInputSettingsConfig
    oneof_schema_77_validator: Optional[ObjectStorageInputSettingsConfig] = None
    # data type: OfflineenrollmentlogsSettingsConfig
    oneof_schema_78_validator: Optional[OfflineenrollmentlogsSettingsConfig] = None
    # data type: OneloginEventsSettingsConfig
    oneof_schema_79_validator: Optional[OneloginEventsSettingsConfig] = None
    # data type: OpenaiSettingsConfig
    oneof_schema_80_validator: Optional[OpenaiSettingsConfig] = None
    # data type: OperationLogsSettingsConfig
    oneof_schema_81_validator: Optional[OperationLogsSettingsConfig] = None
    # data type: OracleSettingsConfig
    oneof_schema_82_validator: Optional[OracleSettingsConfig] = None
    # data type: OrgAuditLogsSettingsConfig
    oneof_schema_83_validator: Optional[OrgAuditLogsSettingsConfig] = None
    # data type: OrganizationsSettingsConfig
    oneof_schema_84_validator: Optional[OrganizationsSettingsConfig] = None
    # data type: PagerdutyAuditRecordsSettingsConfig
    oneof_schema_85_validator: Optional[PagerdutyAuditRecordsSettingsConfig] = None
    # data type: PaloAltoDataSecurityAlertsSettingsConfig
    oneof_schema_86_validator: Optional[PaloAltoDataSecurityAlertsSettingsConfig] = None
    # data type: PolymerSettingsConfig
    oneof_schema_87_validator: Optional[PolymerSettingsConfig] = None
    # data type: PostmanAuditLogsSettingsConfig
    oneof_schema_88_validator: Optional[PostmanAuditLogsSettingsConfig] = None
    # data type: PubsubSettingsConfig
    oneof_schema_89_validator: Optional[PubsubSettingsConfig] = None
    # data type: ResourceEvaluationsSettingsConfig
    oneof_schema_90_validator: Optional[ResourceEvaluationsSettingsConfig] = None
    # data type: RolesInfoSettingsConfig
    oneof_schema_91_validator: Optional[RolesInfoSettingsConfig] = None
    # data type: RootlyAuditLogsSettingsConfig
    oneof_schema_92_validator: Optional[RootlyAuditLogsSettingsConfig] = None
    # data type: SalesforceUsersSettingsConfig
    oneof_schema_93_validator: Optional[SalesforceUsersSettingsConfig] = None
    # data type: SecretsmanagerSettingsConfig
    oneof_schema_94_validator: Optional[SecretsmanagerSettingsConfig] = None
    # data type: SecurityGroupsSettingsConfig
    oneof_schema_95_validator: Optional[SecurityGroupsSettingsConfig] = None
    # data type: SemgrepCodeFindingsSettingsConfig
    oneof_schema_96_validator: Optional[SemgrepCodeFindingsSettingsConfig] = None
    # data type: SemgrepDeploymentsSettingsConfig
    oneof_schema_97_validator: Optional[SemgrepDeploymentsSettingsConfig] = None
    # data type: SemgrepProjectDetailsSettingsConfig
    oneof_schema_98_validator: Optional[SemgrepProjectDetailsSettingsConfig] = None
    # data type: SemgrepProjectsSettingsConfig
    oneof_schema_99_validator: Optional[SemgrepProjectsSettingsConfig] = None
    # data type: SemgrepSupplyChainFindingsSettingsConfig
    oneof_schema_100_validator: Optional[SemgrepSupplyChainFindingsSettingsConfig] = None
    # data type: SentryOrgAuditLogsSettingsConfig
    oneof_schema_101_validator: Optional[SentryOrgAuditLogsSettingsConfig] = None
    # data type: SlackEnterpriseAuditLogsSettingsConfig
    oneof_schema_102_validator: Optional[SlackEnterpriseAuditLogsSettingsConfig] = None
    # data type: SlackUsersSettingsConfig
    oneof_schema_103_validator: Optional[SlackUsersSettingsConfig] = None
    # data type: SlackgroupsSettingsConfig
    oneof_schema_104_validator: Optional[SlackgroupsSettingsConfig] = None
    ...
    oneof_schema_107_validator: Optional[SnykOrganizationsSettingsConfig] = None
    # data type: SnykProjectsSettingsConfig
    oneof_schema_108_validator: Optional[SnykProjectsSettingsConfig] = None
    # data type: SnykTargetsSettingsConfig
    oneof_schema_109_validator: Optional[SnykTargetsSettingsConfig] = None
    # data type: SyntheticDataSettingsConfig
    oneof_schema_110_validator: Optional[SyntheticDataSettingsConfig] = None
    # data type: SyntheticDataCustomSettingsConfig
    oneof_schema_111_validator: Optional[SyntheticDataCustomSettingsConfig] = None
    # data type: SystemlogSettingsConfig
    oneof_schema_112_validator: Optional[SystemlogSettingsConfig] = None
    # data type: TailscaleUsersSettingsConfig
    oneof_schema_113_validator: Optional[TailscaleUsersSettingsConfig] = None
    # data type: TaniumGraphqlInputSettingsConfig
    oneof_schema_114_validator: Optional[TaniumGraphqlInputSettingsConfig] = None
    # data type: TeamAccessLogsSettingsConfig
    oneof_schema_115_validator: Optional[TeamAccessLogsSettingsConfig] = None
    # data type: TeamIntegrationLogsSettingsConfig
    oneof_schema_116_validator: Optional[TeamIntegrationLogsSettingsConfig] = None
    # data type: TelephonyLogsSettingsConfig
    oneof_schema_117_validator: Optional[TelephonyLogsSettingsConfig] = None
    # data type: TenableAssetsSettingsConfig
    oneof_schema_118_validator: Optional[TenableAssetsSettingsConfig] = None
    # data type: TenableAssetsCronSettingsConfig
    oneof_schema_119_validator: Optional[TenableAssetsCronSettingsConfig] = None
    # data type: TenableVulnerabilitiesSettingsConfig
    oneof_schema_120_validator: Optional[TenableVulnerabilitiesSettingsConfig] = None
    # data type: TenableVulnerabilitiesCronSettingsConfig
    oneof_schema_121_validator: Optional[TenableVulnerabilitiesCronSettingsConfig] = None
    # data type: TinesAuditLogsSettingsConfig
    oneof_schema_122_validator: Optional[TinesAuditLogsSettingsConfig] = None
    # data type: TinesEventsLogsSettingsConfig
    oneof_schema_123_validator: Optional[TinesEventsLogsSettingsConfig] = None
    # data type: TwilioEventsSettingsConfig
    oneof_schema_124_validator: Optional[TwilioEventsSettingsConfig] = None
    # data type: TwilioSendgridEmailActivitySettingsConfig
    oneof_schema_125_validator: Optional[TwilioSendgridEmailActivitySettingsConfig] = None
    # data type: UniversalSettingsConfig
    oneof_schema_126_validator: Optional[UniversalSettingsConfig] = None
    # data type: UsersSettingsConfig
    oneof_schema_127_validator: Optional[UsersSettingsConfig] = None
    # data type: UsersInfoSettingsConfig
    oneof_schema_128_validator: Optional[UsersInfoSettingsConfig] = None
    # data type: VercelUserEventsSettingsConfig
    oneof_schema_129_validator: Optional[VercelUserEventsSettingsConfig] = None
    # data type: VulnerabilitiesSettingsConfig
    oneof_schema_130_validator: Optional[VulnerabilitiesSettingsConfig] = None
    # data type: VulnerabilitiesCronSettingsConfig
    oneof_schema_131_validator: Optional[VulnerabilitiesCronSettingsConfig] = None
    # data type: VulnerabilityFindingsSettingsConfig
    oneof_schema_132_validator: Optional[VulnerabilityFindingsSettingsConfig] = None
    # data type: VulnerabilityFindingsReportSettingsConfig
    oneof_schema_133_validator: Optional[VulnerabilityFindingsReportSettingsConfig] = None
    # data type: WizAuditLogsSettingsConfig
    oneof_schema_134_validator: Optional[WizAuditLogsSettingsConfig] = None
    # data type: ZendeskAuditLogsSettingsConfig
    oneof_schema_135_validator: Optional[ZendeskAuditLogsSettingsConfig] = None
    # data type: ZoomActivityLogsSettingsConfig
    oneof_schema_136_validator: Optional[ZoomActivityLogsSettingsConfig] = None
    # data type: ZoomMeetingActivityLogsSettingsConfig
    oneof_schema_137_validator: Optional[ZoomMeetingActivityLogsSettingsConfig] = None
