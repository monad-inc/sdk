...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_72_validator: Optional[TailscaleUsersSettingsConfig] = None
    # data type: object
    ...
    oneof_schema_74_validator: Optional[TenableAssetsCronSettingsConfig] = None
    # data type: object
    oneof_schema_75_validator: Optional[Dict[str, Any]] = Field(default=None, description="Tenable assets settings")
    # data type: TenableVulnerabilitiesCronSettingsConfig
    oneof_schema_76_validator: Optional[TenableVulnerabilitiesCronSettingsConfig] = None
    # data type: UsersSettingsConfig
    oneof_schema_77_validator: Optional[UsersSettingsConfig] = None
    # data type: UsersInfoSettingsConfig
    oneof_schema_78_validator: Optional[UsersInfoSettingsConfig] = None
    # data type: VulnerabilitiesSettingsConfig
    oneof_schema_79_validator: Optional[VulnerabilitiesSettingsConfig] = None
    # data type: VulnerabilitiesCronSettingsConfig
    oneof_schema_80_validator: Optional[VulnerabilitiesCronSettingsConfig] = None
    # data type: VulnerabilityFindingsSettingsConfig
    oneof_schema_81_validator: Optional[VulnerabilityFindingsSettingsConfig] = None
