...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_131_validator: Optional[VulnerabilitiesSettingsConfig] = None
    # data type: VulnerabilitiesCronSettingsConfig
    oneof_schema_132_validator: Optional[VulnerabilitiesCronSettingsConfig] = None
    # data type: VulnerabilityFindingsSettingsConfig
    oneof_schema_133_validator: Optional[VulnerabilityFindingsSettingsConfig] = None
    # data type: VulnerabilityFindingsReportSettingsConfig
    oneof_schema_134_validator: Optional[VulnerabilityFindingsReportSettingsConfig] = None
    # data type: WizAuditLogsSettingsConfig
    oneof_schema_135_validator: Optional[WizAuditLogsSettingsConfig] = None
    # data type: ZendeskAuditLogsSettingsConfig
    oneof_schema_136_validator: Optional[ZendeskAuditLogsSettingsConfig] = None
    # data type: ZoomActivityLogsSettingsConfig
    oneof_schema_137_validator: Optional[ZoomActivityLogsSettingsConfig] = None
    # data type: ZoomMeetingActivityLogsSettingsConfig
    oneof_schema_138_validator: Optional[ZoomMeetingActivityLogsSettingsConfig] = None
