...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_81_validator: Optional[OpenaiSettingsConfig] = None
    # data type: OperationLogsSettingsConfig
    oneof_schema_82_validator: Optional[OperationLogsSettingsConfig] = None
    # data type: OracleSettingsConfig
    oneof_schema_83_validator: Optional[OracleSettingsConfig] = None
    # data type: OrgAuditLogsSettingsConfig
    oneof_schema_84_validator: Optional[OrgAuditLogsSettingsConfig] = None
    # data type: OwnbackupAccountEventsSettingsConfig
    oneof_schema_85_validator: Optional[OwnbackupAccountEventsSettingsConfig] = None
    # data type: PagerdutyAuditRecordsSettingsConfig
    oneof_schema_86_validator: Optional[PagerdutyAuditRecordsSettingsConfig] = None
    # data type: PaloAltoDataSecurityAlertsSettingsConfig
    oneof_schema_87_validator: Optional[PaloAltoDataSecurityAlertsSettingsConfig] = None
    # data type: PolymerSettingsConfig
    oneof_schema_88_validator: Optional[PolymerSettingsConfig] = None
    # data type: PostmanAuditLogsSettingsConfig
    oneof_schema_89_validator: Optional[PostmanAuditLogsSettingsConfig] = None
    # data type: PubsubSettingsConfig
    oneof_schema_90_validator: Optional[PubsubSettingsConfig] = None
    # data type: ResourceEvaluationsSettingsConfig
    oneof_schema_91_validator: Optional[ResourceEvaluationsSettingsConfig] = None
    # data type: RolesInfoSettingsConfig
    oneof_schema_92_validator: Optional[RolesInfoSettingsConfig] = None
    # data type: RootlyAuditLogsSettingsConfig
    oneof_schema_93_validator: Optional[RootlyAuditLogsSettingsConfig] = None
    # data type: SalesforceUsersSettingsConfig
    oneof_schema_94_validator: Optional[SalesforceUsersSettingsConfig] = None
    ...
    oneof_schema_104_validator: Optional[SlackUsersSettingsConfig] = None
    # data type: SlackgroupsSettingsConfig
    oneof_schema_105_validator: Optional[SlackgroupsSettingsConfig] = None
    # data type: SnowflakeInputSettingsConfig
    oneof_schema_106_validator: Optional[SnowflakeInputSettingsConfig] = None
    # data type: SnykIssuesSettingsConfig
    oneof_schema_107_validator: Optional[SnykIssuesSettingsConfig] = None
    # data type: SnykOrganizationsSettingsConfig
    oneof_schema_108_validator: Optional[SnykOrganizationsSettingsConfig] = None
