...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    # data type: object
    oneof_schema_67_validator: Optional[Dict[str, Any]] = Field(default=None, description="Snyk issues settings")
    ...
    # data type: object
    oneof_schema_70_validator: Optional[Dict[str, Any]] = Field(default=None, description="Snyk targets settings")
