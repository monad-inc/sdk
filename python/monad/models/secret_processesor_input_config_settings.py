...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_24_validator: Optional[BrinqaAuditLogsSettingsConfig] = None
    # data type: BugsnagOrgEventsSettingsConfig
    oneof_schema_25_validator: Optional[BugsnagOrgEventsSettingsConfig] = None
    # data type: BuildkiteAuditLogsSettingsConfig
    oneof_schema_26_validator: Optional[BuildkiteAuditLogsSettingsConfig] = None
    # data type: BuildkiteGraphqlInputSettingsConfig
    oneof_schema_27_validator: Optional[BuildkiteGraphqlInputSettingsConfig] = None
    # data type: CisaUserSettingsConfig
    oneof_schema_28_validator: Optional[CisaUserSettingsConfig] = None
    # data type: CloudAssetInventorySettingsConfig
    oneof_schema_29_validator: Optional[CloudAssetInventorySettingsConfig] = None
    # data type: CloudConfigurationFindingsSettingsConfig
    oneof_schema_30_validator: Optional[CloudConfigurationFindingsSettingsConfig] = None
    # data type: CloudLogsSettingsConfig
    oneof_schema_31_validator: Optional[CloudLogsSettingsConfig] = None
    # data type: CloudResourceInventorySettingsConfig
    oneof_schema_32_validator: Optional[CloudResourceInventorySettingsConfig] = None
    # data type: CloudResourceInventoryReportsSettingsConfig
    oneof_schema_33_validator: Optional[CloudResourceInventoryReportsSettingsConfig] = None
    # data type: CloudflareDdosAttackAnalyticsSettingsConfig
    oneof_schema_34_validator: Optional[CloudflareDdosAttackAnalyticsSettingsConfig] = None
    # data type: CloudflareDnsRecordsSettingsConfig
    oneof_schema_35_validator: Optional[CloudflareDnsRecordsSettingsConfig] = None
    # data type: CloudflareFirewallEventsSettingsConfig
    oneof_schema_36_validator: Optional[CloudflareFirewallEventsSettingsConfig] = None
    # data type: CloudflareHttpRequestsSettingsConfig
    oneof_schema_37_validator: Optional[CloudflareHttpRequestsSettingsConfig] = None
    # data type: CloudflarePageShieldConnectionsSettingsConfig
    oneof_schema_38_validator: Optional[CloudflarePageShieldConnectionsSettingsConfig] = None
    # data type: CloudflareRulesetsSettingsConfig
    oneof_schema_39_validator: Optional[CloudflareRulesetsSettingsConfig] = None
    # data type: CloudflareSecurityInsightsSettingsConfig
    oneof_schema_40_validator: Optional[CloudflareSecurityInsightsSettingsConfig] = None
    # data type: CloudflareUrlScannerSettingsConfig
    oneof_schema_41_validator: Optional[CloudflareUrlScannerSettingsConfig] = None
    # data type: CloudflareUsersSettingsConfig
    oneof_schema_42_validator: Optional[CloudflareUsersSettingsConfig] = None
    # data type: CloudflareZeroTrustAccessRequestsSettingsConfig
    oneof_schema_43_validator: Optional[CloudflareZeroTrustAccessRequestsSettingsConfig] = None
    # data type: CloudflareZonesSettingsConfig
    oneof_schema_44_validator: Optional[CloudflareZonesSettingsConfig] = None
    # data type: CloudtrailSettingsConfig
    oneof_schema_45_validator: Optional[CloudtrailSettingsConfig] = None
    # data type: ClumioAuditLogsSettingsConfig
    oneof_schema_46_validator: Optional[ClumioAuditLogsSettingsConfig] = None
    # data type: ClumioConsolidatedAlertsSettingsConfig
    oneof_schema_47_validator: Optional[ClumioConsolidatedAlertsSettingsConfig] = None
    # data type: CodaAuditEventsSettingsConfig
    oneof_schema_48_validator: Optional[CodaAuditEventsSettingsConfig] = None
    # data type: CognitoUsersSettingsConfig
    oneof_schema_49_validator: Optional[CognitoUsersSettingsConfig] = None
    # data type: CortexXsoarManagementLogsSettingsConfig
    oneof_schema_50_validator: Optional[CortexXsoarManagementLogsSettingsConfig] = None
    # data type: CrowdstrikeFdrSettingsConfig
    oneof_schema_51_validator: Optional[CrowdstrikeFdrSettingsConfig] = None
    # data type: CustomerEventDataSettingsConfig
    oneof_schema_52_validator: Optional[CustomerEventDataSettingsConfig] = None
    # data type: DefenderForEndpointAlertsSettingsConfig
    oneof_schema_53_validator: Optional[DefenderForEndpointAlertsSettingsConfig] = None
    # data type: DeviceDetailsSettingsConfig
    oneof_schema_54_validator: Optional[DeviceDetailsSettingsConfig] = None
    # data type: DevicesSettingsConfig
    oneof_schema_55_validator: Optional[DevicesSettingsConfig] = None
    # data type: DuoSecurityActivityLogsSettingsConfig
    oneof_schema_56_validator: Optional[DuoSecurityActivityLogsSettingsConfig] = None
    # data type: EndorLabsAuditLogsSettingsConfig
    oneof_schema_57_validator: Optional[EndorLabsAuditLogsSettingsConfig] = None
    # data type: EntraIdSettingsConfig
    oneof_schema_58_validator: Optional[EntraIdSettingsConfig] = None
    # data type: EventSettingsConfig
    oneof_schema_59_validator: Optional[EventSettingsConfig] = None
    # data type: FleetdmActivityLogsSettingsConfig
    oneof_schema_60_validator: Optional[FleetdmActivityLogsSettingsConfig] = None
    # data type: FullScansSettingsConfig
    oneof_schema_61_validator: Optional[FullScansSettingsConfig] = None
    # data type: GithubAdvisoryUserSettingsConfig
    oneof_schema_62_validator: Optional[GithubAdvisoryUserSettingsConfig] = None
    # data type: GitlabIssuesSettingsConfig
    oneof_schema_63_validator: Optional[GitlabIssuesSettingsConfig] = None
    # data type: GoogleCloudStorageSettingsConfig
    oneof_schema_64_validator: Optional[GoogleCloudStorageSettingsConfig] = None
    # data type: GoogleWorkspaceSettingsConfig
    oneof_schema_65_validator: Optional[GoogleWorkspaceSettingsConfig] = None
