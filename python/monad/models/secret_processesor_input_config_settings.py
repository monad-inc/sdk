...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    # data type: object
    oneof_schema_17_validator: Optional[Dict[str, Any]] = Field(default=None, description="CISA KEV settings")
    ...
    oneof_schema_26_validator: Optional[DemoSettingsConfig] = None
    # data type: DemoCustomSettingsConfig
    oneof_schema_27_validator: Optional[DemoCustomSettingsConfig] = None
    ...
    # data type: object
    oneof_schema_38_validator: Optional[Dict[str, Any]] = Field(default=None, description="Github Advisory Database settings")
    ...
    oneof_schema_42_validator: Optional[IssuesSettingsConfig] = None
    # data type: KmsSettingsConfig
    oneof_schema_43_validator: Optional[KmsSettingsConfig] = None
    # data type: LogAnalyticsQuerySettingsConfig
    oneof_schema_44_validator: Optional[LogAnalyticsQuerySettingsConfig] = None
    # data type: LoginActivitySettingsConfig
    oneof_schema_45_validator: Optional[LoginActivitySettingsConfig] = None
    # data type: LoginSessionsSettingsConfig
    oneof_schema_46_validator: Optional[LoginSessionsSettingsConfig] = None
    # data type: Dict[str, object]
    oneof_schema_47_validator: Optional[Dict[str, Any]] = None
    # data type: object
    oneof_schema_48_validator: Optional[Dict[str, Any]] = Field(default=None, description="Monad HTTP settings")
    ...
    oneof_schema_50_validator: Optional[OauthActivitySettingsConfig] = None
    ...
    oneof_schema_52_validator: Optional[OneloginEventsSettingsConfig] = None
    # data type: OrganizationsSettingsConfig
    oneof_schema_53_validator: Optional[OrganizationsSettingsConfig] = None
    ...
    oneof_schema_55_validator: Optional[ResourceEvaluationsSettingsConfig] = None
    # data type: RolesInfoSettingsConfig
    oneof_schema_56_validator: Optional[RolesInfoSettingsConfig] = None
    # data type: SecretsmanagerSettingsConfig
    oneof_schema_57_validator: Optional[SecretsmanagerSettingsConfig] = None
    # data type: SecurityGroupsSettingsConfig
    oneof_schema_58_validator: Optional[SecurityGroupsSettingsConfig] = None
    # data type: object
    oneof_schema_59_validator: Optional[Dict[str, Any]] = Field(default=None, description="Semgrep code findings settings")
    # data type: SemgrepDeploymentsSettingsConfig
    oneof_schema_60_validator: Optional[SemgrepDeploymentsSettingsConfig] = None
    # data type: SemgrepProjectDetailsSettingsConfig
    oneof_schema_61_validator: Optional[SemgrepProjectDetailsSettingsConfig] = None
    # data type: SemgrepProjectsSettingsConfig
    oneof_schema_62_validator: Optional[SemgrepProjectsSettingsConfig] = None
    # data type: object
    oneof_schema_63_validator: Optional[Dict[str, Any]] = Field(default=None, description="Semgrep supply chain findings settings")
    # data type: SentryOrgAuditLogsSettingsConfig
    oneof_schema_64_validator: Optional[SentryOrgAuditLogsSettingsConfig] = None
    # data type: SlackUsersSettingsConfig
    oneof_schema_65_validator: Optional[SlackUsersSettingsConfig] = None
    # data type: SlackgroupsSettingsConfig
    oneof_schema_66_validator: Optional[SlackgroupsSettingsConfig] = None
    # data type: SnowflakeInputSettingsConfig
    oneof_schema_67_validator: Optional[SnowflakeInputSettingsConfig] = None
    # data type: object
    oneof_schema_68_validator: Optional[Dict[str, Any]] = Field(default=None, description="Snyk issues settings")
    # data type: SnykOrganizationsSettingsConfig
    oneof_schema_69_validator: Optional[SnykOrganizationsSettingsConfig] = None
    # data type: SnykProjectsSettingsConfig
    oneof_schema_70_validator: Optional[SnykProjectsSettingsConfig] = None
    # data type: object
    oneof_schema_71_validator: Optional[Dict[str, Any]] = Field(default=None, description="Snyk targets settings")
    # data type: SystemlogSettingsConfig
    oneof_schema_72_validator: Optional[SystemlogSettingsConfig] = None
    # data type: TailscaleUsersSettingsConfig
    oneof_schema_73_validator: Optional[TailscaleUsersSettingsConfig] = None
    # data type: object
    oneof_schema_74_validator: Optional[Dict[str, Any]] = Field(default=None, description="Tenable assets settings")
    # data type: TenableAssetsCronSettingsConfig
    oneof_schema_75_validator: Optional[TenableAssetsCronSettingsConfig] = None
    # data type: object
    oneof_schema_76_validator: Optional[Dict[str, Any]] = Field(default=None, description="Tenable assets settings")
    # data type: TenableVulnerabilitiesCronSettingsConfig
    oneof_schema_77_validator: Optional[TenableVulnerabilitiesCronSettingsConfig] = None
    # data type: UsersSettingsConfig
    oneof_schema_78_validator: Optional[UsersSettingsConfig] = None
    # data type: UsersInfoSettingsConfig
    oneof_schema_79_validator: Optional[UsersInfoSettingsConfig] = None
    # data type: VulnerabilitiesSettingsConfig
    oneof_schema_80_validator: Optional[VulnerabilitiesSettingsConfig] = None
    # data type: VulnerabilitiesCronSettingsConfig
    oneof_schema_81_validator: Optional[VulnerabilitiesCronSettingsConfig] = None
    # data type: VulnerabilityFindingsSettingsConfig
    oneof_schema_82_validator: Optional[VulnerabilityFindingsSettingsConfig] = None
