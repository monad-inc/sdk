...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_33_validator: Optional[CloudflareAuditLogsSettingsConfig] = None
    ...
    # data type: object
    oneof_schema_60_validator: Optional[Dict[str, Any]] = Field(default=None, description="Monad HTTP settings")
    ...
    oneof_schema_85_validator: Optional[OrganizationsSettingsConfig] = None
