...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_109_validator: Optional[SnykProjectsSettingsConfig] = None
    # data type: SnykTargetsSettingsConfig
    oneof_schema_110_validator: Optional[SnykTargetsSettingsConfig] = None
    # data type: SyntheticDataSettingsConfig
    oneof_schema_111_validator: Optional[SyntheticDataSettingsConfig] = None
    # data type: SyntheticDataCustomSettingsConfig
    oneof_schema_112_validator: Optional[SyntheticDataCustomSettingsConfig] = None
    # data type: SystemlogSettingsConfig
    oneof_schema_113_validator: Optional[SystemlogSettingsConfig] = None
