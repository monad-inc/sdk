...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, BuildkiteGraphqlInputSettingsConfig):
            ...
            match += 1
        # validate data type: CatoNetworksEventsSettingsConfig
        if not isinstance(v, CatoNetworksEventsSettingsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `CatoNetworksEventsSettingsConfig`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into CatoNetworksEventsSettingsConfig
        try:
            instance.actual_instance = CatoNetworksEventsSettingsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
