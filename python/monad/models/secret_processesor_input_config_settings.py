...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_35_validator: Optional[EventsLogsSettingsConfig] = None
    # data type: FullScansSettingsConfig
    oneof_schema_36_validator: Optional[FullScansSettingsConfig] = None
    # data type: object
    oneof_schema_37_validator: Optional[Dict[str, Any]] = Field(default=None, description="Github Advisory Database settings")
    # data type: GitlabIssuesSettingsConfig
    oneof_schema_38_validator: Optional[GitlabIssuesSettingsConfig] = None
    ...
    oneof_schema_40_validator: Optional[IamAccessAnalyzerSettingsConfig] = None
    # data type: IssuesSettingsConfig
    oneof_schema_41_validator: Optional[IssuesSettingsConfig] = None
    # data type: KmsSettingsConfig
    oneof_schema_42_validator: Optional[KmsSettingsConfig] = None
    ...
    oneof_schema_44_validator: Optional[LoginActivitySettingsConfig] = None
    # data type: LoginSessionsSettingsConfig
    oneof_schema_45_validator: Optional[LoginSessionsSettingsConfig] = None
    # data type: Dict[str, object]
    oneof_schema_46_validator: Optional[Dict[str, Any]] = None
    # data type: object
    oneof_schema_47_validator: Optional[Dict[str, Any]] = Field(default=None, description="Monad HTTP settings")
    # data type: MonadLogSettingsConfig
    oneof_schema_48_validator: Optional[MonadLogSettingsConfig] = None
    # data type: OauthActivitySettingsConfig
    oneof_schema_49_validator: Optional[OauthActivitySettingsConfig] = None
    ...
    oneof_schema_51_validator: Optional[OneloginEventsSettingsConfig] = None
    ...
    # data type: object
    oneof_schema_58_validator: Optional[Dict[str, Any]] = Field(default=None, description="Semgrep code findings settings")
    ...
    # data type: object
    oneof_schema_62_validator: Optional[Dict[str, Any]] = Field(default=None, description="Semgrep supply chain findings settings")
    # data type: SlackUsersSettingsConfig
    oneof_schema_63_validator: Optional[SlackUsersSettingsConfig] = None
    # data type: SlackgroupsSettingsConfig
    oneof_schema_64_validator: Optional[SlackgroupsSettingsConfig] = None
    # data type: SnowflakeInputSettingsConfig
    oneof_schema_65_validator: Optional[SnowflakeInputSettingsConfig] = None
    # data type: object
    oneof_schema_66_validator: Optional[Dict[str, Any]] = Field(default=None, description="Snyk issues settings")
    # data type: SnykOrganizationsSettingsConfig
    oneof_schema_67_validator: Optional[SnykOrganizationsSettingsConfig] = None
    # data type: SnykProjectsSettingsConfig
    oneof_schema_68_validator: Optional[SnykProjectsSettingsConfig] = None
    # data type: object
    oneof_schema_69_validator: Optional[Dict[str, Any]] = Field(default=None, description="Snyk targets settings")
    # data type: TailscaleUsersSettingsConfig
    oneof_schema_70_validator: Optional[TailscaleUsersSettingsConfig] = None
    # data type: object
    oneof_schema_71_validator: Optional[Dict[str, Any]] = Field(default=None, description="Tenable assets settings")
    # data type: TenableAssetsCronSettingsConfig
    oneof_schema_72_validator: Optional[TenableAssetsCronSettingsConfig] = None
    # data type: object
    oneof_schema_73_validator: Optional[Dict[str, Any]] = Field(default=None, description="Tenable assets settings")
    # data type: TenableVulnerabilitiesCronSettingsConfig
    oneof_schema_74_validator: Optional[TenableVulnerabilitiesCronSettingsConfig] = None
    # data type: UsersSettingsConfig
    oneof_schema_75_validator: Optional[UsersSettingsConfig] = None
    # data type: UsersInfoSettingsConfig
    oneof_schema_76_validator: Optional[UsersInfoSettingsConfig] = None
    # data type: VulnerabilitiesSettingsConfig
    oneof_schema_77_validator: Optional[VulnerabilitiesSettingsConfig] = None
    # data type: VulnerabilitiesCronSettingsConfig
    oneof_schema_78_validator: Optional[VulnerabilitiesCronSettingsConfig] = None
