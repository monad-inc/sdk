...
class SecretProcessesorInputConfigSettings(BaseModel):
    ...
    oneof_schema_14_validator: Optional[BoxEventsSettingsConfig] = None
    # data type: BoxUsersSettingsConfig
    oneof_schema_15_validator: Optional[BoxUsersSettingsConfig] = None
    ...
    oneof_schema_17_validator: Optional[CloudAssetInventorySettingsConfig] = None
    ...
    oneof_schema_21_validator: Optional[CloudtrailSettingsConfig] = None
    # data type: CognitoUsersSettingsConfig
    oneof_schema_22_validator: Optional[CognitoUsersSettingsConfig] = None
    # data type: CrowdstrikeFdrSettingsConfig
    oneof_schema_23_validator: Optional[CrowdstrikeFdrSettingsConfig] = None
    # data type: DefenderForEndpointAlertsSettingsConfig
    oneof_schema_24_validator: Optional[DefenderForEndpointAlertsSettingsConfig] = None
    # data type: DetectSummariesSettingsConfig
    oneof_schema_25_validator: Optional[DetectSummariesSettingsConfig] = None
    # data type: DeviceActivitySettingsConfig
    oneof_schema_26_validator: Optional[DeviceActivitySettingsConfig] = None
    # data type: DeviceDetailsSettingsConfig
    oneof_schema_27_validator: Optional[DeviceDetailsSettingsConfig] = None
    # data type: DevicesSettingsConfig
    oneof_schema_28_validator: Optional[DevicesSettingsConfig] = None
    # data type: DriveActivitySettingsConfig
    oneof_schema_29_validator: Optional[DriveActivitySettingsConfig] = None
    ...
    oneof_schema_32_validator: Optional[EventsSettingsConfig] = None
    # data type: EventsLogsSettingsConfig
    oneof_schema_33_validator: Optional[EventsLogsSettingsConfig] = None
    # data type: FullScansSettingsConfig
    oneof_schema_34_validator: Optional[FullScansSettingsConfig] = None
    # data type: object
    oneof_schema_35_validator: Optional[Dict[str, Any]] = Field(default=None, description="Github Advisory Database settings")
    # data type: GitlabIssuesSettingsConfig
    oneof_schema_36_validator: Optional[GitlabIssuesSettingsConfig] = None
    ...
    oneof_schema_38_validator: Optional[IamAccessAnalyzerSettingsConfig] = None
    # data type: IssuesSettingsConfig
    oneof_schema_39_validator: Optional[IssuesSettingsConfig] = None
    # data type: KmsSettingsConfig
    oneof_schema_40_validator: Optional[KmsSettingsConfig] = None
    # data type: LogAnalyticsQuerySettingsConfig
    oneof_schema_41_validator: Optional[LogAnalyticsQuerySettingsConfig] = None
    # data type: LoginActivitySettingsConfig
    oneof_schema_42_validator: Optional[LoginActivitySettingsConfig] = None
    # data type: LoginSessionsSettingsConfig
    oneof_schema_43_validator: Optional[LoginSessionsSettingsConfig] = None
    # data type: Dict[str, object]
    oneof_schema_44_validator: Optional[Dict[str, Any]] = None
    # data type: object
    oneof_schema_45_validator: Optional[Dict[str, Any]] = Field(default=None, description="Monad HTTP settings")
    ...
    oneof_schema_47_validator: Optional[OauthActivitySettingsConfig] = None
    ...
    oneof_schema_49_validator: Optional[OneloginEventsSettingsConfig] = None
    # data type: OrganizationsSettingsConfig
    oneof_schema_50_validator: Optional[OrganizationsSettingsConfig] = None
    ...
    oneof_schema_52_validator: Optional[ResourceEvaluationsSettingsConfig] = None
    # data type: RolesInfoSettingsConfig
    oneof_schema_53_validator: Optional[RolesInfoSettingsConfig] = None
    # data type: SecretsmanagerSettingsConfig
    oneof_schema_54_validator: Optional[SecretsmanagerSettingsConfig] = None
    # data type: SecurityGroupsSettingsConfig
    oneof_schema_55_validator: Optional[SecurityGroupsSettingsConfig] = None
    # data type: SemgrepCodeFindingsSettingsConfig
    oneof_schema_56_validator: Optional[SemgrepCodeFindingsSettingsConfig] = None
    # data type: SemgrepDeploymentsSettingsConfig
    oneof_schema_57_validator: Optional[SemgrepDeploymentsSettingsConfig] = None
    # data type: SemgrepProjectDetailsSettingsConfig
    oneof_schema_58_validator: Optional[SemgrepProjectDetailsSettingsConfig] = None
    # data type: SemgrepProjectsSettingsConfig
    oneof_schema_59_validator: Optional[SemgrepProjectsSettingsConfig] = None
    # data type: SentryOrgAuditLogsSettingsConfig
    oneof_schema_60_validator: Optional[SentryOrgAuditLogsSettingsConfig] = None
    # data type: SlackUsersSettingsConfig
    oneof_schema_61_validator: Optional[SlackUsersSettingsConfig] = None
    # data type: SlackgroupsSettingsConfig
    oneof_schema_62_validator: Optional[SlackgroupsSettingsConfig] = None
    # data type: SnowflakeInputSettingsConfig
    oneof_schema_63_validator: Optional[SnowflakeInputSettingsConfig] = None
    ...
    oneof_schema_65_validator: Optional[SnykOrganizationsSettingsConfig] = None
    # data type: SnykProjectsSettingsConfig
    oneof_schema_66_validator: Optional[SnykProjectsSettingsConfig] = None
    # data type: SnykTargetsSettingsConfig
    oneof_schema_67_validator: Optional[SnykTargetsSettingsConfig] = None
    # data type: SyntheticDataSettingsConfig
    oneof_schema_68_validator: Optional[SyntheticDataSettingsConfig] = None
    # data type: SyntheticDataCustomSettingsConfig
    oneof_schema_69_validator: Optional[SyntheticDataCustomSettingsConfig] = None
    # data type: SystemlogSettingsConfig
    oneof_schema_70_validator: Optional[SystemlogSettingsConfig] = None
    # data type: TailscaleUsersSettingsConfig
    oneof_schema_71_validator: Optional[TailscaleUsersSettingsConfig] = None
    # data type: TenableAssetsSettingsConfig
    oneof_schema_72_validator: Optional[TenableAssetsSettingsConfig] = None
    # data type: TenableAssetsCronSettingsConfig
    oneof_schema_73_validator: Optional[TenableAssetsCronSettingsConfig] = None
    # data type: TenableVulnerabilitiesSettingsConfig
    oneof_schema_74_validator: Optional[TenableVulnerabilitiesSettingsConfig] = None
    # data type: TenableVulnerabilitiesCronSettingsConfig
    oneof_schema_75_validator: Optional[TenableVulnerabilitiesCronSettingsConfig] = None
    # data type: UsersSettingsConfig
    oneof_schema_76_validator: Optional[UsersSettingsConfig] = None
    # data type: UsersInfoSettingsConfig
    oneof_schema_77_validator: Optional[UsersInfoSettingsConfig] = None
    # data type: VulnerabilitiesSettingsConfig
    oneof_schema_78_validator: Optional[VulnerabilitiesSettingsConfig] = None
    # data type: VulnerabilitiesCronSettingsConfig
    oneof_schema_79_validator: Optional[VulnerabilitiesCronSettingsConfig] = None
