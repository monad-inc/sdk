...
class SecretsmanagerSettingsConfig(BaseModel):
    """
    ...
    filters: Optional[List[GithubComAwsAwsSdkGoV2ServiceSecretsmanagerTypesFilter]] = Field(default=None, description="Filters for returned secrets")
