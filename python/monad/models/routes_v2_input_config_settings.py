...
class RoutesV2InputConfigSettings(BaseModel):
    ...
    oneof_schema_35_validator: Optional[SlackUsersSettingsConfig] = None
    # data type: SlackgroupsSettingsConfig
    oneof_schema_36_validator: Optional[SlackgroupsSettingsConfig] = None
    # data type: object
    oneof_schema_37_validator: Optional[Dict[str, Any]] = Field(default=None, description="Snyk issues settings")
    # data type: SnykOrganizationsSettingsConfig
    oneof_schema_38_validator: Optional[SnykOrganizationsSettingsConfig] = None
    # data type: SnykProjectsSettingsConfig
    oneof_schema_39_validator: Optional[SnykProjectsSettingsConfig] = None
    # data type: object
    oneof_schema_40_validator: Optional[Dict[str, Any]] = Field(default=None, description="Snyk targets settings")
    # data type: object
    oneof_schema_41_validator: Optional[Dict[str, Any]] = Field(default=None, description="Tenable assets settings")
    # data type: object
    oneof_schema_42_validator: Optional[Dict[str, Any]] = Field(default=None, description="Tenable vulnerabilities settings")
    # data type: UsersSettingsConfig
    oneof_schema_43_validator: Optional[UsersSettingsConfig] = None
    # data type: UsersInfoSettingsConfig
    oneof_schema_44_validator: Optional[UsersInfoSettingsConfig] = None
    # data type: VulnerabilitiesSettingsConfig
    oneof_schema_45_validator: Optional[VulnerabilitiesSettingsConfig] = None
    # data type: VulnerabilityFindingsSettingsConfig
    oneof_schema_46_validator: Optional[VulnerabilityFindingsSettingsConfig] = None
