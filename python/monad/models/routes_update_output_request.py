...
class RoutesUpdateOutputRequest(BaseModel):
    """
    RoutesUpdateOutputRequest
    """ # noqa: E501
    config: Optional[RoutesUpdateOutputRequestConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": RoutesUpdateOutputRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
