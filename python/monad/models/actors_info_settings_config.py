...
class ActorsInfoSettingsConfig(BaseModel):
    """
    CrowdStrike EDR actors info settings
    """ # noqa: E501
    actor_type: Optional[StrictStr] = Field(default=None, description="Type of actor. Ex: 'APT', 'eCrime', 'Hacktivist', 'Insider Threat', 'Nation-State', 'Unknown', 'Other', etc. Select 'None' for no preference.")
