...
class CreateKeyValueIfKeyValueCreateKeyValueIfKeyValue(BaseModel):
    ...
    """ # noqa: E501
    arguments: Optional[CreateKeyValueIfKeyValueArgumentsConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "arguments": CreateKeyValueIfKeyValueArgumentsConfig.from_dict(obj["arguments"]) if obj.get("arguments") is not None else None
        })
        return _obj
