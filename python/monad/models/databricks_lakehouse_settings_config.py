...
class DatabricksLakehouseSettingsConfig(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "write_mode": DatabricksLakehouseWriteMode.from_dict(obj["write_mode"]) if obj.get("write_mode") is not None else None
        })
        return _obj
