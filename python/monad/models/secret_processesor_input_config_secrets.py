...
class SecretProcessesorInputConfigSecrets(BaseModel):
    ...
    oneof_schema_65_validator: Optional[VoltioAuditLogsSecretsConfig] = None
    # data type: VulnerabilityFindingsSecretsConfig
    oneof_schema_66_validator: Optional[VulnerabilityFindingsSecretsConfig] = None
    # data type: WizAuditLogsSecretsConfig
    oneof_schema_67_validator: Optional[WizAuditLogsSecretsConfig] = None
