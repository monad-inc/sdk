...
class SecretProcessesorInputConfigSecrets(BaseModel):
    ...
    oneof_schema_37_validator: Optional[IndividualAlertsSecretsConfig] = None
    # data type: InspectorSecretsConfig
    oneof_schema_38_validator: Optional[InspectorSecretsConfig] = None
    # data type: IssuesSecretsConfig
    oneof_schema_39_validator: Optional[IssuesSecretsConfig] = None
    # data type: KoiAuditLogsSecretsConfig
    oneof_schema_40_validator: Optional[KoiAuditLogsSecretsConfig] = None
    ...
    oneof_schema_42_validator: Optional[LookerAuditLogsSecretsConfig] = None
    # data type: MerakiConfigLogsSecretsConfig
    oneof_schema_43_validator: Optional[MerakiConfigLogsSecretsConfig] = None
    # data type: Microsoft365GenericSecretsConfig
    oneof_schema_44_validator: Optional[Microsoft365GenericSecretsConfig] = None
    # data type: object
    oneof_schema_45_validator: Optional[Dict[str, Any]] = Field(default=None, description="Monad Log secrets")
    ...
    oneof_schema_47_validator: Optional[OfflineenrollmentlogsSecretsConfig] = None
    # data type: OperationLogsSecretsConfig
    oneof_schema_48_validator: Optional[OperationLogsSecretsConfig] = None
    # data type: OrgAuditLogsSecretsConfig
    oneof_schema_49_validator: Optional[OrgAuditLogsSecretsConfig] = None
    # data type: PaloAltoDataSecurityAlertsSecretsConfig
    oneof_schema_50_validator: Optional[PaloAltoDataSecurityAlertsSecretsConfig] = None
    # data type: PlaidWebhooksSecretsConfig
    oneof_schema_51_validator: Optional[PlaidWebhooksSecretsConfig] = None
    # data type: SlackEnterpriseAuditLogsSecretsConfig
    oneof_schema_52_validator: Optional[SlackEnterpriseAuditLogsSecretsConfig] = None
    # data type: SnykIssuesSecretsConfig
    oneof_schema_53_validator: Optional[SnykIssuesSecretsConfig] = None
    # data type: SnykTargetsSecretsConfig
    oneof_schema_54_validator: Optional[SnykTargetsSecretsConfig] = None
    # data type: object
    oneof_schema_55_validator: Optional[Dict[str, Any]] = Field(default=None, description="Demo secrets")
    # data type: object
    oneof_schema_56_validator: Optional[Dict[str, Any]] = Field(default=None, description="Demo Custom secrets")
    # data type: TaniumGraphqlInputSecretsConfig
    oneof_schema_57_validator: Optional[TaniumGraphqlInputSecretsConfig] = None
    # data type: TeamAccessLogsSecretsConfig
    oneof_schema_58_validator: Optional[TeamAccessLogsSecretsConfig] = None
    # data type: TeamIntegrationLogsSecretsConfig
    oneof_schema_59_validator: Optional[TeamIntegrationLogsSecretsConfig] = None
    # data type: TelephonyLogsSecretsConfig
    oneof_schema_60_validator: Optional[TelephonyLogsSecretsConfig] = None
    # data type: TinesAuditLogsSecretsConfig
    oneof_schema_61_validator: Optional[TinesAuditLogsSecretsConfig] = None
    # data type: TinesEventsLogsSecretsConfig
    oneof_schema_62_validator: Optional[TinesEventsLogsSecretsConfig] = None
    # data type: TwilioEventsSecretsConfig
    oneof_schema_63_validator: Optional[TwilioEventsSecretsConfig] = None
    # data type: TwilioSendgridEmailActivitySecretsConfig
    oneof_schema_64_validator: Optional[TwilioSendgridEmailActivitySecretsConfig] = None
    # data type: VercelUserEventsSecretsConfig
    oneof_schema_65_validator: Optional[VercelUserEventsSecretsConfig] = None
    # data type: VoltioAuditLogsSecretsConfig
    oneof_schema_66_validator: Optional[VoltioAuditLogsSecretsConfig] = None
    # data type: VulnerabilityFindingsSecretsConfig
    oneof_schema_67_validator: Optional[VulnerabilityFindingsSecretsConfig] = None
    # data type: WizAuditLogsSecretsConfig
    oneof_schema_68_validator: Optional[WizAuditLogsSecretsConfig] = None
