...
class SecretProcessesorInputConfigSecrets(BaseModel):
    ...
    oneof_schema_20_validator: Optional[BitwardenEventsSecretsConfig] = None
    # data type: BoxEventsSecretsConfig
    oneof_schema_21_validator: Optional[BoxEventsSecretsConfig] = None
    # data type: BoxUsersSecretsConfig
    oneof_schema_22_validator: Optional[BoxUsersSecretsConfig] = None
    # data type: BrinqaAuditLogsSecretsConfig
    oneof_schema_23_validator: Optional[BrinqaAuditLogsSecretsConfig] = None
    # data type: BugsnagOrgEventsSecretsConfig
    oneof_schema_24_validator: Optional[BugsnagOrgEventsSecretsConfig] = None
    # data type: BuildkiteAuditLogsSecretsConfig
    oneof_schema_25_validator: Optional[BuildkiteAuditLogsSecretsConfig] = None
    # data type: BuildkiteGraphqlInputSecretsConfig
    oneof_schema_26_validator: Optional[BuildkiteGraphqlInputSecretsConfig] = None
    # data type: object
    oneof_schema_27_validator: Optional[Dict[str, Any]] = Field(default=None, description="CISA KEV secrets")
    # data type: CloudAssetInventorySecretsConfig
    oneof_schema_28_validator: Optional[CloudAssetInventorySecretsConfig] = None
    # data type: CloudConfigurationFindingsSecretsConfig
    oneof_schema_29_validator: Optional[CloudConfigurationFindingsSecretsConfig] = None
    # data type: CloudLogsSecretsConfig
    oneof_schema_30_validator: Optional[CloudLogsSecretsConfig] = None
    # data type: CloudResourceInventorySecretsConfig
    oneof_schema_31_validator: Optional[CloudResourceInventorySecretsConfig] = None
    # data type: CloudResourceInventoryReportsSecretsConfig
    oneof_schema_32_validator: Optional[CloudResourceInventoryReportsSecretsConfig] = None
    # data type: CloudflareDdosAttackAnalyticsSecretsConfig
    oneof_schema_33_validator: Optional[CloudflareDdosAttackAnalyticsSecretsConfig] = None
    # data type: CloudflareDnsRecordsSecretsConfig
    oneof_schema_34_validator: Optional[CloudflareDnsRecordsSecretsConfig] = None
    # data type: CloudflareFirewallEventsSecretsConfig
    oneof_schema_35_validator: Optional[CloudflareFirewallEventsSecretsConfig] = None
    # data type: CloudflareHttpRequestsSecretsConfig
    oneof_schema_36_validator: Optional[CloudflareHttpRequestsSecretsConfig] = None
    # data type: CloudflarePageShieldConnectionsSecretsConfig
    oneof_schema_37_validator: Optional[CloudflarePageShieldConnectionsSecretsConfig] = None
    # data type: CloudflareRulesetsSecretsConfig
    oneof_schema_38_validator: Optional[CloudflareRulesetsSecretsConfig] = None
    # data type: CloudflareSecurityInsightsSecretsConfig
    oneof_schema_39_validator: Optional[CloudflareSecurityInsightsSecretsConfig] = None
    # data type: CloudflareUrlScannerSecretsConfig
    oneof_schema_40_validator: Optional[CloudflareUrlScannerSecretsConfig] = None
    # data type: CloudflareUsersSecretsConfig
    oneof_schema_41_validator: Optional[CloudflareUsersSecretsConfig] = None
    # data type: CloudflareZeroTrustAccessRequestsSecretsConfig
    oneof_schema_42_validator: Optional[CloudflareZeroTrustAccessRequestsSecretsConfig] = None
    # data type: CloudflareZonesSecretsConfig
    oneof_schema_43_validator: Optional[CloudflareZonesSecretsConfig] = None
    # data type: ClumioAuditLogsSecretsConfig
    oneof_schema_44_validator: Optional[ClumioAuditLogsSecretsConfig] = None
    # data type: ClumioConsolidatedAlertsSecretsConfig
    oneof_schema_45_validator: Optional[ClumioConsolidatedAlertsSecretsConfig] = None
    # data type: CodaAuditEventsSecretsConfig
    oneof_schema_46_validator: Optional[CodaAuditEventsSecretsConfig] = None
    # data type: CortexXsoarManagementLogsSecretsConfig
    oneof_schema_47_validator: Optional[CortexXsoarManagementLogsSecretsConfig] = None
    # data type: CrowdstrikeFdrSecretsConfig
    oneof_schema_48_validator: Optional[CrowdstrikeFdrSecretsConfig] = None
    # data type: CustomerEventDataSecretsConfig
    oneof_schema_49_validator: Optional[CustomerEventDataSecretsConfig] = None
    # data type: DefenderForEndpointAlertsSecretsConfig
    oneof_schema_50_validator: Optional[DefenderForEndpointAlertsSecretsConfig] = None
    # data type: DeviceDetailsSecretsConfig
    oneof_schema_51_validator: Optional[DeviceDetailsSecretsConfig] = None
    # data type: DevicesSecretsConfig
    oneof_schema_52_validator: Optional[DevicesSecretsConfig] = None
    # data type: EndorLabsAuditLogsSecretsConfig
    oneof_schema_53_validator: Optional[EndorLabsAuditLogsSecretsConfig] = None
    # data type: EntraIdSecretsConfig
    oneof_schema_54_validator: Optional[EntraIdSecretsConfig] = None
    # data type: EventSecretsConfig
    oneof_schema_55_validator: Optional[EventSecretsConfig] = None
    ...
    oneof_schema_103_validator: Optional[SystemlogSecretsConfig] = None
