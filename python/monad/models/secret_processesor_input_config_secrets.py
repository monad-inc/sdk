...
class SecretProcessesorInputConfigSecrets(BaseModel):
    ...
    oneof_schema_48_validator: Optional[SemgrepCodeFindingsSecretsConfig] = None
    # data type: SemgrepDeploymentsSecretsConfig
    oneof_schema_49_validator: Optional[SemgrepDeploymentsSecretsConfig] = None
    # data type: SemgrepProjectDetailsSecretsConfig
    oneof_schema_50_validator: Optional[SemgrepProjectDetailsSecretsConfig] = None
    # data type: SemgrepProjectsSecretsConfig
    oneof_schema_51_validator: Optional[SemgrepProjectsSecretsConfig] = None
    # data type: SemgrepSupplyChainFindingsSecretsConfig
    oneof_schema_52_validator: Optional[SemgrepSupplyChainFindingsSecretsConfig] = None
    # data type: SlackUsersSecretsConfig
    oneof_schema_53_validator: Optional[SlackUsersSecretsConfig] = None
    # data type: SlackgroupsSecretsConfig
    oneof_schema_54_validator: Optional[SlackgroupsSecretsConfig] = None
    # data type: SnowflakeInputSecretsConfig
    oneof_schema_55_validator: Optional[SnowflakeInputSecretsConfig] = None
    # data type: SnykIssuesSecretsConfig
    oneof_schema_56_validator: Optional[SnykIssuesSecretsConfig] = None
    # data type: SnykOrganizationsSecretsConfig
    oneof_schema_57_validator: Optional[SnykOrganizationsSecretsConfig] = None
    # data type: SnykProjectsSecretsConfig
    oneof_schema_58_validator: Optional[SnykProjectsSecretsConfig] = None
    ...
    oneof_schema_60_validator: Optional[TailscaleUsersSecretsConfig] = None
    # data type: TenableAssetsSecretsConfig
    oneof_schema_61_validator: Optional[TenableAssetsSecretsConfig] = None
    # data type: TenableAssetsCronSecretsConfig
    oneof_schema_62_validator: Optional[TenableAssetsCronSecretsConfig] = None
    # data type: TenableVulnerabilitiesSecretsConfig
    oneof_schema_63_validator: Optional[TenableVulnerabilitiesSecretsConfig] = None
    # data type: TenableVulnerabilitiesCronSecretsConfig
    oneof_schema_64_validator: Optional[TenableVulnerabilitiesCronSecretsConfig] = None
    # data type: UsersSecretsConfig
    oneof_schema_65_validator: Optional[UsersSecretsConfig] = None
    # data type: UsersInfoSecretsConfig
    oneof_schema_66_validator: Optional[UsersInfoSecretsConfig] = None
    # data type: VulnerabilitiesSecretsConfig
    oneof_schema_67_validator: Optional[VulnerabilitiesSecretsConfig] = None
    # data type: VulnerabilitiesCronSecretsConfig
    oneof_schema_68_validator: Optional[VulnerabilitiesCronSecretsConfig] = None
