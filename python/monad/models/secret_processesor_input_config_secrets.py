...
class SecretProcessesorInputConfigSecrets(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, BuildkiteGraphqlInputSecretsConfig):
            ...
            match += 1
        # validate data type: CatoNetworksEventsSecretsConfig
        if not isinstance(v, CatoNetworksEventsSecretsConfig):
            error_messages.append(f"Error! Input type `{type(v)}` is not `CatoNetworksEventsSecretsConfig`")
        else:
            match += 1
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into CatoNetworksEventsSecretsConfig
        try:
            instance.actual_instance = CatoNetworksEventsSecretsConfig.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
