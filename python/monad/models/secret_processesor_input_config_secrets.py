...
class SecretProcessesorInputConfigSecrets(BaseModel):
    ...
    oneof_schema_63_validator: Optional[SlackUsersSecretsConfig] = None
    # data type: SlackgroupsSecretsConfig
    oneof_schema_64_validator: Optional[SlackgroupsSecretsConfig] = None
    # data type: SnowflakeInputSecretsConfig
    oneof_schema_65_validator: Optional[SnowflakeInputSecretsConfig] = None
    # data type: SnykIssuesSecretsConfig
    oneof_schema_66_validator: Optional[SnykIssuesSecretsConfig] = None
    # data type: SnykOrganizationsSecretsConfig
    oneof_schema_67_validator: Optional[SnykOrganizationsSecretsConfig] = None
    # data type: SnykProjectsSecretsConfig
    oneof_schema_68_validator: Optional[SnykProjectsSecretsConfig] = None
    # data type: SnykTargetsSecretsConfig
    oneof_schema_69_validator: Optional[SnykTargetsSecretsConfig] = None
    # data type: TailscaleUsersSecretsConfig
    oneof_schema_70_validator: Optional[TailscaleUsersSecretsConfig] = None
    # data type: TenableAssetsSecretsConfig
    oneof_schema_71_validator: Optional[TenableAssetsSecretsConfig] = None
    # data type: TenableAssetsCronSecretsConfig
    oneof_schema_72_validator: Optional[TenableAssetsCronSecretsConfig] = None
    # data type: TenableVulnerabilitiesSecretsConfig
    oneof_schema_73_validator: Optional[TenableVulnerabilitiesSecretsConfig] = None
    # data type: TenableVulnerabilitiesCronSecretsConfig
    oneof_schema_74_validator: Optional[TenableVulnerabilitiesCronSecretsConfig] = None
    # data type: UsersSecretsConfig
    oneof_schema_75_validator: Optional[UsersSecretsConfig] = None
    # data type: UsersInfoSecretsConfig
    oneof_schema_76_validator: Optional[UsersInfoSecretsConfig] = None
    # data type: VulnerabilitiesSecretsConfig
    oneof_schema_77_validator: Optional[VulnerabilitiesSecretsConfig] = None
    # data type: VulnerabilitiesCronSecretsConfig
    oneof_schema_78_validator: Optional[VulnerabilitiesCronSecretsConfig] = None
    # data type: VulnerabilityFindingsSecretsConfig
    oneof_schema_79_validator: Optional[VulnerabilityFindingsSecretsConfig] = None
