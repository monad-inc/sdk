...
class SecretProcessesorInputConfigSecrets(BaseModel):
    ...
    oneof_schema_70_validator: Optional[VercelUserEventsSecretsConfig] = None
    # data type: VoltioAuditLogsSecretsConfig
    oneof_schema_71_validator: Optional[VoltioAuditLogsSecretsConfig] = None
    # data type: VulnerabilityFindingsSecretsConfig
    oneof_schema_72_validator: Optional[VulnerabilityFindingsSecretsConfig] = None
    # data type: WizAuditLogsSecretsConfig
    oneof_schema_73_validator: Optional[WizAuditLogsSecretsConfig] = None
