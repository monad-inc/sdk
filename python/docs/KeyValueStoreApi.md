# monad.KeyValueStoreApi

All URIs are relative to *https://monad.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_kv_lookup_metadata**](KeyValueStoreApi.md#get_kv_lookup_metadata) | **GET** /v3/{organization_id}/kv_lookup/metadata | Get KV lookup metadata
[**get_kv_lookup_sample_entries**](KeyValueStoreApi.md#get_kv_lookup_sample_entries) | **GET** /v3/{organization_id}/kv_lookup/sample | Get KV lookup sample entries
[**get_value_from_kv_store**](KeyValueStoreApi.md#get_value_from_kv_store) | **GET** /v3/{organization_id}/kv_lookup/value | Get value by key from KV lookup


# **get_kv_lookup_metadata**
> KvlookupGetMetadataResponse get_kv_lookup_metadata(organization_id, component_id)
...
with monad.ApiClient(configuration) as api_client:
    ...
    api_instance = monad.KeyValueStoreApi(api_client)
    organization_id = 'organization_id_example' # str | Organization ID
    component_id = 'component_id_example' # str | Component ID

    try:
        # Get KV lookup metadata
        api_response = api_instance.get_kv_lookup_metadata(organization_id, component_id)
        print("The response of KeyValueStoreApi->get_kv_lookup_metadata:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeyValueStoreApi->get_kv_lookup_metadata: %s\n" % e)
```
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        # Get KV lookup sample entries
        api_response = api_instance.get_kv_lookup_sample_entries(organization_id, component_id, num_entries)
        print("The response of KeyValueStoreApi->get_kv_lookup_sample_entries:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeyValueStoreApi->get_kv_lookup_sample_entries: %s\n" % e)
```
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        # Get value by key from KV lookup
        api_response = api_instance.get_value_from_kv_store(organization_id, component_id, key)
        print("The response of KeyValueStoreApi->get_value_from_kv_store:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling KeyValueStoreApi->get_value_from_kv_store: %s\n" % e)
```
