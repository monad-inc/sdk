# monad.TransformSandboxApi

All URIs are relative to *https://monad.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**apply_transformation**](TransformSandboxApi.md#apply_transformation) | **POST** /v2/{organization_id}/sandbox/transform | Apply transformation to record
[**apply_transformation_v2**](TransformSandboxApi.md#apply_transformation_v2) | **POST** /v2/sandbox/transform | Apply transformation to record
[**generate_record**](TransformSandboxApi.md#generate_record) | **POST** /v2/sandbox/template | Generate sample record
[**list_templates**](TransformSandboxApi.md#list_templates) | **GET** /v2/sandbox/template | List available templates
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TransformSandboxApi->apply_transformation: %s\n" % e)
```
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TransformSandboxApi->apply_transformation_v2: %s\n" % e)
```
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling TransformSandboxApi->generate_record: %s\n" % e)
```
...
# **list_templates**
> RoutesV2ListTemplatesResponse list_templates(body=body)
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        # List available templates
        api_response = api_instance.list_templates(body=body)
        print("The response of TransformSandboxApi->list_templates:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TransformSandboxApi->list_templates: %s\n" % e)
```
