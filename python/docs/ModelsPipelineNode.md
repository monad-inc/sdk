...
**config_overrides** | **Dict[str, object]** | ConfigOverrides is the node&#39;s sparse override delta over its component&#39;s base config (RFC 0017 §3). Nil when the node has no override. | [optional] 
