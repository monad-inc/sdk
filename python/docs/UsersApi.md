...
[**enable_mfa**](UsersApi.md#enable_mfa) | **POST** /v3/users/mfa | Enable MFA
[**get_active_user**](UsersApi.md#get_active_user) | **GET** /v1/users | Get your current user
[**get_mfa_status**](UsersApi.md#get_mfa_status) | **GET** /v3/users/mfa | Get MFA status
...
# **enable_mfa**
> AuthenticationtypesMFAEnrollmentTicket enable_mfa()
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable MFA
        api_response = api_instance.enable_mfa()
        print("The response of UsersApi->enable_mfa:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->enable_mfa: %s\n" % e)
```
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling UsersApi->get_active_user: %s\n" % e)
```
...
# **get_mfa_status**
> RoutesV3MFAStatusResponse get_mfa_status()
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        # Get MFA status
        api_response = api_instance.get_mfa_status()
        print("The response of UsersApi->get_mfa_status:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsersApi->get_mfa_status: %s\n" % e)
```
