# monad.ConditionSandboxApi

All URIs are relative to *https://monad.com/api*

Method | HTTP request | Description
------------- | ------------- | -------------
[**apply_condition_v2**](ConditionSandboxApi.md#apply_condition_v2) | **POST** /v2/sandbox/condition | Apply condition to record
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ConditionSandboxApi->apply_condition_v2: %s\n" % e)
```
