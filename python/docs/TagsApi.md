...
# **delete_tag**
> delete_tag(organization_id, tag)
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a tag
        api_instance.delete_tag(organization_id, tag)
    except Exception as e:
...
# **get_tag**
> RoutesV3TagResponse get_tag(organization_id, tag)
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a tag
        api_response = api_instance.get_tag(organization_id, tag)
...
# **update_tag**
> RoutesV3TagResponse update_tag(organization_id, tag, update_tag_request)
...
with monad.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a tag
        api_response = api_instance.update_tag(organization_id, tag, update_tag_request)
