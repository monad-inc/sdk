...
|------------ | ------------- | ------------- | -------------|
|**appName** | **String** | The application name the connector uses to connect to the CrowdStrike data stream. It&#39;s important that this name is unique to avoid conflicts with other applications connecting to the same stream. You&#39;re advised to use a unique identifier for this application. For example, if you have 2 stream input connections they should not both share the same name. |  [optional] |
