...
<a id="listOutputTypes"></a>
# **listOutputTypes**
> List&lt;OutputsConnectorMeta&gt; listOutputTypes()
...
public class Example {
  public static void main(String[] args) {
    ...
    OutputsApi apiInstance = new OutputsApi(defaultClient);
    try {
      List<OutputsConnectorMeta> result = apiInstance.listOutputTypes();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OutputsApi#listOutputTypes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
