...
import org.openapitools.client.model.ModelsUserList;
...
public class UsersApi {
     ...
     */
    public okhttp3.Call v1UsersGetCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call v1UsersGetValidateBeforeCall(Integer limit, Integer offset, final ApiCallback _callback) throws ApiException {
        return v1UsersGetCall(limit, offset, _callback);
     ...
     */
    public ModelsUserList v1UsersGet(Integer limit, Integer offset) throws ApiException {
        ApiResponse<ModelsUserList> localVarResp = v1UsersGetWithHttpInfo(limit, offset);
     ...
     */
    public ApiResponse<ModelsUserList> v1UsersGetWithHttpInfo(Integer limit, Integer offset) throws ApiException {
        okhttp3.Call localVarCall = v1UsersGetValidateBeforeCall(limit, offset, null);
        Type localVarReturnType = new TypeToken<ModelsUserList>(){}.getType();
     ...
     */
    public okhttp3.Call v1UsersGetAsync(Integer limit, Integer offset, final ApiCallback<ModelsUserList> _callback) throws ApiException {

        okhttp3.Call localVarCall = v1UsersGetValidateBeforeCall(limit, offset, _callback);
        Type localVarReturnType = new TypeToken<ModelsUserList>(){}.getType();
