...
public class BillingAccountsApi {
     ...
     */
    public okhttp3.Call deleteBillingAccountCall(@javax.annotation.Nonnull String billingAccountId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteBillingAccountValidateBeforeCall(@javax.annotation.Nonnull String billingAccountId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'billingAccountId' is set
        if (billingAccountId == null) {
            throw new ApiException("Missing the required parameter 'billingAccountId' when calling deleteBillingAccount(Async)");
        }

        return deleteBillingAccountCall(billingAccountId, _callback);
     ...
     */
    public void deleteBillingAccount(@javax.annotation.Nonnull String billingAccountId) throws ApiException {
        deleteBillingAccountWithHttpInfo(billingAccountId);
    }
     ...
     */
    public ApiResponse<Void> deleteBillingAccountWithHttpInfo(@javax.annotation.Nonnull String billingAccountId) throws ApiException {
        okhttp3.Call localVarCall = deleteBillingAccountValidateBeforeCall(billingAccountId, null);
     ...
     */
    public okhttp3.Call deleteBillingAccountAsync(@javax.annotation.Nonnull String billingAccountId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteBillingAccountValidateBeforeCall(billingAccountId, _callback);
     ...
     */
    public okhttp3.Call getBillingAccountCall(@javax.annotation.Nonnull String billingAccountId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getBillingAccountValidateBeforeCall(@javax.annotation.Nonnull String billingAccountId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'billingAccountId' is set
        if (billingAccountId == null) {
            throw new ApiException("Missing the required parameter 'billingAccountId' when calling getBillingAccount(Async)");
        }

        return getBillingAccountCall(billingAccountId, _callback);
     ...
     */
    public ModelsBillingAccount getBillingAccount(@javax.annotation.Nonnull String billingAccountId) throws ApiException {
        ApiResponse<ModelsBillingAccount> localVarResp = getBillingAccountWithHttpInfo(billingAccountId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ModelsBillingAccount> getBillingAccountWithHttpInfo(@javax.annotation.Nonnull String billingAccountId) throws ApiException {
        okhttp3.Call localVarCall = getBillingAccountValidateBeforeCall(billingAccountId, null);
        Type localVarReturnType = new TypeToken<ModelsBillingAccount>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getBillingAccountAsync(@javax.annotation.Nonnull String billingAccountId, final ApiCallback<ModelsBillingAccount> _callback) throws ApiException {

        okhttp3.Call localVarCall = getBillingAccountValidateBeforeCall(billingAccountId, _callback);
        Type localVarReturnType = new TypeToken<ModelsBillingAccount>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getBillingAccountsCall(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getBillingAccountsValidateBeforeCall(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, final ApiCallback _callback) throws ApiException {
        return getBillingAccountsCall(limit, offset, _callback);
     ...
     */
    public ModelsBillingAccountList getBillingAccounts(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset) throws ApiException {
        ApiResponse<ModelsBillingAccountList> localVarResp = getBillingAccountsWithHttpInfo(limit, offset);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ModelsBillingAccountList> getBillingAccountsWithHttpInfo(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset) throws ApiException {
        okhttp3.Call localVarCall = getBillingAccountsValidateBeforeCall(limit, offset, null);
     ...
     */
    public okhttp3.Call getBillingAccountsAsync(@javax.annotation.Nullable Integer limit, @javax.annotation.Nullable Integer offset, final ApiCallback<ModelsBillingAccountList> _callback) throws ApiException {

        okhttp3.Call localVarCall = getBillingAccountsValidateBeforeCall(limit, offset, _callback);
        Type localVarReturnType = new TypeToken<ModelsBillingAccountList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
