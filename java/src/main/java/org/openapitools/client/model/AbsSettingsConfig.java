...
public class AbsSettingsConfig {
  ...
  public AbsSettingsConfig() {
  }

  public AbsSettingsConfig accountUrl(@javax.annotation.Nullable String accountUrl) {
  ...
  public AbsSettingsConfig batchConfig(@javax.annotation.Nullable BatchConfigBatchConfig batchConfig) {
  ...
  public AbsSettingsConfig compression(@javax.annotation.Nullable String compression) {
  ...
  public AbsSettingsConfig container(@javax.annotation.Nullable String container) {
  ...
  public AbsSettingsConfig formatConfig(@javax.annotation.Nullable FormatterFormatConfig formatConfig) {
  ...
  public AbsSettingsConfig partitionFormat(@javax.annotation.Nullable String partitionFormat) {
  ...
  public AbsSettingsConfig prefix(@javax.annotation.Nullable String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AbsSettingsConfig absSettingsConfig = (AbsSettingsConfig) o;
    return Objects.equals(this.accountUrl, absSettingsConfig.accountUrl) &&
        Objects.equals(this.batchConfig, absSettingsConfig.batchConfig) &&
        Objects.equals(this.compression, absSettingsConfig.compression) &&
        Objects.equals(this.container, absSettingsConfig.container) &&
        Objects.equals(this.formatConfig, absSettingsConfig.formatConfig) &&
        Objects.equals(this.partitionFormat, absSettingsConfig.partitionFormat) &&
        Objects.equals(this.prefix, absSettingsConfig.prefix);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountUrl, batchConfig, compression, container, formatConfig, partitionFormat, prefix);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AbsSettingsConfig {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("account_url", "batch_config", "compression", "container", "format_config", "partition_format", "prefix"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AbsSettingsConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AbsSettingsConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AbsSettingsConfig is not found in the empty JSON string", AbsSettingsConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AbsSettingsConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AbsSettingsConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbsSettingsConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbsSettingsConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbsSettingsConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbsSettingsConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<AbsSettingsConfig>() {
           @Override
           public void write(JsonWriter out, AbsSettingsConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AbsSettingsConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AbsSettingsConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AbsSettingsConfig
   * @throws IOException if the JSON string is invalid with respect to AbsSettingsConfig
   */
  public static AbsSettingsConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbsSettingsConfig.class);
  }

  /**
   * Convert an instance of AbsSettingsConfig to an JSON string
   *
   * @return JSON string
   */
