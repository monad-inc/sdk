...
public class ModelsQuota {
  ...
  public ModelsQuota action(@javax.annotation.Nullable ModelsQuotaAction action) {
    this.action = action;
    return this;
  }
  ...
  public ModelsQuota limitType(@javax.annotation.Nullable ModelsQuotaLimitType limitType) {
  ...
  public ModelsQuota limitUnit(@javax.annotation.Nullable ModelsQuotaLimitUnit limitUnit) {
  ...
  public ModelsQuota timeframe(@javax.annotation.Nullable ModelsQuotaTimeframe timeframe) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsQuota.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelsQuota is not found in the empty JSON string", ModelsQuota.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsQuota.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModelsQuota` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
