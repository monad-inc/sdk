...
public class ModelsTransform {
  ...
  public ModelsTransform managedBy(@javax.annotation.Nullable ModelsManagedBy managedBy) {
  ...
  public ModelsTransform shareDetails(@javax.annotation.Nullable ModelsShareDetails shareDetails) {
  ...
  public ModelsTransform version(@javax.annotation.Nullable Integer version) {
  ...
  public boolean equals(Object o) {
    ...
    ModelsTransform modelsTransform = (ModelsTransform) o;
    return Objects.equals(this.config, modelsTransform.config) &&
        ...
        Objects.equals(this.shareDetails, modelsTransform.shareDetails) &&
        Objects.equals(this.updatedAt, modelsTransform.updatedAt) &&
        Objects.equals(this.version, modelsTransform.version);
  }

  @Override
  public int hashCode() {
    return Objects.hash(config, createdAt, description, id, managedBy, name, organizationId, references, shareDetails, updatedAt, version);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ModelsTransform {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("config", "created_at", "description", "id", "managed_by", "name", "organization_id", "references", "share_details", "updated_at", "version"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelsTransform
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsTransform.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelsTransform is not found in the empty JSON string", ModelsTransform.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsTransform.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModelsTransform` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsTransform.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsTransform' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsTransform> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsTransform.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsTransform>() {
           @Override
           public void write(JsonWriter out, ModelsTransform value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsTransform read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModelsTransform given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelsTransform
   * @throws IOException if the JSON string is invalid with respect to ModelsTransform
   */
  public static ModelsTransform fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsTransform.class);
  }

  /**
   * Convert an instance of ModelsTransform to an JSON string
   *
   * @return JSON string
   */
