...
public class ModelsInput {
  ...
  public ModelsInput managedBy(@javax.annotation.Nullable ModelsManagedBy managedBy) {
  ...
  public ModelsInput references(@javax.annotation.Nullable ModelsReferences references) {
  ...
  public ModelsInput version(@javax.annotation.Nullable Integer version) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.config, modelsInput.config) &&
        ...
        Objects.equals(this.managedBy, modelsInput.managedBy) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelsInput is not found in the empty JSON string", ModelsInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModelsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
