...
public class OpenaiSettingsConfig {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.useSyntheticData, openaiSettingsConfig.useSyntheticData);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OpenaiSettingsConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpenaiSettingsConfig is not found in the empty JSON string", OpenaiSettingsConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OpenaiSettingsConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `OpenaiSettingsConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
