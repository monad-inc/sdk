...
public class ModelsPipeline {
  ...
  public ModelsPipeline status(@javax.annotation.Nullable ModelsPipelineStatus status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.componentTier, modelsPipeline.componentTier) &&
        ...
        Objects.equals(this.managedBy, modelsPipeline.managedBy) &&
        Objects.equals(this.name, modelsPipeline.name) &&
        Objects.equals(this.organizationId, modelsPipeline.organizationId) &&
        Objects.equals(this.status, modelsPipeline.status) &&
        Objects.equals(this.tags, modelsPipeline.tags) &&
        Objects.equals(this.updatedAt, modelsPipeline.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(componentTier, createdAt, cronSchedule, description, enabled, id, inputId, managedBy, name, organizationId, status, tags, updatedAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("component_tier", "created_at", "cron_schedule", "description", "enabled", "id", "input_id", "managed_by", "name", "organization_id", "status", "tags", "updated_at"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsPipeline.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelsPipeline is not found in the empty JSON string", ModelsPipeline.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsPipeline.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModelsPipeline` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("cron_schedule") != null && !jsonObj.get("cron_schedule").isJsonNull()) && !jsonObj.get("cron_schedule").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `cron_schedule` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cron_schedule").toString()));
      }
