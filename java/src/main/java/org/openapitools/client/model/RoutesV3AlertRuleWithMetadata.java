...
public class RoutesV3AlertRuleWithMetadata {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active, createdAt, description, id, invertSelection, managedBy, name, organizationId, pipelineIds, resourceMetadata, ruleConfig, severity, type, updatedAt);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("active", "created_at", "description", "id", "invert_selection", "managed_by", "name", "organization_id", "pipeline_ids", "resource_metadata", "rule_config", "severity", "type", "updated_at"));
