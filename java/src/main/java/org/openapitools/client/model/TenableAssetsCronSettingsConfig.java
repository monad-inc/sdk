...
public class TenableAssetsCronSettingsConfig {
  ...
  public TenableAssetsCronSettingsConfig rateLimit(@javax.annotation.Nullable ModelsInputRateLimit rateLimit) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cron, tenableAssetsCronSettingsConfig.cron) &&
        Objects.equals(this.rateLimit, tenableAssetsCronSettingsConfig.rateLimit);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TenableAssetsCronSettingsConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TenableAssetsCronSettingsConfig is not found in the empty JSON string", TenableAssetsCronSettingsConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TenableAssetsCronSettingsConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TenableAssetsCronSettingsConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
