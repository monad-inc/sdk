...
public class ConvertTimestampArgumentsConfig {
  ...
  public ConvertTimestampArgumentsConfig sourceFormatCustom(@javax.annotation.Nullable String sourceFormatCustom) {
  ...
  public ConvertTimestampArgumentsConfig sourceKey(@javax.annotation.Nullable String sourceKey) {
  ...
  public ConvertTimestampArgumentsConfig sourceTimezone(@javax.annotation.Nullable String sourceTimezone) {
  ...
  public ConvertTimestampArgumentsConfig targetFormatCustom(@javax.annotation.Nullable String targetFormatCustom) {
  ...
  public ConvertTimestampArgumentsConfig targetKey(@javax.annotation.Nullable String targetKey) {
  ...
  public ConvertTimestampArgumentsConfig targetTimezone(@javax.annotation.Nullable String targetTimezone) {
  ...
  public boolean equals(Object o) {
    ...
    ConvertTimestampArgumentsConfig convertTimestampArgumentsConfig = (ConvertTimestampArgumentsConfig) o;
    return Objects.equals(this.sourceFormat, convertTimestampArgumentsConfig.sourceFormat) &&
        Objects.equals(this.sourceFormatCustom, convertTimestampArgumentsConfig.sourceFormatCustom) &&
        Objects.equals(this.sourceKey, convertTimestampArgumentsConfig.sourceKey) &&
        Objects.equals(this.sourceTimezone, convertTimestampArgumentsConfig.sourceTimezone) &&
        Objects.equals(this.targetFormat, convertTimestampArgumentsConfig.targetFormat) &&
        Objects.equals(this.targetFormatCustom, convertTimestampArgumentsConfig.targetFormatCustom) &&
        Objects.equals(this.targetKey, convertTimestampArgumentsConfig.targetKey) &&
        Objects.equals(this.targetTimezone, convertTimestampArgumentsConfig.targetTimezone);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConvertTimestampArgumentsConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConvertTimestampArgumentsConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConvertTimestampArgumentsConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ConvertTimestampArgumentsConfig is not found in the empty JSON string", ConvertTimestampArgumentsConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConvertTimestampArgumentsConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ConvertTimestampArgumentsConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConvertTimestampArgumentsConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConvertTimestampArgumentsConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConvertTimestampArgumentsConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConvertTimestampArgumentsConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<ConvertTimestampArgumentsConfig>() {
           @Override
           public void write(JsonWriter out, ConvertTimestampArgumentsConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ConvertTimestampArgumentsConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ConvertTimestampArgumentsConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ConvertTimestampArgumentsConfig
   * @throws IOException if the JSON string is invalid with respect to ConvertTimestampArgumentsConfig
   */
  public static ConvertTimestampArgumentsConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConvertTimestampArgumentsConfig.class);
  }

  /**
   * Convert an instance of ConvertTimestampArgumentsConfig to an JSON string
   *
   * @return JSON string
   */
