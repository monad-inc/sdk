...
public class RoutesV2CreatePipelineRequest {
  ...
  public RoutesV2CreatePipelineRequest cronSchedule(@javax.annotation.Nullable String cronSchedule) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cronSchedule, routesV2CreatePipelineRequest.cronSchedule) &&
        Objects.equals(this.description, routesV2CreatePipelineRequest.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cronSchedule, description, edges, enabled, name, nodes);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("cron_schedule", "description", "edges", "enabled", "name", "nodes"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RoutesV2CreatePipelineRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RoutesV2CreatePipelineRequest is not found in the empty JSON string", RoutesV2CreatePipelineRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RoutesV2CreatePipelineRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RoutesV2CreatePipelineRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
