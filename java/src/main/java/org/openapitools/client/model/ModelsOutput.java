...
public class ModelsOutput {
  ...
  public ModelsOutput config(@javax.annotation.Nullable ModelsOutputConfig config) {
    this.config = config;
    return this;
  }
  ...
  public ModelsOutput createdAt(@javax.annotation.Nullable String createdAt) {
  ...
  public ModelsOutput description(@javax.annotation.Nullable String description) {
  ...
  public ModelsOutput id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ModelsOutput managedBy(@javax.annotation.Nullable ModelsManagedBy managedBy) {
  ...
  public ModelsOutput name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ModelsOutput organizationId(@javax.annotation.Nullable String organizationId) {
  ...
  public ModelsOutput references(@javax.annotation.Nullable ModelsReferences references) {
  ...
  public ModelsOutput shareDetails(@javax.annotation.Nullable ModelsShareDetails shareDetails) {
  ...
  public ModelsOutput templateSettings(@javax.annotation.Nullable ModelsTemplateSettings templateSettings) {
  ...
  public ModelsOutput type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public ModelsOutput updatedAt(@javax.annotation.Nullable String updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    ModelsOutput modelsOutput = (ModelsOutput) o;
    return Objects.equals(this.config, modelsOutput.config) &&
        Objects.equals(this.createdAt, modelsOutput.createdAt) &&
        Objects.equals(this.description, modelsOutput.description) &&
        Objects.equals(this.id, modelsOutput.id) &&
        Objects.equals(this.managedBy, modelsOutput.managedBy) &&
        Objects.equals(this.name, modelsOutput.name) &&
        Objects.equals(this.organizationId, modelsOutput.organizationId) &&
        Objects.equals(this.references, modelsOutput.references) &&
        Objects.equals(this.shareDetails, modelsOutput.shareDetails) &&
        Objects.equals(this.templateSettings, modelsOutput.templateSettings) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ModelsOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ModelsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ModelsOutput is not found in the empty JSON string", ModelsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ModelsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ModelsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ModelsOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ModelsOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ModelsOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ModelsOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<ModelsOutput>() {
           @Override
           public void write(JsonWriter out, ModelsOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ModelsOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ModelsOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ModelsOutput
   * @throws IOException if the JSON string is invalid with respect to ModelsOutput
   */
  public static ModelsOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ModelsOutput.class);
  }

  /**
   * Convert an instance of ModelsOutput to an JSON string
   *
   * @return JSON string
   */
