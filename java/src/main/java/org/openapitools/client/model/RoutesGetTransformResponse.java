...
public class RoutesGetTransformResponse {
  ...
  public RoutesGetTransformResponse addComponentOfItem(ModelsPipeline componentOfItem) {
  ...
  public RoutesGetTransformResponse managedBy(@javax.annotation.Nullable ModelsManagedBy managedBy) {
  ...
  public RoutesGetTransformResponse references(@javax.annotation.Nullable ModelsReferences references) {
  ...
  public boolean equals(Object o) {
    ...
    RoutesGetTransformResponse routesGetTransformResponse = (RoutesGetTransformResponse) o;
    return Objects.equals(this.componentOf, routesGetTransformResponse.componentOf) &&
        Objects.equals(this.config, routesGetTransformResponse.config) &&
        Objects.equals(this.createdAt, routesGetTransformResponse.createdAt) &&
        Objects.equals(this.description, routesGetTransformResponse.description) &&
        Objects.equals(this.id, routesGetTransformResponse.id) &&
        Objects.equals(this.managedBy, routesGetTransformResponse.managedBy) &&
        Objects.equals(this.name, routesGetTransformResponse.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(componentOf, config, createdAt, description, id, managedBy, name, organizationId, references, updatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RoutesGetTransformResponse {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("component_of", "config", "created_at", "description", "id", "managed_by", "name", "organization_id", "references", "updated_at"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RoutesGetTransformResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RoutesGetTransformResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RoutesGetTransformResponse is not found in the empty JSON string", RoutesGetTransformResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RoutesGetTransformResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RoutesGetTransformResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RoutesGetTransformResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RoutesGetTransformResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RoutesGetTransformResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RoutesGetTransformResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RoutesGetTransformResponse>() {
           @Override
           public void write(JsonWriter out, RoutesGetTransformResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RoutesGetTransformResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RoutesGetTransformResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RoutesGetTransformResponse
   * @throws IOException if the JSON string is invalid with respect to RoutesGetTransformResponse
   */
  public static RoutesGetTransformResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RoutesGetTransformResponse.class);
  }

  /**
   * Convert an instance of RoutesGetTransformResponse to an JSON string
   *
   * @return JSON string
   */
