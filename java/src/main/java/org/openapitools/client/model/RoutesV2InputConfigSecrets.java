...
public class RoutesV2InputConfigSecrets extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            final TypeAdapter<MonadHttpSecretsConfig> adapterMonadHttpSecretsConfig = gson.getDelegateAdapter(this, TypeToken.get(MonadHttpSecretsConfig.class));
            ...
            return (TypeAdapter<T>) new TypeAdapter<RoutesV2InputConfigSecrets>() {
                ...
                public void write(JsonWriter out, RoutesV2InputConfigSecrets value) throws IOException {
                    ...
                    // check if the actual instance is of the type `MonadHttpSecretsConfig`
                    if (value.getActualInstance() instanceof MonadHttpSecretsConfig) {
                        JsonElement element = adapterMonadHttpSecretsConfig.toJsonTree((MonadHttpSecretsConfig)value.getActualInstance());
                        elementAdapter.write(out, element);
                        return;
                    }
                ...
                public RoutesV2InputConfigSecrets read(JsonReader in) throws IOException {
                    ...
                    // deserialize MonadHttpSecretsConfig
                    try {
                        // validate the JSON object to see if any exception is thrown
                        MonadHttpSecretsConfig.validateJsonElement(jsonElement);
                        actualAdapter = adapterMonadHttpSecretsConfig;
                        match++;
                        log.log(Level.FINER, "Input data matches schema 'MonadHttpSecretsConfig'");
                    } catch (Exception e) {
                        // deserialization failed, continue
                        errorMessages.add(String.format("Deserialization for MonadHttpSecretsConfig failed with `%s`.", e.getMessage()));
                        log.log(Level.FINER, "Input data does not match schema 'MonadHttpSecretsConfig'", e);
                    }
    ...
    static {
        ...
        schemas.put("MonadHttpSecretsConfig", MonadHttpSecretsConfig.class);
    ...
    public void setActualInstance(Object instance) {
        ...
        if (instance instanceof MonadHttpSecretsConfig) {
            super.setActualInstance(instance);
            return;
        }
    ...
    /**
     * Get the actual instance of `MonadHttpSecretsConfig`. If the actual instance is not `MonadHttpSecretsConfig`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `MonadHttpSecretsConfig`
     * @throws ClassCastException if the instance is not `MonadHttpSecretsConfig`
     */
    public MonadHttpSecretsConfig getMonadHttpSecretsConfig() throws ClassCastException {
        return (MonadHttpSecretsConfig)super.getActualInstance();
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the json string with MonadHttpSecretsConfig
        try {
            MonadHttpSecretsConfig.validateJsonElement(jsonElement);
            validCount++;
        } catch (Exception e) {
