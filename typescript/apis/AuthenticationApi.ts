...
export class AuthenticationApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async getToken(routesLoginRequest: RoutesLoginRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v1/login/token';
     ...
     */
    public async loginCallbackHandler(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // Path Params
        const localVarPath = '/v1/login/callback';
     ...
     */
    public async loginHandler(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
     ...
     */
    public async resendVerificationHandler(_options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class AuthenticationApiResponseProcessor {
     ...
     */
     public async getTokenWithHttpInfo(response: ResponseContext): Promise<HttpInfo<AuthenticationtypesTokenResponse >> {
        ...
        if (isCodeInRange("0", response.httpStatusCode)) {
            ...
            throw new ApiException<string>(response.httpStatusCode, "Error message", body, response.headers);
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to loginCallbackHandler
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async loginCallbackHandlerWithHttpInfo(response: ResponseContext): Promise<HttpInfo<string >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: string = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to loginHandler
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async loginHandlerWithHttpInfo(response: ResponseContext): Promise<HttpInfo< void>> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("307", response.httpStatusCode)) {
            ...
            throw new ApiException<string>(response.httpStatusCode, "Temporary Redirect", body, response.headers);
        }
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to resendVerificationHandler
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async resendVerificationHandlerWithHttpInfo(response: ResponseContext): Promise<HttpInfo<string >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: string = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
