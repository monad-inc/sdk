...
export class AuthenticationApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async v1LoginCallbackGet(_options?: Configuration): Promise<RequestContext> {
...
export class AuthenticationApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to v1LoginCallbackGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1LoginCallbackGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<string >> {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1LoginGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1LoginGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo< void>> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1LoginResendVerificationPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1LoginResendVerificationPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<string >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: string = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
