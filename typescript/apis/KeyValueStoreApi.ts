...
export class KeyValueStoreApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getKVLookupMetadata(organizationId: string, componentId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("KeyValueStoreApi", "getKVLookupMetadata", "organizationId");
        }


        // verify required parameter 'componentId' is not null or undefined
        if (componentId === null || componentId === undefined) {
            throw new RequiredError("KeyValueStoreApi", "getKVLookupMetadata", "componentId");
        }
     ...
     */
    public async getKVLookupSampleEntries(organizationId: string, componentId: string, numEntries: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("KeyValueStoreApi", "getKVLookupSampleEntries", "organizationId");
        }


        // verify required parameter 'componentId' is not null or undefined
        if (componentId === null || componentId === undefined) {
            throw new RequiredError("KeyValueStoreApi", "getKVLookupSampleEntries", "componentId");
        }


        // verify required parameter 'numEntries' is not null or undefined
        if (numEntries === null || numEntries === undefined) {
            throw new RequiredError("KeyValueStoreApi", "getKVLookupSampleEntries", "numEntries");
        }
     ...
     */
    public async getValueFromKvStore(organizationId: string, componentId: string, key: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("KeyValueStoreApi", "getValueFromKvStore", "organizationId");
        }


        // verify required parameter 'componentId' is not null or undefined
        if (componentId === null || componentId === undefined) {
            throw new RequiredError("KeyValueStoreApi", "getValueFromKvStore", "componentId");
        }


        // verify required parameter 'key' is not null or undefined
        if (key === null || key === undefined) {
            throw new RequiredError("KeyValueStoreApi", "getValueFromKvStore", "key");
        }
...
export class KeyValueStoreApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getKVLookupMetadata
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getKVLookupMetadataWithHttpInfo(response: ResponseContext): Promise<HttpInfo<KvlookupGetMetadataResponse >> {
        ...
        if (isCodeInRange("404", response.httpStatusCode)) {
            ...
            throw new ApiException<string>(response.httpStatusCode, "KV lookup output not found", body, response.headers);
        }
