...
export class OrganizationsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async v3OrganizationIdOrganizationsPost(organizationId: string, routesV3CreateChildOrganizationRequest: RoutesV3CreateChildOrganizationRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("OrganizationsApi", "v3OrganizationIdOrganizationsPost", "organizationId");
        }
        ...
        if (routesV3CreateChildOrganizationRequest === null || routesV3CreateChildOrganizationRequest === undefined) {
            throw new RequiredError("OrganizationsApi", "v3OrganizationIdOrganizationsPost", "routesV3CreateChildOrganizationRequest");
        }
...
export class OrganizationsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v3OrganizationIdOrganizationsGet
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v3OrganizationIdOrganizationsGetWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ModelsUserOrganizationList >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v3OrganizationIdOrganizationsPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v3OrganizationIdOrganizationsPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<GithubComMonadIncCorePkgTypesModelsOrganization >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: GithubComMonadIncCorePkgTypesModelsOrganization = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
