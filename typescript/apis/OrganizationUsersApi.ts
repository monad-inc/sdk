...
export class OrganizationUsersApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async addUser(organizationId: string, routesAddUserToOrganizationRequest: RoutesAddUserToOrganizationRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("OrganizationUsersApi", "addUser", "organizationId");
        }
        ...
        if (routesAddUserToOrganizationRequest === null || routesAddUserToOrganizationRequest === undefined) {
            throw new RequiredError("OrganizationUsersApi", "addUser", "routesAddUserToOrganizationRequest");
        }
     ...
     * @param offset Offset
     */
    public async listUsers(organizationId: string, limit?: number, offset?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("OrganizationUsersApi", "listUsers", "organizationId");
        }
     ...
     */
    public async removeUser(organizationId: string, userId: string, userAuthProviderId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("OrganizationUsersApi", "removeUser", "organizationId");
        }


        // verify required parameter 'userId' is not null or undefined
        if (userId === null || userId === undefined) {
            throw new RequiredError("OrganizationUsersApi", "removeUser", "userId");
        }
        ...
        if (userAuthProviderId === null || userAuthProviderId === undefined) {
            throw new RequiredError("OrganizationUsersApi", "removeUser", "userAuthProviderId");
        }
     ...
     */
    public async updateUser(organizationId: string, userId: string, routesUpdateUserInOrganizationRequest: RoutesUpdateUserInOrganizationRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("OrganizationUsersApi", "updateUser", "organizationId");
        }


        // verify required parameter 'userId' is not null or undefined
        if (userId === null || userId === undefined) {
            throw new RequiredError("OrganizationUsersApi", "updateUser", "userId");
        }
        ...
        if (routesUpdateUserInOrganizationRequest === null || routesUpdateUserInOrganizationRequest === undefined) {
            throw new RequiredError("OrganizationUsersApi", "updateUser", "routesUpdateUserInOrganizationRequest");
        }
     ...
     * @param organizationId Organization ID
     */
    public async v1OrganizationIdUsersLeavePost(organizationId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("OrganizationUsersApi", "v1OrganizationIdUsersLeavePost", "organizationId");
        }


        // Path Params
        const localVarPath = '/v1/{organization_id}/users/leave'
            .replace('{organization_id}', encodeURIComponent(String(organizationId)));
...
export class OrganizationUsersApiResponseProcessor {
     ...
     */
     public async addUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ModelsOrganizationUser >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listUsersWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ModelsOrganizationUserList >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to removeUser
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async removeUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateUserWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ModelsOrganizationUser >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ModelsOrganizationUser = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v1OrganizationIdUsersLeavePost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v1OrganizationIdUsersLeavePostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<any >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: any = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
