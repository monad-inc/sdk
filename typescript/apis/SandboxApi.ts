...
export class SandboxApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async v2OrganizationIdSandboxTransformPost(organizationId: string, routesV2ApplyTransformationRequest: RoutesV2ApplyTransformationRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("SandboxApi", "v2OrganizationIdSandboxTransformPost", "organizationId");
        }
        ...
        if (routesV2ApplyTransformationRequest === null || routesV2ApplyTransformationRequest === undefined) {
            throw new RequiredError("SandboxApi", "v2OrganizationIdSandboxTransformPost", "routesV2ApplyTransformationRequest");
        }


        // Path Params
        const localVarPath = '/v2/{organization_id}/sandbox/transform'
...
export class SandboxApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to v2OrganizationIdSandboxTransformPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v2OrganizationIdSandboxTransformPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RoutesV2ApplyTransformationResponse >> {
