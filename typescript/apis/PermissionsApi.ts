...
export class PermissionsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async listPermissions(organizationId: string, limit?: number, offset?: number, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v2/{organization_id}/roles/permissions'
     ...
     */
     public async listPermissionsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ModelsPermissionList >> {
        ...
        if (isCodeInRange("500", response.httpStatusCode)) {
            ...
            throw new ApiException<string>(response.httpStatusCode, "Error listing permissions", body, response.headers);
        }
