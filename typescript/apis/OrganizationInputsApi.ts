...
export class OrganizationInputsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async v2OrganizationIdInputsBulkPost(organizationId: string, routesV2BulkCreateInputRequest: RoutesV2BulkCreateInputRequest, testConnection?: boolean, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("OrganizationInputsApi", "v2OrganizationIdInputsBulkPost", "organizationId");
        }


        // verify required parameter 'routesV2BulkCreateInputRequest' is not null or undefined
        if (routesV2BulkCreateInputRequest === null || routesV2BulkCreateInputRequest === undefined) {
            throw new RequiredError("OrganizationInputsApi", "v2OrganizationIdInputsBulkPost", "routesV2BulkCreateInputRequest");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(routesV2BulkCreateInputRequest, "RoutesV2BulkCreateInputRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
...
export class OrganizationInputsApiResponseProcessor {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to v2OrganizationIdInputsBulkPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async v2OrganizationIdInputsBulkPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<ModelsInput> >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: Array<ModelsInput> = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
