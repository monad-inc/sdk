 ...
 * no description
 */
export class OrganizationQuotasApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async v2OrganizationIdQuotasGet(organizationId: string, limit?: number, offset?: number, body?: any, _options?: Configuration): Promise<RequestContext> {
        ...
        // Path Params
        const localVarPath = '/v2/{organization_id}/quotas'
...
export class OrganizationQuotasApiResponseProcessor {
