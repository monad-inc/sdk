...
export class BillingAccountsApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async deleteBillingAccount(billingAccountId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'billingAccountId' is not null or undefined
        if (billingAccountId === null || billingAccountId === undefined) {
            throw new RequiredError("BillingAccountsApi", "deleteBillingAccount", "billingAccountId");
        }
     ...
     * @param billingAccountId Billing Account ID
     */
    public async getBillingAccount(billingAccountId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'billingAccountId' is not null or undefined
        if (billingAccountId === null || billingAccountId === undefined) {
            throw new RequiredError("BillingAccountsApi", "getBillingAccount", "billingAccountId");
        }
     ...
     * @param offset Offset
     */
    public async getBillingAccounts(limit?: number, offset?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
    ...
    public async updateBillingAccount(billingAccountId: string, routesV2UpdateBillingAccountRequest: RoutesV2UpdateBillingAccountRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'billingAccountId' is not null or undefined
        if (billingAccountId === null || billingAccountId === undefined) {
            throw new RequiredError("BillingAccountsApi", "updateBillingAccount", "billingAccountId");
        }
...
export class BillingAccountsApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to createBillingAccount
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async createBillingAccountWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ModelsBillingAccount >> {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to deleteBillingAccount
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteBillingAccountWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getBillingAccount
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getBillingAccountWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ModelsBillingAccount >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ModelsBillingAccount = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getBillingAccounts
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getBillingAccountsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ModelsBillingAccountList >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateBillingAccount
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateBillingAccountWithHttpInfo(response: ResponseContext): Promise<HttpInfo<ModelsBillingAccount >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: ModelsBillingAccount = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
