 ...
 * no description
 */
export class TransformSandboxApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async applyTransformation(organizationId: string, routesV2ApplyTransformationRequest: RoutesV2ApplyTransformationRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("TransformSandboxApi", "applyTransformation", "organizationId");
        }
     ...
     * @param body 
     */
    public async listTemplates(body?: any, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
...
export class TransformSandboxApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to applyTransformation
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async applyTransformationWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RoutesV2ApplyTransformationResponse >> {
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to applyTransformationV2
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async applyTransformationV2WithHttpInfo(response: ResponseContext): Promise<HttpInfo<RoutesV2ApplyTransformationResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: RoutesV2ApplyTransformationResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to generateRecord
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async generateRecordWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RoutesV2GenerateRecordResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listTemplatesWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RoutesV2ListTemplatesResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
