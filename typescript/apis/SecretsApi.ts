...
export class SecretsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async createSecret(organizationId: string, createSecretRequest: CreateSecretRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("SecretsApi", "createSecret", "organizationId");
        }
     ...
     */
    public async deleteSecret(organizationId: string, secretId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("SecretsApi", "deleteSecret", "organizationId");
        }


        // verify required parameter 'secretId' is not null or undefined
        if (secretId === null || secretId === undefined) {
            throw new RequiredError("SecretsApi", "deleteSecret", "secretId");
        }
     ...
     * @param secretId Secret ID
     */
    public async getSecret(organizationId: string, secretId: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("SecretsApi", "getSecret", "organizationId");
        }


        // verify required parameter 'secretId' is not null or undefined
        if (secretId === null || secretId === undefined) {
            throw new RequiredError("SecretsApi", "getSecret", "secretId");
        }
     ...
     */
    public async listSecrets(organizationId: string, limit?: number, offset?: number, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("SecretsApi", "listSecrets", "organizationId");
        }
    ...
    public async updateSecret(organizationId: string, secretId: string, updateSecretRequest: UpdateSecretRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'organizationId' is not null or undefined
        if (organizationId === null || organizationId === undefined) {
            throw new RequiredError("SecretsApi", "updateSecret", "organizationId");
        }


        // verify required parameter 'secretId' is not null or undefined
        if (secretId === null || secretId === undefined) {
            throw new RequiredError("SecretsApi", "updateSecret", "secretId");
        }
...
export class SecretsApiResponseProcessor {
     ...
     */
     public async createSecretWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RoutesV2SecretResponse >> {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async deleteSecretWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        ...
        if (isCodeInRange("403", response.httpStatusCode)) {
            ...
            throw new ApiException<ResponderErrorResponse>(response.httpStatusCode, "Secret is shared with this organization by another organization and can only be deleted by its owner", body, response.headers);
        }
        ...
        if (isCodeInRange("409", response.httpStatusCode)) {
            ...
            throw new ApiException<ResponderErrorResponse>(response.httpStatusCode, "Secret is still referenced by a component or pipeline node, or is shared with other organizations; the message names the referencing resources", body, response.headers);
        }
        if (isCodeInRange("500", response.httpStatusCode)) {
            const body: ResponderErrorResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to getSecret
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async getSecretWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RoutesV2SecretWithComponentsResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: RoutesV2SecretWithComponentsResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "RoutesV2SecretWithComponentsResponse", ""
            ) as RoutesV2SecretWithComponentsResponse;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("404", response.httpStatusCode)) {
            const body: ResponderErrorResponse = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to listSecrets
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async listSecretsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RoutesV2SecretWithComponentsListResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: RoutesV2SecretWithComponentsListResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
                "RoutesV2SecretWithComponentsListResponse", ""
            ) as RoutesV2SecretWithComponentsListResponse;
            return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
        }
        if (isCodeInRange("500", response.httpStatusCode)) {
            const body: ResponderErrorResponse = ObjectSerializer.deserialize(
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to updateSecret
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateSecretWithHttpInfo(response: ResponseContext): Promise<HttpInfo<RoutesV2SecretResponse >> {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: RoutesV2SecretResponse = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
