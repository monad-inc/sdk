...
// checks if the ZoomActivityLogsSettingsConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoomActivityLogsSettingsConfig{}

// ZoomActivityLogsSettingsConfig Zoom Operation Logs settings
type ZoomActivityLogsSettingsConfig struct {
...
func NewZoomActivityLogsSettingsConfig() *ZoomActivityLogsSettingsConfig {
	this := ZoomActivityLogsSettingsConfig{}
	return &this
}
...
func (o ZoomActivityLogsSettingsConfig) MarshalJSON() ([]byte, error) {
...
func (o ZoomActivityLogsSettingsConfig) ToMap() (map[string]interface{}, error) {
...
type NullableZoomActivityLogsSettingsConfig struct {
	value *ZoomActivityLogsSettingsConfig
	isSet bool
}

func (v NullableZoomActivityLogsSettingsConfig) Get() *ZoomActivityLogsSettingsConfig {
	return v.value
}

func (v *NullableZoomActivityLogsSettingsConfig) Set(val *ZoomActivityLogsSettingsConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableZoomActivityLogsSettingsConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableZoomActivityLogsSettingsConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoomActivityLogsSettingsConfig(val *ZoomActivityLogsSettingsConfig) *NullableZoomActivityLogsSettingsConfig {
	return &NullableZoomActivityLogsSettingsConfig{value: val, isSet: true}
}

func (v NullableZoomActivityLogsSettingsConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoomActivityLogsSettingsConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
