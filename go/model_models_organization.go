...
func (o *ModelsOrganization) GetConnectionId() string {
...
// and a boolean to check if the value has been set.
func (o *ModelsOrganization) GetConnectionIdOk() (*string, bool) {
	if o == nil || IsNil(o.ConnectionId) {
		return nil, false
	}
...
func (o *ModelsOrganization) HasConnectionId() bool {
	if o != nil && !IsNil(o.ConnectionId) {
		return true
	}
...
func (o *ModelsOrganization) SetConnectionId(v string) {
	o.ConnectionId = &v
}
...
func (o *ModelsOrganization) GetFriendlyName() string {
...
// and a boolean to check if the value has been set.
func (o *ModelsOrganization) GetFriendlyNameOk() (*string, bool) {
	if o == nil || IsNil(o.FriendlyName) {
		return nil, false
	}
...
func (o *ModelsOrganization) HasFriendlyName() bool {
	if o != nil && !IsNil(o.FriendlyName) {
		return true
	}
...
func (o *ModelsOrganization) SetFriendlyName(v string) {
	o.FriendlyName = &v
}
...
func (o *ModelsOrganization) GetParentOrganizationId() string {
...
// and a boolean to check if the value has been set.
func (o *ModelsOrganization) GetParentOrganizationIdOk() (*string, bool) {
	if o == nil || IsNil(o.ParentOrganizationId) {
		return nil, false
	}
...
func (o *ModelsOrganization) HasParentOrganizationId() bool {
	if o != nil && !IsNil(o.ParentOrganizationId) {
		return true
	}
...
func (o *ModelsOrganization) SetParentOrganizationId(v string) {
