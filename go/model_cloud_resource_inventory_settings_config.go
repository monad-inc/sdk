...
type _CloudResourceInventorySettingsConfig CloudResourceInventorySettingsConfig
...
func (o *CloudResourceInventorySettingsConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudResourceInventorySettingsConfig := _CloudResourceInventorySettingsConfig{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCloudResourceInventorySettingsConfig)

	if err != nil {
		return err
	}

	*o = CloudResourceInventorySettingsConfig(varCloudResourceInventorySettingsConfig)
