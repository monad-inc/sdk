...
`func (o *SemgrepSupplyChainFindingsSettingsConfig) GetRateLimit() ModelsInputRateLimit`

GetRateLimit returns the RateLimit field if non-nil, zero value otherwise.

### GetRateLimitOk

`func (o *SemgrepSupplyChainFindingsSettingsConfig) GetRateLimitOk() (*ModelsInputRateLimit, bool)`
...
`func (o *SemgrepSupplyChainFindingsSettingsConfig) SetRateLimit(v ModelsInputRateLimit)`

SetRateLimit sets RateLimit field to given value.

### HasRateLimit

`func (o *SemgrepSupplyChainFindingsSettingsConfig) HasRateLimit() bool`
