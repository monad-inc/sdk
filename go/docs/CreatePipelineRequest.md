...
**Tags** | Pointer to **[]string** | tag names; must exist in the org | [optional] 

## Methods

### NewCreatePipelineRequest

`func NewCreatePipelineRequest(edges []RoutesV2PipelineRequestEdge, name string, nodes []RoutesV2PipelineRequestNode, ) *CreatePipelineRequest`
...
`func (o *CreatePipelineRequest) HasEnabled() bool`
...
`func (o *CreatePipelineRequest) GetTags() []string`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *CreatePipelineRequest) GetTagsOk() (*[]string, bool)`
...
`func (o *CreatePipelineRequest) SetTags(v []string)`
