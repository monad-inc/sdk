...
`func (o *CloudLogsSecretsConfig) GetCredentialsJson() string`

GetCredentialsJson returns the CredentialsJson field if non-nil, zero value otherwise.

### GetCredentialsJsonOk

`func (o *CloudLogsSecretsConfig) GetCredentialsJsonOk() (*string, bool)`
...
`func (o *CloudLogsSecretsConfig) SetCredentialsJson(v string)`
