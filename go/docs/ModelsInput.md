...
`func (o *ModelsInput) GetManagedBy() ModelsManagedBy`

GetManagedBy returns the ManagedBy field if non-nil, zero value otherwise.

### GetManagedByOk

`func (o *ModelsInput) GetManagedByOk() (*ModelsManagedBy, bool)`
...
`func (o *ModelsInput) SetManagedBy(v ModelsManagedBy)`

SetManagedBy sets ManagedBy field to given value.

### HasManagedBy

`func (o *ModelsInput) HasManagedBy() bool`
...
`func (o *ModelsInput) GetReferences() ModelsReferences`

GetReferences returns the References field if non-nil, zero value otherwise.

### GetReferencesOk

`func (o *ModelsInput) GetReferencesOk() (*ModelsReferences, bool)`
...
`func (o *ModelsInput) SetReferences(v ModelsReferences)`

SetReferences sets References field to given value.

### HasReferences

`func (o *ModelsInput) HasReferences() bool`

HasReferences returns a boolean if a field has been set.

### GetShareDetails

`func (o *ModelsInput) GetShareDetails() ModelsShareDetails`

GetShareDetails returns the ShareDetails field if non-nil, zero value otherwise.

### GetShareDetailsOk

`func (o *ModelsInput) GetShareDetailsOk() (*ModelsShareDetails, bool)`
...
`func (o *ModelsInput) SetShareDetails(v ModelsShareDetails)`

SetShareDetails sets ShareDetails field to given value.

### HasShareDetails

`func (o *ModelsInput) HasShareDetails() bool`

HasShareDetails returns a boolean if a field has been set.

### GetTemplateSettings

`func (o *ModelsInput) GetTemplateSettings() ModelsTemplateSettings`

GetTemplateSettings returns the TemplateSettings field if non-nil, zero value otherwise.

### GetTemplateSettingsOk

`func (o *ModelsInput) GetTemplateSettingsOk() (*ModelsTemplateSettings, bool)`
...
`func (o *ModelsInput) SetTemplateSettings(v ModelsTemplateSettings)`

SetTemplateSettings sets TemplateSettings field to given value.

### HasTemplateSettings

`func (o *ModelsInput) HasTemplateSettings() bool`
...
`func (o *ModelsInput) GetVersion() int32`

GetVersion returns the Version field if non-nil, zero value otherwise.

### GetVersionOk

`func (o *ModelsInput) GetVersionOk() (*int32, bool)`
...
`func (o *ModelsInput) SetVersion(v int32)`

SetVersion sets Version field to given value.

### HasVersion

`func (o *ModelsInput) HasVersion() bool`
