...
`func (o *VercelUserEventsSettingsConfig) GetRateLimit() ModelsInputRateLimit`

GetRateLimit returns the RateLimit field if non-nil, zero value otherwise.

### GetRateLimitOk

`func (o *VercelUserEventsSettingsConfig) GetRateLimitOk() (*ModelsInputRateLimit, bool)`
...
`func (o *VercelUserEventsSettingsConfig) SetRateLimit(v ModelsInputRateLimit)`

SetRateLimit sets RateLimit field to given value.

### HasRateLimit

`func (o *VercelUserEventsSettingsConfig) HasRateLimit() bool`
