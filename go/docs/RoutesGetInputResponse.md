...
`func (o *RoutesGetInputResponse) GetManagedBy() ModelsManagedBy`

GetManagedBy returns the ManagedBy field if non-nil, zero value otherwise.

### GetManagedByOk

`func (o *RoutesGetInputResponse) GetManagedByOk() (*ModelsManagedBy, bool)`
...
`func (o *RoutesGetInputResponse) SetManagedBy(v ModelsManagedBy)`

SetManagedBy sets ManagedBy field to given value.

### HasManagedBy

`func (o *RoutesGetInputResponse) HasManagedBy() bool`
...
`func (o *RoutesGetInputResponse) GetReferences() ModelsReferences`

GetReferences returns the References field if non-nil, zero value otherwise.

### GetReferencesOk

`func (o *RoutesGetInputResponse) GetReferencesOk() (*ModelsReferences, bool)`
...
`func (o *RoutesGetInputResponse) SetReferences(v ModelsReferences)`
...
`func (o *RoutesGetInputResponse) GetResourceMetadata() ConnectormetaResourceMetadata`

GetResourceMetadata returns the ResourceMetadata field if non-nil, zero value otherwise.

### GetResourceMetadataOk

`func (o *RoutesGetInputResponse) GetResourceMetadataOk() (*ConnectormetaResourceMetadata, bool)`
...
`func (o *RoutesGetInputResponse) SetResourceMetadata(v ConnectormetaResourceMetadata)`

SetResourceMetadata sets ResourceMetadata field to given value.

### HasResourceMetadata

`func (o *RoutesGetInputResponse) HasResourceMetadata() bool`
...
`func (o *RoutesGetInputResponse) GetVersion() int32`

GetVersion returns the Version field if non-nil, zero value otherwise.

### GetVersionOk

`func (o *RoutesGetInputResponse) GetVersionOk() (*int32, bool)`
...
`func (o *RoutesGetInputResponse) SetVersion(v int32)`

SetVersion sets Version field to given value.

### HasVersion

`func (o *RoutesGetInputResponse) HasVersion() bool`
