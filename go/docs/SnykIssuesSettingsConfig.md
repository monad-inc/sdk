...
`func (o *SnykIssuesSettingsConfig) GetRateLimit() ModelsInputRateLimit`

GetRateLimit returns the RateLimit field if non-nil, zero value otherwise.

### GetRateLimitOk

`func (o *SnykIssuesSettingsConfig) GetRateLimitOk() (*ModelsInputRateLimit, bool)`
...
`func (o *SnykIssuesSettingsConfig) SetRateLimit(v ModelsInputRateLimit)`

SetRateLimit sets RateLimit field to given value.

### HasRateLimit

`func (o *SnykIssuesSettingsConfig) HasRateLimit() bool`
