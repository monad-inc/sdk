...
`func (o *ApplyTransformationV2Request) GetRecord() map[string]interface{}`

GetRecord returns the Record field if non-nil, zero value otherwise.

### GetRecordOk

`func (o *ApplyTransformationV2Request) GetRecordOk() (*map[string]interface{}, bool)`
...
`func (o *ApplyTransformationV2Request) SetRecord(v map[string]interface{})`
