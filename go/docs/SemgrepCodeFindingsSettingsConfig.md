...
`func (o *SemgrepCodeFindingsSettingsConfig) GetBackfillStartTime() string`

GetBackfillStartTime returns the BackfillStartTime field if non-nil, zero value otherwise.

### GetBackfillStartTimeOk

`func (o *SemgrepCodeFindingsSettingsConfig) GetBackfillStartTimeOk() (*string, bool)`
...
`func (o *SemgrepCodeFindingsSettingsConfig) SetBackfillStartTime(v string)`

SetBackfillStartTime sets BackfillStartTime field to given value.

### HasBackfillStartTime

`func (o *SemgrepCodeFindingsSettingsConfig) HasBackfillStartTime() bool`

HasBackfillStartTime returns a boolean if a field has been set.

### GetRateLimit

`func (o *SemgrepCodeFindingsSettingsConfig) GetRateLimit() ModelsInputRateLimit`

GetRateLimit returns the RateLimit field if non-nil, zero value otherwise.

### GetRateLimitOk

`func (o *SemgrepCodeFindingsSettingsConfig) GetRateLimitOk() (*ModelsInputRateLimit, bool)`
...
`func (o *SemgrepCodeFindingsSettingsConfig) SetRateLimit(v ModelsInputRateLimit)`

SetRateLimit sets RateLimit field to given value.

### HasRateLimit

`func (o *SemgrepCodeFindingsSettingsConfig) HasRateLimit() bool`
