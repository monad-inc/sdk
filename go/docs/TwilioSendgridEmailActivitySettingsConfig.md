...
`func (o *TwilioSendgridEmailActivitySettingsConfig) GetRateLimit() ModelsInputRateLimit`

GetRateLimit returns the RateLimit field if non-nil, zero value otherwise.

### GetRateLimitOk

`func (o *TwilioSendgridEmailActivitySettingsConfig) GetRateLimitOk() (*ModelsInputRateLimit, bool)`
...
`func (o *TwilioSendgridEmailActivitySettingsConfig) SetRateLimit(v ModelsInputRateLimit)`

SetRateLimit sets RateLimit field to given value.

### HasRateLimit

`func (o *TwilioSendgridEmailActivitySettingsConfig) HasRateLimit() bool`
