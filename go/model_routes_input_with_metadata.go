...
// checks if the RoutesInputWithMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutesInputWithMetadata{}

// RoutesInputWithMetadata struct for RoutesInputWithMetadata
type RoutesInputWithMetadata struct {
...
func (o RoutesInputWithMetadata) MarshalJSON() ([]byte, error) {
...
func (o RoutesInputWithMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableRoutesInputWithMetadata struct {
	value *RoutesInputWithMetadata
	isSet bool
}

func (v NullableRoutesInputWithMetadata) Get() *RoutesInputWithMetadata {
	return v.value
}

func (v *NullableRoutesInputWithMetadata) Set(val *RoutesInputWithMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutesInputWithMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutesInputWithMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutesInputWithMetadata(val *RoutesInputWithMetadata) *NullableRoutesInputWithMetadata {
	return &NullableRoutesInputWithMetadata{value: val, isSet: true}
}

func (v NullableRoutesInputWithMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutesInputWithMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
