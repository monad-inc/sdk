...
// checks if the ZoomMeetingActivityLogsSettingsConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZoomMeetingActivityLogsSettingsConfig{}

// ZoomMeetingActivityLogsSettingsConfig Zoom Meeting Activity Logs settings
type ZoomMeetingActivityLogsSettingsConfig struct {
...
func NewZoomMeetingActivityLogsSettingsConfig() *ZoomMeetingActivityLogsSettingsConfig {
	this := ZoomMeetingActivityLogsSettingsConfig{}
	return &this
}
...
func (o ZoomMeetingActivityLogsSettingsConfig) MarshalJSON() ([]byte, error) {
...
func (o ZoomMeetingActivityLogsSettingsConfig) ToMap() (map[string]interface{}, error) {
...
type NullableZoomMeetingActivityLogsSettingsConfig struct {
	value *ZoomMeetingActivityLogsSettingsConfig
	isSet bool
}

func (v NullableZoomMeetingActivityLogsSettingsConfig) Get() *ZoomMeetingActivityLogsSettingsConfig {
	return v.value
}

func (v *NullableZoomMeetingActivityLogsSettingsConfig) Set(val *ZoomMeetingActivityLogsSettingsConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableZoomMeetingActivityLogsSettingsConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableZoomMeetingActivityLogsSettingsConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZoomMeetingActivityLogsSettingsConfig(val *ZoomMeetingActivityLogsSettingsConfig) *NullableZoomMeetingActivityLogsSettingsConfig {
	return &NullableZoomMeetingActivityLogsSettingsConfig{value: val, isSet: true}
}

func (v NullableZoomMeetingActivityLogsSettingsConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZoomMeetingActivityLogsSettingsConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
