...
type OpensearchSettingsConfig struct {
	AuthMode *OpensearchAuthMode `json:"auth_mode,omitempty"`
...
// SetAuthMode gets a reference to the given OpensearchAuthMode and assigns it to the AuthMode field.
