...
// checks if the ModelsConnectionPermission type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelsConnectionPermission{}

// ModelsConnectionPermission struct for ModelsConnectionPermission
type ModelsConnectionPermission struct {
...
func NewModelsConnectionPermission() *ModelsConnectionPermission {
	this := ModelsConnectionPermission{}
	return &this
}
...
func (o ModelsConnectionPermission) MarshalJSON() ([]byte, error) {
...
func (o ModelsConnectionPermission) ToMap() (map[string]interface{}, error) {
...
type NullableModelsConnectionPermission struct {
	value *ModelsConnectionPermission
	isSet bool
}

func (v NullableModelsConnectionPermission) Get() *ModelsConnectionPermission {
	return v.value
}

func (v *NullableModelsConnectionPermission) Set(val *ModelsConnectionPermission) {
	v.value = val
	v.isSet = true
}

func (v NullableModelsConnectionPermission) IsSet() bool {
	return v.isSet
}

func (v *NullableModelsConnectionPermission) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelsConnectionPermission(val *ModelsConnectionPermission) *NullableModelsConnectionPermission {
	return &NullableModelsConnectionPermission{value: val, isSet: true}
}

func (v NullableModelsConnectionPermission) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelsConnectionPermission) UnmarshalJSON(src []byte) error {
	v.isSet = true
