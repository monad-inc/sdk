...
func (o *ModelsOutput) HasManagedBy() bool {
	if o != nil && !IsNil(o.ManagedBy) {
		return true
	}
...
func (o *ModelsOutput) GetShareDetails() ModelsShareDetails {
...
// and a boolean to check if the value has been set.
func (o *ModelsOutput) GetShareDetailsOk() (*ModelsShareDetails, bool) {
	if o == nil || IsNil(o.ShareDetails) {
		return nil, false
	}
...
func (o *ModelsOutput) HasShareDetails() bool {
	if o != nil && !IsNil(o.ShareDetails) {
		return true
	}
...
func (o *ModelsOutput) SetShareDetails(v ModelsShareDetails) {
	o.ShareDetails = &v
}

// GetTemplateSettings returns the TemplateSettings field value if set, zero value otherwise.
func (o *ModelsOutput) GetTemplateSettings() ModelsTemplateSettings {
...
// and a boolean to check if the value has been set.
func (o *ModelsOutput) GetTemplateSettingsOk() (*ModelsTemplateSettings, bool) {
	if o == nil || IsNil(o.TemplateSettings) {
		return nil, false
	}
...
func (o *ModelsOutput) HasTemplateSettings() bool {
	if o != nil && !IsNil(o.TemplateSettings) {
		return true
	}
...
func (o *ModelsOutput) SetTemplateSettings(v ModelsTemplateSettings) {
...
func (o *ModelsOutput) GetVersion() int32 {
...
// and a boolean to check if the value has been set.
func (o *ModelsOutput) GetVersionOk() (*int32, bool) {
	if o == nil || IsNil(o.Version) {
		return nil, false
	}
...
func (o *ModelsOutput) HasVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *ModelsOutput) SetVersion(v int32) {
	o.Version = &v
}
