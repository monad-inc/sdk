...
type AwssqsoutputSettingsConfig struct {
	...
	QueueType *AwssqsoutputQueueType `json:"queue_type,omitempty"`
...
// SetQueueType gets a reference to the given AwssqsoutputQueueType and assigns it to the QueueType field.
