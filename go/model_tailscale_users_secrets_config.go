...
// checks if the TailscaleUsersSecretsConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TailscaleUsersSecretsConfig{}

// TailscaleUsersSecretsConfig Tailscale Users secrets
type TailscaleUsersSecretsConfig struct {
...
func NewTailscaleUsersSecretsConfig() *TailscaleUsersSecretsConfig {
	this := TailscaleUsersSecretsConfig{}
	return &this
}
...
func (o TailscaleUsersSecretsConfig) MarshalJSON() ([]byte, error) {
...
func (o TailscaleUsersSecretsConfig) ToMap() (map[string]interface{}, error) {
...
type NullableTailscaleUsersSecretsConfig struct {
	value *TailscaleUsersSecretsConfig
	isSet bool
}

func (v NullableTailscaleUsersSecretsConfig) Get() *TailscaleUsersSecretsConfig {
	return v.value
}

func (v *NullableTailscaleUsersSecretsConfig) Set(val *TailscaleUsersSecretsConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableTailscaleUsersSecretsConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableTailscaleUsersSecretsConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTailscaleUsersSecretsConfig(val *TailscaleUsersSecretsConfig) *NullableTailscaleUsersSecretsConfig {
	return &NullableTailscaleUsersSecretsConfig{value: val, isSet: true}
}

func (v NullableTailscaleUsersSecretsConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTailscaleUsersSecretsConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
