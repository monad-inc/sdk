...
// checks if the VulnerabilitiesCronSettingsConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VulnerabilitiesCronSettingsConfig{}

// VulnerabilitiesCronSettingsConfig CrowdStrike EDR vulnerabilities settings
type VulnerabilitiesCronSettingsConfig struct {
...
func NewVulnerabilitiesCronSettingsConfig() *VulnerabilitiesCronSettingsConfig {
	this := VulnerabilitiesCronSettingsConfig{}
	return &this
}
...
func (o VulnerabilitiesCronSettingsConfig) MarshalJSON() ([]byte, error) {
...
func (o VulnerabilitiesCronSettingsConfig) ToMap() (map[string]interface{}, error) {
...
type NullableVulnerabilitiesCronSettingsConfig struct {
	value *VulnerabilitiesCronSettingsConfig
	isSet bool
}

func (v NullableVulnerabilitiesCronSettingsConfig) Get() *VulnerabilitiesCronSettingsConfig {
	return v.value
}

func (v *NullableVulnerabilitiesCronSettingsConfig) Set(val *VulnerabilitiesCronSettingsConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableVulnerabilitiesCronSettingsConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableVulnerabilitiesCronSettingsConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVulnerabilitiesCronSettingsConfig(val *VulnerabilitiesCronSettingsConfig) *NullableVulnerabilitiesCronSettingsConfig {
	return &NullableVulnerabilitiesCronSettingsConfig{value: val, isSet: true}
}

func (v NullableVulnerabilitiesCronSettingsConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVulnerabilitiesCronSettingsConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
