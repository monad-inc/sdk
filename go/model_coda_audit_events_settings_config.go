...
func (o *CodaAuditEventsSettingsConfig) GetRateLimit() ModelsInputRateLimit {
...
// and a boolean to check if the value has been set.
func (o *CodaAuditEventsSettingsConfig) GetRateLimitOk() (*ModelsInputRateLimit, bool) {
	if o == nil || IsNil(o.RateLimit) {
		return nil, false
	}
...
func (o *CodaAuditEventsSettingsConfig) HasRateLimit() bool {
	if o != nil && !IsNil(o.RateLimit) {
		return true
	}
...
func (o *CodaAuditEventsSettingsConfig) SetRateLimit(v ModelsInputRateLimit) {
	o.RateLimit = &v
}
