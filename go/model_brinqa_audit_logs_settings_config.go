...
func (o *BrinqaAuditLogsSettingsConfig) GetRateLimit() ModelsInputRateLimit {
...
// and a boolean to check if the value has been set.
func (o *BrinqaAuditLogsSettingsConfig) GetRateLimitOk() (*ModelsInputRateLimit, bool) {
	if o == nil || IsNil(o.RateLimit) {
		return nil, false
	}
...
func (o *BrinqaAuditLogsSettingsConfig) HasRateLimit() bool {
	if o != nil && !IsNil(o.RateLimit) {
		return true
	}
...
func (o *BrinqaAuditLogsSettingsConfig) SetRateLimit(v ModelsInputRateLimit) {
	o.RateLimit = &v
}
