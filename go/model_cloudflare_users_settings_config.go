...
// checks if the CloudflareUsersSettingsConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudflareUsersSettingsConfig{}

// CloudflareUsersSettingsConfig Cloudflare Users settings
type CloudflareUsersSettingsConfig struct {
...
func NewCloudflareUsersSettingsConfig() *CloudflareUsersSettingsConfig {
	this := CloudflareUsersSettingsConfig{}
	return &this
}
...
func (o CloudflareUsersSettingsConfig) MarshalJSON() ([]byte, error) {
...
func (o CloudflareUsersSettingsConfig) ToMap() (map[string]interface{}, error) {
...
type NullableCloudflareUsersSettingsConfig struct {
	value *CloudflareUsersSettingsConfig
	isSet bool
}

func (v NullableCloudflareUsersSettingsConfig) Get() *CloudflareUsersSettingsConfig {
	return v.value
}

func (v *NullableCloudflareUsersSettingsConfig) Set(val *CloudflareUsersSettingsConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudflareUsersSettingsConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudflareUsersSettingsConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudflareUsersSettingsConfig(val *CloudflareUsersSettingsConfig) *NullableCloudflareUsersSettingsConfig {
	return &NullableCloudflareUsersSettingsConfig{value: val, isSet: true}
}

func (v NullableCloudflareUsersSettingsConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudflareUsersSettingsConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
