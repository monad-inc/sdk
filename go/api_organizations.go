...
type ApiV3OrganizationIdOrganizationsChildOrganizationIdDeleteRequest struct {
	ctx context.Context
	ApiService *OrganizationsAPIService
	organizationId string
...
func (r ApiV3OrganizationIdOrganizationsChildOrganizationIdDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.V3OrganizationIdOrganizationsChildOrganizationIdDeleteExecute(r)
}

/*
V3OrganizationIdOrganizationsChildOrganizationIdDelete Delete child organization
...
Delete a child organization under the given parent organization
 ...
 @return ApiV3OrganizationIdOrganizationsChildOrganizationIdDeleteRequest
*/
func (a *OrganizationsAPIService) V3OrganizationIdOrganizationsChildOrganizationIdDelete(ctx context.Context, organizationId string, childOrganizationId string) ApiV3OrganizationIdOrganizationsChildOrganizationIdDeleteRequest {
	return ApiV3OrganizationIdOrganizationsChildOrganizationIdDeleteRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
// Execute executes the request
func (a *OrganizationsAPIService) V3OrganizationIdOrganizationsChildOrganizationIdDeleteExecute(r ApiV3OrganizationIdOrganizationsChildOrganizationIdDeleteRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsAPIService.V3OrganizationIdOrganizationsChildOrganizationIdDelete")
	if err != nil {
...
type ApiV3OrganizationIdOrganizationsChildOrganizationIdPatchRequest struct {
	ctx context.Context
	ApiService *OrganizationsAPIService
	organizationId string
	childOrganizationId string
...
// Request body
func (r ApiV3OrganizationIdOrganizationsChildOrganizationIdPatchRequest) RoutesV3UpdateChildOrganizationRequest(routesV3UpdateChildOrganizationRequest RoutesV3UpdateChildOrganizationRequest) ApiV3OrganizationIdOrganizationsChildOrganizationIdPatchRequest {
	r.routesV3UpdateChildOrganizationRequest = &routesV3UpdateChildOrganizationRequest
	return r
}

func (r ApiV3OrganizationIdOrganizationsChildOrganizationIdPatchRequest) Execute() (*GithubComMonadIncCorePkgTypesModelsOrganization, *http.Response, error) {
	return r.ApiService.V3OrganizationIdOrganizationsChildOrganizationIdPatchExecute(r)
}

/*
V3OrganizationIdOrganizationsChildOrganizationIdPatch Update child organization
...
Update a child organization under the given parent organization
 ...
 @param organizationId Parent Organization ID
 @param childOrganizationId Child Organization ID
 @return ApiV3OrganizationIdOrganizationsChildOrganizationIdPatchRequest
*/
func (a *OrganizationsAPIService) V3OrganizationIdOrganizationsChildOrganizationIdPatch(ctx context.Context, organizationId string, childOrganizationId string) ApiV3OrganizationIdOrganizationsChildOrganizationIdPatchRequest {
	return ApiV3OrganizationIdOrganizationsChildOrganizationIdPatchRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return GithubComMonadIncCorePkgTypesModelsOrganization
func (a *OrganizationsAPIService) V3OrganizationIdOrganizationsChildOrganizationIdPatchExecute(r ApiV3OrganizationIdOrganizationsChildOrganizationIdPatchRequest) (*GithubComMonadIncCorePkgTypesModelsOrganization, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsAPIService.V3OrganizationIdOrganizationsChildOrganizationIdPatch")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
