...
// AwsSqsS3GuarddutySettingsConfigAsSecretProcessesorInputConfigSettings is a convenience function that returns AwsSqsS3GuarddutySettingsConfig wrapped in SecretProcessesorInputConfigSettings
func AwsSqsS3GuarddutySettingsConfigAsSecretProcessesorInputConfigSettings(v *AwsSqsS3GuarddutySettingsConfig) SecretProcessesorInputConfigSettings {
	return SecretProcessesorInputConfigSettings{
		AwsSqsS3GuarddutySettingsConfig: v,
	}
}
...
// CatoNetworksEventsSettingsConfigAsSecretProcessesorInputConfigSettings is a convenience function that returns CatoNetworksEventsSettingsConfig wrapped in SecretProcessesorInputConfigSettings
func CatoNetworksEventsSettingsConfigAsSecretProcessesorInputConfigSettings(v *CatoNetworksEventsSettingsConfig) SecretProcessesorInputConfigSettings {
	return SecretProcessesorInputConfigSettings{
		CatoNetworksEventsSettingsConfig: v,
	}
}
...
func (dst *SecretProcessesorInputConfigSettings) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into AwsSqsS3GuarddutySettingsConfig
	err = newStrictDecoder(data).Decode(&dst.AwsSqsS3GuarddutySettingsConfig)
	if err == nil {
		jsonAwsSqsS3GuarddutySettingsConfig, _ := json.Marshal(dst.AwsSqsS3GuarddutySettingsConfig)
		if string(jsonAwsSqsS3GuarddutySettingsConfig) == "{}" { // empty struct
			dst.AwsSqsS3GuarddutySettingsConfig = nil
		} else {
			if err = validator.Validate(dst.AwsSqsS3GuarddutySettingsConfig); err != nil {
				dst.AwsSqsS3GuarddutySettingsConfig = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into CatoNetworksEventsSettingsConfig
	err = newStrictDecoder(data).Decode(&dst.CatoNetworksEventsSettingsConfig)
	if err == nil {
		jsonCatoNetworksEventsSettingsConfig, _ := json.Marshal(dst.CatoNetworksEventsSettingsConfig)
		if string(jsonCatoNetworksEventsSettingsConfig) == "{}" { // empty struct
			dst.CatoNetworksEventsSettingsConfig = nil
		} else {
			if err = validator.Validate(dst.CatoNetworksEventsSettingsConfig); err != nil {
				dst.CatoNetworksEventsSettingsConfig = nil
			} else {
				match++
			}
...
func (src SecretProcessesorInputConfigSettings) MarshalJSON() ([]byte, error) {
	...
	if src.AwsSqsS3GuarddutySettingsConfig != nil {
		return json.Marshal(&src.AwsSqsS3GuarddutySettingsConfig)
	}
	...
	if src.CatoNetworksEventsSettingsConfig != nil {
		return json.Marshal(&src.CatoNetworksEventsSettingsConfig)
	}
...
func (obj *SecretProcessesorInputConfigSettings) GetActualInstance() (interface{}) {
	...
	if obj.AwsSqsS3GuarddutySettingsConfig != nil {
		return obj.AwsSqsS3GuarddutySettingsConfig
	}
	...
	if obj.CatoNetworksEventsSettingsConfig != nil {
		return obj.CatoNetworksEventsSettingsConfig
	}
